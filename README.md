...
[![Tests](https://img.shields.io/badge/Tests-167%20Passing-brightgreen.svg)](test)
...
├── test/                           # Unit & widget test suites (167 tests)
...
To execute the automated unit and widget test suite (167 tests with 100% pass rate):
```bash
flutter test
```
