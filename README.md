...
[![Tests](https://img.shields.io/badge/Tests-165%20Passing-brightgreen.svg)](test)
...
├── test/                           # Unit & widget test suites (165 tests)
...
To execute the automated unit and widget test suite (165 tests with 100% pass rate):
```bash
flutter test
```
