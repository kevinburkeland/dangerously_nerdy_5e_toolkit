...
[![Tests](https://img.shields.io/badge/Tests-1482%20Passing-brightgreen.svg)](test)
...
├── test/                           # Unit, widget, accessibility, & resilience test suites (1,482 tests)
...
To execute the automated unit, widget, accessibility, spellcasting mechanics, character progression pipeline, conflict resolution, domain purity, and resilience test suite (**1,482 tests with 100% pass rate**):
```bash
flutter test
```
...
- Writing comprehensive unit, widget, domain purity, and resilience tests (1,482 automated tests).
