...
├── test/                           # Unit, widget, accessibility, & resilience test suites (402 tests)
...
To execute the automated unit, widget, accessibility, spellcasting mechanics, and resilience test suite (402 tests with 100% pass rate):
```bash
flutter test
```
