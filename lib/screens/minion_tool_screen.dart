...
class _MinionToolScreenState extends State<MinionToolScreen>
  ...
  Future<void> _confirmClearSquad() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            const Text('Remove all summoned minions and reset squad points?'),
        actions: [
          TextButton(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            if (!widget.preset.isRandomTable &&
                widget.preset.id != 'figurines_of_wondrous_power')
              Container(
        ...
        body: isDualPane
            ? Row(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 9,
                    child: SpellReferenceWidget(
                        initialPreset: _session.activePreset),
                  ),
                ],
              )
            : Align(
