...
class _DprCalculatorScreenState extends State<DprCalculatorScreen> {
    ...
    DprWeaponPickerSheet.show(
      ...
      onSelected: (preset) {
        ...
        final updated = current.copyWith(
          ...
          damageBonus: preset.isCantrip
              ? preset.flatBonus
              : (abilityMod + preset.flatBonus),
          attackBonus: abilityMod +
              pb +
              preset.flatBonus +
              (preset.isRanged && current.hasArchery ? 2 : 0),
          ...
          weaponMastery: (!preset.isCantrip &&
                  _resolveEdition(context) == DmRulesEdition.v2024)
              ? preset.defaultMastery
              : WeaponMastery.none,
          abilityModForGraze: (!preset.isCantrip &&
                  preset.defaultMastery == WeaponMastery.graze)
              ? abilityMod
              : 0,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  '• 2014 Power Attack: -5 to hit for +10 flat damage.\n'
                  '• Heavy Weapon Damage Bonus: Adds Proficiency Bonus (+PB) damage without -5 penalty.\n'
  ...
  Widget build(BuildContext context) {
    ...
    final baselineCurve =
        DprCalculatorEngine.generateCurve(_profile, minAc: 5, maxAc: 30);
    final breakEvenAnalysis = DprCalculatorEngine.calculatePowerAttackBreakEven(
        _profile,
        minAc: 5,
        maxAc: 30);
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildChartCard(
                            ...
                            advantageCurve,
                            disadvantageCurve,
                            breakEvenAnalysis.maxOptimalAc,
                          ),
                          const SizedBox(height: 12),
  ...
  Widget _buildChartCard(
    ...
    final hasGraze =
        baselineCurve.points.values.any((p) => p.expectedDamageOnMiss > 0);
                  ...
                  child: SegmentedButton<DprChartMode>(
                    segments: const [
                      ...
                      ButtonSegment(
                        ...
                        label:
                            Text('Breakdown', style: TextStyle(fontSize: 11)),
                      ),
                    ],
                    selected: {_chartMode},
            ...
            if (_chartMode == DprChartMode.dpr)
              Wrap(
                ...
                children: [
                  ...
                  FilterChip(
                    label:
                        const Text('Advantage', style: TextStyle(fontSize: 11)),
                  ...
                  FilterChip(
                    ...
                    onSelected: (val) =>
                        setState(() => _showDisadvantage = val),
                  ),
                ],
              )
              ...
              Wrap(
                ...
                children: [
                  _buildLegendItem(
                      'Regular Hit Damage', const Color(0xFF00E5FF)),
                  _buildLegendItem(
                      'Critical Hit Damage', const Color(0xFFFFD700)),
                  if (hasGraze)
                    _buildLegendItem(
                        'Miss Damage (Graze)', const Color(0xFFB388FF)),
                ],
              ),
          ],
        ),
              ...
              children: [
                ...
                Expanded(
                  child: Slider(
                    value: _selectedAc
                        .toDouble()
                        .clamp(_chartMinAc.toDouble(), _chartMaxAc.toDouble()),
                ...
                children: [
                  ...
                  ...DprMonsterAcPreset.standardPresets.map((preset) {
                    ...
                    return Padding(
                      ...
                      child: ChoiceChip(
                        label: Text(
                            'CR ${preset.crDisplay} (AC ${preset.typicalAc})',
                        ...
                        onSelected: (selected) {
                          if (selected) {
                            HapticService.selectionTick(context);
                            setState(() {
                              _selectedAc = preset.typicalAc
                                  .clamp(_chartMinAc, _chartMaxAc);
                            });
                            _autoSaveDraft();
                          }
                        },
