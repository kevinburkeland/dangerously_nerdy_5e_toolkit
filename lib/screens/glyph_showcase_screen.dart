...
class _GlyphShowcaseScreenState extends State<GlyphShowcaseScreen>
  ...
  // ---------------------------------------------------------------------------
  int _builderMode =
      0; // 0: Spell, 1: Creature, 2: Magic Item, 3: Feat, 4: Class, 5: Species, 6: Generic UI
  ...
  String _builderFeatId = 'feat_grappler';
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              ...
              const Tab(
                  icon: Icon(Icons.stars_outlined), text: 'Feats & Boons'),
              ...
              const Tab(
                  ...
                  text: 'Generic UI & Dice'),
              const Tab(
                  icon: Icon(Icons.build_circle), text: 'Custom Glyph Studio'),
              const Tab(
                          ...
                          child: FilterChip(
                            avatar: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    shape: BoxShape.circle)),
                            label:
                                Text('${ct.displayName} (d${ct.hitDieSides})'),
  ...
  Widget _buildCreaturesGallery(bool isDark, DmRulesEdition edition) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, idx) => _buildCreatureCard(creatures[idx], isDark),
    );
  }
  ...
  Widget _buildItemsGallery(bool isDark, DmRulesEdition edition) {
    var items = GlyphGalleryData.allItems.where((i) {
      if (_selectedItemCategory != null &&
          i.category != _selectedItemCategory) {
        return false;
      }
      if (_searchQuery.isNotEmpty) {
    ...
    if (items.isEmpty) {
      return _buildEmptyState(
          'No magic items matching current filters.', isDark);
    }
  ...
  Widget _buildItemCard(GlyphItemEntry item, bool isDark) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side:
            BorderSide(color: rarityColor.withValues(alpha: 0.65), width: 1.5),
      ),
      child: InkWell(
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildFeatsGallery(bool isDark, DmRulesEdition edition) {
    var feats = GlyphGalleryData.allFeats.where((f) {
      if (edition == DmRulesEdition.v2014 &&
          f.featCategory == FeatCategory.origin) {
        return false;
      }
  ...
  Widget _buildClassCard(GlyphClassEntry classEntry, bool isDark) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(color: classColor.withValues(alpha: 0.55), width: 1.5),
      ),
      child: InkWell(
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildSpeciesGallery(bool isDark, DmRulesEdition edition) {
    var species = GlyphGalleryData.allSpecies.where((s) {
      if (_selectedSpeciesType != null &&
          s.speciesType != _selectedSpeciesType) {
        return false;
      }
      if (_searchQuery.isNotEmpty) {
        final match = s.name.toLowerCase().contains(_searchQuery) ||
  ...
  Widget _buildSpeciesCard(
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side:
            BorderSide(color: speciesColor.withValues(alpha: 0.55), width: 1.5),
      ),
      child: InkWell(
        borderRadius: BorderRadius.circular(16),
  ...
  Widget _buildGenericUiGallery(bool isDark, DmRulesEdition edition) {
    ...
    if (entries.isEmpty) {
      return _buildEmptyState(
          'No generic UI icons matching current filters.', isDark);
    }
        ...
        children: [
                ...
                children: [
                  ...
                  Text(
                    switch (_builderMode) {
                      ...
                      3 =>
                        '${_builderFeatCategory.displayName} • $_builderFeatId',
                      4 =>
                        '${_builderClassType.displayName} • d${_builderClassType.hitDieSides} Hit Die',
                      5 =>
                        '${_builderSpeciesType.displayName} • ${_builderSpeciesType.getSize(edition)}, ${_builderSpeciesType.getSpeed(edition)} ft',
                    ...
                    _buildPresetDropdown<GlyphFeatEntry>(
                      ...
                      items: GlyphGalleryData.allFeats
                          .map((feat) => DropdownMenuItem(
                                value: feat,
                                child: Text(
                                    '${feat.name} (${feat.featCategory.displayName})',
                                    style: const TextStyle(fontSize: 13)),
                              ))
                          .toList(),
                      onChanged: (feat) {
                    ...
                    _buildPresetDropdown<GlyphClassEntry>(
                      ...
                      items: GlyphGalleryData.allClasses
                          .map((cls) => DropdownMenuItem(
                                value: cls,
                                child: Text(
                                    '${cls.name} (d${cls.classType.hitDieSides})',
                                    style: const TextStyle(fontSize: 13)),
                              ))
                          .toList(),
                      onChanged: (cls) {
                      ...
                      onChanged: (spec) {
                        if (spec != null) {
                          setState(() {
                            ...
                            _builderShapeOverride = null;
                            _builderRings =
                                List.from(spec.getActionRings(edition));
                          });
                        }
                      },
                    ),
          ...
          SingleChildScrollView(
            ...
            child: SegmentedButton<int>(
              segments: [
                const ButtonSegment(
                    value: 0, icon: Icon(Icons.memory), label: Text('Spell')),
                const ButtonSegment(
                    value: 1, icon: Icon(Icons.pets), label: Text('Creature')),
                const ButtonSegment(
                    value: 2,
                ...
                const ButtonSegment(
                    ...
                    label: Text('Feat')),
                const ButtonSegment(
                    value: 4, icon: Icon(Icons.shield), label: Text('Class')),
                ButtonSegment(
                  value: 5,
                  icon: const Icon(Icons.groups_outlined),
                  label: Text(
                      edition == DmRulesEdition.v2014 ? 'Race' : 'Species'),
                ),
                const ButtonSegment(
                    value: 6,
                    icon: Icon(Icons.widgets_outlined),
          ...
          if (_builderMode == 0) ...[
            ...
            FilterChip(
              avatar: Icon(
                _builderItemRequiresAttunement ? Icons.link : Icons.link_off,
                size: 16,
              ),
            ...
            Text(
                'Select ${edition == DmRulesEdition.v2014 ? "Race (2014 SRD)" : "Species (2024 SRD)"}:',
                style:
          ...
          Wrap(
            ...
            children: [
              ChoiceChip(
                ...
                onSelected: (_) => setState(() => _builderShapeOverride = null),
              ),
  ...
  Widget _buildFullStyleGuide(bool isDark, DmRulesEdition edition) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text(
              'Fifth Edition Glyph System: Techno-Wireframe HUD & Arcane Codex',
                        ...
                        children: [
                          Text(ct.displayName,
                              style: TextStyle(
                                  ...
                                  color: col)),
                          Text(
                              'Hit Die: d${ct.hitDieSides} (${ct.hitDieSides} Vertices)',
                              style: const TextStyle(
                                  fontSize: 11, fontFamily: 'monospace')),
                        ...
                        children: [
                          Text(st.displayName,
                              style: TextStyle(
                                  ...
                                  color: col)),
                          Text(
                              '${st.getSize(edition)} • ${st.getSpeed(edition)} ft Speed',
                              style: const TextStyle(
                                  fontSize: 11, fontFamily: 'monospace')),
                ...
                Text(
                  switch (ringType) {
                    ...
                    ActionRingType.ranged =>
                      '4-Axis Targeting Crosshair Reticle',
                    ActionRingType.recharge => '6-Segment Pulse Energy Gaps',
                    ActionRingType.reaction =>
                      'Square Corner Deflection Brackets',
                    ...
                    ActionRingType.concentration =>
                      'Orbital Satellite Pulse Loop',
                    ActionRingType.attunement => 'Sacred Knot Crosshair Tether',
                    ActionRingType.bonusAction =>
                      'Triple-Spark Triangulation Rays',
                    ActionRingType.resource =>
                      '4-Segment Rest & Recharge Matrix',
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildDetailRow('School', spell.school.displayName,
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildDetailRow('Type', creature.type.displayName,
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildDetailRow('Attunement',
                item.requiresAttunement ? 'Requires Attunement' : 'No'),
            const SizedBox(height: 10),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildDetailRow('Tier', feat.featCategory.displayName,
                accentColor: catColor),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildDetailRow('Hit Die', 'd${classEntry.classType.hitDieSides}',
