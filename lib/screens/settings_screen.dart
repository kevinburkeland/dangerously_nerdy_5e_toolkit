...
class _SettingsScreenState extends State<SettingsScreen> {
  final CriticalEffectController _testCritController =
      CriticalEffectController();
  int _previewHp = 22;
    ...
    return CriticalEffectOverlay(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            _buildSectionHeader(
                context, '5e Rules Edition & Mechanics', Icons.menu_book),
            Card(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Global Rulebook Edition',
                    ...
                    const Text('Character Creation Step Flow',
                        style: TextStyle(fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4),
                    Text(
            ...
            _buildSectionHeader(
                context, 'Theme & Appearance', Icons.palette_outlined),
            Card(
              child: Padding(
                padding: const EdgeInsets.all(14),
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Fantasy Accent Palette',
                        style: TextStyle(fontWeight: FontWeight.w600)),
                    const SizedBox(height: 10),
                    Wrap(
                      spacing: 8,
                    ...
                    if (s.themeMode != ThemeMode.light) ...[
                      ...
                      SwitchListTile.adaptive(
                        ...
                        subtitle: const Text(
                            'Pure #000000 background for AMOLED battery savings'),
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(
                context, 'RPG Micro-Interactions & FX', Icons.auto_awesome),
            Card(
              child: Column(
                children: [
                  SwitchListTile.adaptive(
                    ...
                    subtitle: const Text(
                        'Screen shake, rumble, and ember bursts on Nat 20 / Nat 1'),
                  ...
                  SwitchListTile.adaptive(
                    secondary:
                        const Icon(Icons.grain, color: Colors.cyanAccent),
                    title: const Text('Spell Particle Canvas FX'),
                    subtitle: const Text(
                        'Floating ambient mana and spell burst particles'),
                  ...
                  SwitchListTile.adaptive(
                    ...
                    subtitle: const Text(
                        'Interactive rolling physics and dice tumbling'),
                  ...
                  SwitchListTile.adaptive(
                    secondary:
                        const Icon(Icons.blur_on, color: Colors.purpleAccent),
                    title: const Text('Creature & Spell Glyph Animations'),
                    subtitle: const Text(
                        'Rotating trait rings and holographic techno-rune pulses'),
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(
                context, 'Haptics & Battery Optimization', Icons.vibration),
            Card(
              child: Column(
                children: [
                  ListTile(
                  ...
                  SwitchListTile.adaptive(
                    ...
                    subtitle: const Text(
                        'Disables continuous tickers, particles, and heavy shaders'),
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(context, 'Interactive Live Preview & Test Lab',
            ...
            PressableCard(
              ...
              onTap: () {
                ...
                setState(() {
                  _previewHp =
                      (_previewHp >= _previewMaxHp) ? 18 : _previewHp + 20;
                });
              },
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Wrap(
                    ...
                    children: [
                      OutlinedButton.icon(
                        onPressed: () {
                          _testCritController
                              .trigger(CritEffectType.critSuccess);
                        },
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          _testCritController
                              .trigger(CritEffectType.critFumble);
                        },
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          _testCritController
                              .trigger(CritEffectType.spellBurst);
                        },
            ...
            _buildSectionHeader(
                context, 'Data Management & Backup', Icons.storage_rounded),
            Card(
              child: Padding(
                padding: const EdgeInsets.all(14),
                child: Column(
  ...
  Future<void> _importAppBackup() async {
    ...
    if (result == true && controller.text.trim().isNotEmpty && mounted) {
      final restoreResult =
          await AppBackupService().importFullBackupJson(controller.text);
      if (!mounted) return;
      if (restoreResult.success) {
        ...
        final homebrewSuffix =
            homebrewCount > 0 ? ', and $homebrewCount homebrew entities' : '';
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content:
                Text(restoreResult.errorMessage ?? 'Failed to import backup'),
          ),
        );
      }
    }
