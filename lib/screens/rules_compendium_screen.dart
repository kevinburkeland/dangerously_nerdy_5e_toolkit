...
/// High-speed SRD 5.1 (2014) & SRD 5.2.1 (2024) Rules Compendium Screen.
              ...
              slivers: [
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Row(
                                children: [
                                  ChoiceChip(
                                    avatar:
                                        const Icon(Icons.table_rows, size: 14),
                                    label: Text(
                                    ...
                                    labelStyle: TextStyle(
                                      color: _selectedTableSubCategory == null
                                          ? Colors.black
                                  ...
                                  ChoiceChip(
                                    ...
                                    selected: _selectedTableSubCategory ==
                                        'Rollable Tables',
                                    selectedColor: const Color(0xFFF59E0B),
                                    labelStyle: TextStyle(
                                      color: _selectedTableSubCategory ==
                                              'Rollable Tables'
                                          ? Colors.black
                                          : theme.colorScheme.onSurface,
                                      fontWeight: FontWeight.bold,
                                    ...
                                    onSelected: (_) {
                                      HapticService.selectionTick(context);
                                      setState(() => _selectedTableSubCategory =
                                          'Rollable Tables');
                                    },
                                  ),
                                  const SizedBox(width: 8),
                ...
                if (pinnedFilteredItems.isNotEmpty) ...[
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: _buildPinnedSectionHeader(
                          theme, pinnedFilteredItems.length),
                    ),
                  ),
                  _buildSliverItemsGrid(
                      context, pinnedFilteredItems, edition, pinnedIds),
                ],
                if (otherFilteredItems.isNotEmpty) ...[
                  ...
                  _buildSliverItemsGrid(
                      context, otherFilteredItems, edition, pinnedIds),
                ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Wrap(
                  ...
                  children: [
                    Semantics(
                      ...
                      child: Text(
                        is2024
                            ? '2024 Revised 5e Rulebook'
                            : '2014 (SRD 5.1 RAW) Rulebook',
                        style: TextStyle(
                          color: theme.colorScheme.onSurface,
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
                ...
                Text(
                  is2024
                      ? 'Displaying 2024 Revised rules (Free SRD 5.2.1 compatible). Rules that changed are tagged with "2024 Diff".'
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Search rules (supports tag:action, category:combat, etc.)...',
                    hintStyle: TextStyle(
                        color:
          ...
          children: [
            ...
            FilterChip(
              avatar: Icon(
                ...
                size: 16,
                color:
                    _showOnlyPinned ? theme.colorScheme.onPrimary : diffColor,
              ),
              label: Text(
