                ...
                children: [
                  ...
                  if (_selectedDie == DieType.d20 && _count == 1) ...[
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('d20 Advantage', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600)),
                        SegmentedButton<RollMode>(
                          segments: const [
                            ButtonSegment(value: RollMode.disadvantage, label: Text('Dis')),
                            ButtonSegment(value: RollMode.normal, label: Text('Norm')),
                          ...
                          style: SegmentedButton.styleFrom(
                            selectedBackgroundColor: Colors.cyanAccent.withValues(alpha: 0.3),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.upload, size: 18, color: Colors.cyanAccent),
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelf ? const Color(0xFF23203E) : const Color(0xFF1E1B2E),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: isSelf ? Colors.cyanAccent.withValues(alpha: 0.3) : Colors.white.withValues(alpha: 0.05),
                    ),
                  ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Row(
                        children: [
                          CircleAvatar(
                            radius: 14,
                            backgroundColor: isSelf ? Colors.cyanAccent : Colors.purpleAccent,
                            child: Text(
                              item.playerName.isNotEmpty ? item.playerName[0].toUpperCase() : '?',
                              ...
                              Row(
                                children: [
                                  Text(
                                    item.playerName,
                                    style: TextStyle(
                                      color: isSelf ? Colors.cyanAccent : Colors.amber,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13,
                                    ),
                                  ),
      ...
      return Container(
        ...
        child: const Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Tap ROLL to roll the dice!', style: TextStyle(color: Colors.white38, fontSize: 15)),
          ],
        ),
      );
    }
  ...
  Future<void> _deleteCustomPreset(CustomPreset preset) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Delete preset "${preset.name}"?', style: const TextStyle(color: Colors.white70)),
        actions: [
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: '[{"name": "Fireball", "dieType": "d6", "count": 8, "modifier": 0}]',
        ...
        actions: [
          ...
          TextButton.icon(
            ...
            label: const Text('Paste Clipboard', style: TextStyle(color: Colors.cyanAccent)),
            onPressed: () async {
