...
class RaceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedSpeciesType =
        SpeciesType.tryParse(slug) ?? SpeciesType.tryParse(race.name);
    final speciesColor = _getSpeciesColor(slug);
    final speciesIcon = _getSpeciesIcon(slug);
    final resolvedEdition = edition ??
      ...
      child: Column(
        ...
        children: [
              ...
              if (resolvedSpeciesType != null)
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: speciesColor.withValues(alpha: 0.55)),
                  ),
          ...
          FormattedMarkdownText(
            race.traitsMarkdown,
            maxLines: race.traitsMarkdown.contains('|') ? null : 3,
            overflow: race.traitsMarkdown.contains('|')
                ? null
