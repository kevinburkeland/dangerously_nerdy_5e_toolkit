  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<RoomSession?>(
      ...
      builder: (context, session, _) {
        final effectiveRoomCode =
            activeRoomCode ?? session?.roomCode ?? roomService.activeRoomCode;
        final effectivePlayerName =
            playerName ?? session?.playerName ?? roomService.playerName;
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              key: ValueKey(
                  'local_roll_${item.timestamp.microsecondsSinceEpoch}_$index'),
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final bool isSelf = item.playerName ==
                    (widget.roomService.playerName ?? widget.playerName);
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      isExpanded
                                                          ? 'Hide'
                                                          : 'Papertrail (${item.details!.length})',
                                                      style: TextStyle(
                                                        color: primary,
                                                        fontSize: 11,
                                                        fontWeight:
