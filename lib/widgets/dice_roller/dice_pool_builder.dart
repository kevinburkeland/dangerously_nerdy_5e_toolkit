          ...
          children: [
            ...
            if (!isDefaultPool)
              TextButton.icon(
                ...
                icon: Icon(Icons.refresh, size: 14, color: primary),
                          ...
                          children: [
                            IconButton(
                              icon: Icon(Icons.remove_circle_outline,
                                  color: primary),
                              tooltip:
                                  'Decrease quantity of ${diceEntry.dieLabel}',
                              onPressed: () {
                                final updatedPool =
                                    List<DiceEntry>.from(dicePool);
                            ...
                            IconButton(
                              icon: Icon(Icons.add_circle_outline,
                                  color: primary),
                              tooltip:
                                  'Increase quantity of ${diceEntry.dieLabel}',
                              onPressed: () {
                                final updatedPool =
                                    List<DiceEntry>.from(dicePool);
                  ...
                  children: [
                    ...
                    SegmentedButton<RollMode>(
                      ...
                      style: SegmentedButton.styleFrom(
                        selectedBackgroundColor: primary.withValues(alpha: 0.2),
