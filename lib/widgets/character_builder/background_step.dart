...
class _BackgroundStepState extends State<BackgroundStep> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgrounds =
        widget.customBackgrounds ?? SrdBackgroundsLibrary.allBackgrounds;
    ...
    final filteredBackgrounds = backgrounds.where((bg) {
      ...
      final skillsMatch =
          bg.skillProficiencies.any((s) => s.toLowerCase().contains(q));
      final toolsMatch =
          bg.toolProficiencies.any((t) => t.toLowerCase().contains(q));
      ...
      builder: (context, _) {
        return Column(
          ...
          children: [
            Text(
              is2024
                  ? 'Step 4: Choose Background Origin'
