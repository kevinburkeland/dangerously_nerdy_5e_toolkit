  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isDefeated
            ? (isDark
                ? const Color(0xFF181A22).withAlpha(150)
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (combatant.activeConcentrationSpellId != null)
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(4),
                                border: Border.all(
                                    color: Colors.purpleAccent, width: 0.8),
                              ),
                              child: const Text(
                                '🔮 Conc',
                                style: TextStyle(
                          ...
                          if (combatant.isSpellcaster &&
                              combatant.maxSpellSlots.isNotEmpty)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 4, vertical: 1),
                              decoration: BoxDecoration(
                ...
                if (isSetupMode) ...[
                  ...
                  IconButton(
                    ...
                    constraints:
                        const BoxConstraints(minWidth: 26, minHeight: 26),
                    tooltip:
                        'Status Conditions (${combatant.conditions.length})',
                    onPressed: () {
                      ArenaConditionToggleDialog.show(
                        context,
                        combatant: combatant,
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    if (!isSetupMode &&
                        (combatant.totalDamageDealt > 0 || combatant.kills > 0))
                      Text(
