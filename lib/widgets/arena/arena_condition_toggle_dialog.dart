...
class ArenaConditionToggleDialog extends StatefulWidget {
  ...
  @override
  State<ArenaConditionToggleDialog> createState() =>
      _ArenaConditionToggleDialogState();
}

class _ArenaConditionToggleDialogState
    extends State<ArenaConditionToggleDialog> {
                ...
                children: [
                  ...
                  Expanded(
                    child: Wrap(
                      ...
                      children: [
                        ChoiceChip(
                          label: const Text('Indefinite (Saved)',
                        ...
                        ChoiceChip(
                          label: const Text('1 Round',
                              style: TextStyle(fontSize: 11)),
                          selected: _selectedDuration == 1,
                          onSelected: (s) =>
                              setState(() => _selectedDuration = s ? 1 : null),
                        ),
                        ChoiceChip(
                          label: const Text('1 Min (10r)',
                              style: TextStyle(fontSize: 11)),
                          selected: _selectedDuration == 10,
                          onSelected: (s) =>
                              setState(() => _selectedDuration = s ? 10 : null),
                        ),
                      ],
                    ),
                  ),
