                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                            color: environment.themeColor.withAlpha(80),
                            width: 1),
                      ),
                      child: Row(
                        ...
                        children: [
                          Icon(environment.icon,
                              size: 13, color: environment.themeColor),
                          ...
                          if (onEnvironmentTap != null) ...[
                            ...
                            Icon(Icons.info_outline,
                                size: 11, color: environment.themeColor),
                          ],
                        ],
                      ),
                    ),
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        isPlaying ? Colors.amber : const Color(0xFF10B981),
