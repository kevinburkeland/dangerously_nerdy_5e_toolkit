...
class ArenaMonsterPickerSheet extends StatefulWidget {
  ...
  @override
  State<ArenaMonsterPickerSheet> createState() =>
      _ArenaMonsterPickerSheetState();
}
...
class _ArenaMonsterPickerSheetState extends State<ArenaMonsterPickerSheet> {
  ...
  List<MonsterItem> _filterMonsters() {
    ...
    final typeFilter = (_selectedType == null || _selectedType == 'All Types')
        ? null
        : _selectedType;
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            CreatureStatBlockDialog.show(
                              ...
                              statBlock: sb,
                              addToSquadLabel:
                                  'ADD TO ${widget.team.label.toUpperCase()}',
                              onAddToSquad: () {
                                widget.onMonstersSelected(
                                    monster, _selectedCount);
                            ...
                            children: [
                              IconButton(
                                icon: Icon(
                                  ...
                                  size: 20,
                                  color:
                                      teamColor.withAlpha(isDark ? 220 : 200),
                                ),
