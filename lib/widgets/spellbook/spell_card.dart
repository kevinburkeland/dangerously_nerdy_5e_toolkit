...
class SpellCard extends StatelessWidget {
  ...
  Future<void> _handleCast(BuildContext context) async {
    ...
    final resources =
        controller?.character.resources ?? const CharacterResourcePool.empty();
      ...
      child: Column(
        ...
        children: [
          ...
          FormattedMarkdownText(
            ...
            maxLines: rules.description.first.contains('|') ? null : 2,
            overflow: rules.description.first.contains('|')
                ? null
