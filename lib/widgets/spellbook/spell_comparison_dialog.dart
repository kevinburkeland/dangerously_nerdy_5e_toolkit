                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        final slug = spell.id;
                        final importedFluff =
                            _fluffService.getFluff('spell', slug);
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Add caster notes, spell combos, component costs...',
                                hintStyle: TextStyle(
                                    fontSize: 12,
                                    color: theme.colorScheme.onSurfaceVariant
                                ...
                                focusedBorder: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(
                                      color: schoolColor, width: 1.5),
                                ),
                                contentPadding: const EdgeInsets.all(12),
                              ),
                              onChanged: (val) => _fluffService.setUserNotes(
                                  'spell', slug, val),
                            ),
                          ],
                        );
