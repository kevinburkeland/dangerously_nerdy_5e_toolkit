...
class ClassCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedClassType = DndClassType.tryParse(slug) ??
        DndClassType.tryParse(characterClass.name);
          ...
          Row(
            ...
            children: [
              if (resolvedClassType != null)
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: classColor.withValues(alpha: 0.55)),
                  ),
              ...
              IconButton(
                ...
                tooltip:
                    isPinned ? 'Remove from Bookmarks' : 'Pin to Bookmarks',
