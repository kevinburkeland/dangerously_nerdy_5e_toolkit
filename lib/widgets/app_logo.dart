...
class D20TechPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
      ...
      final glowPaint = Paint()
        ..shader = RadialGradient(
          ...
          stops: const [0.0, 0.65, 1.0],
            ...
            Rect.fromCircle(center: center, radius: d20Radius * 1.45));
    ...
    final vIn = [
      ...
      Offset(center.dx + rIn * math.cos(math.pi / 6),
          center.dy + rIn * math.sin(math.pi / 6)),
      Offset(center.dx + rIn * math.cos(5 * math.pi / 6),
          center.dy + rIn * math.sin(5 * math.pi / 6)),
    ];
  ...
  void _paintTechRings(
    ...
    if (scale >= 0.5) {
      _paintVectorCurvedBrandText(
          canvas, center, outerRingRadius + 4.2 * scale, scale);
    }
  }
  ...
  void _drawFacet(
    ...
    final cx =
        (facet.points[0].dx + facet.points[1].dx + facet.points[2].dx) / 3;
    final cy =
        (facet.points[0].dy + facet.points[1].dy + facet.points[2].dy) / 3;
    ...
    if (facet.isCenter) {
      ...
      fillPaint.shader = LinearGradient(
        ...
        colors: [
          ...
          Color.lerp(primaryColor, const Color(0xFF0F172A), 0.5)!
  ...
  void _drawVectorGlyph(
      Canvas canvas, String char, double w, double h, Paint paint) {
    final path = Path();
