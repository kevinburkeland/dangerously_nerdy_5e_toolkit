...
enum ItemCategory {
  ...
  ring('Ring & Band', Color(0xFFF59E0B), Color(0xFFFFFBEB), Color(0xFF78350F),
      GlyphFrameShape.circle),
  rod('Rod & Scepter', Color(0xFFA855F7), Color(0xFFFAF5FF), Color(0xFF581C87),
      GlyphFrameShape.heavySquare),
  ...
  wand('Wand & Baton', Color(0xFFF43F5E), Color(0xFFFFF1F2), Color(0xFF881337),
      GlyphFrameShape.diamond),
  ...
  gemstone('Gemstone', Color(0xFF06B6D4), Color(0xFFECFEFF), Color(0xFF164E63),
      GlyphFrameShape.diamond),
  artObject('Art Object', Color(0xFFC084FC), Color(0xFFFAF5FF),
      Color(0xFF581C87), GlyphFrameShape.crest),
  trinket('Trinket', Color(0xFF10B981), Color(0xFFECFDF5), Color(0xFF064E3B),
      GlyphFrameShape.circle);
...
/// 12 Core 5E Character Classes.
enum DndClassType {
  barbarian(
      'Barbarian', 12, Color(0xFFEF4444), GlyphFrameShape.heavySquare, 'Rage'),
  bard('Bard', 8, Color(0xFFEC4899), GlyphFrameShape.filigreeOval,
      'Bardic Inspiration'),
  cleric('Cleric', 8, Color(0xFFF59E0B), GlyphFrameShape.crest,
      'Channel Divinity'),
  druid('Druid', 8, Color(0xFF10B981), GlyphFrameShape.teardrop, 'Wild Shape'),
  fighter('Fighter', 10, Color(0xFFDC2626), GlyphFrameShape.heaterShield,
      'Action Surge'),
  monk('Monk', 8, Color(0xFF06B6D4), GlyphFrameShape.circle, 'Ki / Focus'),
  paladin('Paladin', 10, Color(0xFFFBBF24), GlyphFrameShape.sharpDiamondShield,
      'Lay on Hands'),
  ranger('Ranger', 10, Color(0xFF16A34A), GlyphFrameShape.softShield,
      'Spell Slots / Hunter'),
  rogue('Rogue', 8, Color(0xFF64748B), GlyphFrameShape.softRhombus,
      'Sneak Attack'),
  sorcerer('Sorcerer', 6, Color(0xFFF97316), GlyphFrameShape.diamond,
      'Sorcery Points'),
  warlock('Warlock', 8, Color(0xFFA855F7), GlyphFrameShape.octagon,
      'Pact Magic Slots'),
  wizard('Wizard', 6, Color(0xFF3B82F6), GlyphFrameShape.hexagon,
      'Arcane Recovery');
  ...
  static DndClassType? tryParse(String? nameOrSlug) {
    ...
    for (final c in values) {
      final cClean =
          c.name.toLowerCase().replaceAll('-', '').replaceAll('_', '');
      final dClean = c.displayName
          .toLowerCase()
          .replaceAll('-', '')
          .replaceAll('_', '')
          .replaceAll(' ', '');
...
enum FeatCategory {
  origin('Origin Feat (Level 1)', Color(0xFF38BDF8), 1,
      GlyphFrameShape.softRhombus),
  general(
      'General Feat (Level 4+)', Color(0xFFA855F7), 2, GlyphFrameShape.crest),
  epicBoon(
      'Epic Boon (Level 19+)', Color(0xFFF59E0B), 4, GlyphFrameShape.diamond);
  ...
  static FeatCategory parse(String? category) {
    ...
    if (lower.contains('boon') || lower.contains('epic'))
      return FeatCategory.epicBoon;
...
/// 9 Core 5E Species / Races across 2014 and 2024 rules editions.
enum SpeciesType {
  ...
  dragonborn(
      'Dragonborn', Color(0xFFEF4444), GlyphFrameShape.sharpDiamondShield),
  ...
  String getSize([DmRulesEdition edition = DmRulesEdition.v2024]) {
    ...
    return switch (this) {
      SpeciesType.human || SpeciesType.tiefling => 'Medium or Small',
      SpeciesType.halfling || SpeciesType.gnome => 'Small',
      _ => 'Medium',
    };
  }
  ...
  String getTraits([DmRulesEdition edition = DmRulesEdition.v2024]) {
    if (edition == DmRulesEdition.v2014) {
      return switch (this) {
        SpeciesType.human =>
          '+1 to All Ability Scores (or Feat + Skill for Variant)',
        SpeciesType.elf =>
          'Darkvision (60 ft), Keen Senses, Fey Ancestry, Trance, Elf Weapon Training',
        SpeciesType.dwarf =>
          'Speed 25 ft (Armor Unhindered), Darkvision (60 ft), Dwarven Resilience, Stonecunning',
        SpeciesType.halfling =>
          'Speed 25 ft, Lucky (Reroll 1s), Brave, Halfling Nimbleness, Naturally Stealthy',
        SpeciesType.dragonborn =>
          'Draconic Ancestry, Breath Weapon (Action), Damage Resistance',
        SpeciesType.gnome =>
          'Speed 25 ft, Darkvision (60 ft), Gnome Cunning (Advantage vs Magic)',
        SpeciesType.tiefling =>
          'Darkvision (60 ft), Hellish Resistance (Fire), Infernal Legacy',
        SpeciesType.orc =>
          'Darkvision (60 ft), Relentless Endurance, Savage Attacks, Menacing',
        SpeciesType.goliath =>
          'Natural Athlete, Stone\'s Endurance (1d12+Con), Powerful Build, Mountain Born',
      };
    }
    return switch (this) {
      SpeciesType.human =>
        'Resourceful (Heroic Inspiration), Skillful, Versatile (Origin Feat)',
      SpeciesType.elf =>
        'Darkvision (60 ft), Keen Senses, Fey Ancestry, Trance, Elven Lineage',
      SpeciesType.dwarf =>
        'Darkvision (120 ft), Dwarven Resilience, Dwarven Toughness (+1 HP/level), Stonecunning (Tremorsense 60 ft)',
      SpeciesType.halfling =>
        'Brave, Halfling Nimbleness, Luck, Naturally Stealthy',
      SpeciesType.dragonborn =>
        'Breath Weapon (Replaces Attack), Damage Resistance, Darkvision (60 ft), Flight (Lv 5)',
      SpeciesType.gnome =>
        'Darkvision (60 ft), Gnomish Cunning (Mental Saves), Gnomish Lineage (Forest/Rock)',
      SpeciesType.tiefling =>
        'Darkvision (60 ft), Fiendish Legacy (Abyssal/Chthonic/Infernal), Otherworldly Presence',
      SpeciesType.orc =>
        'Darkvision (120 ft), Adrenaline Rush (Dash + Temp HP), Relentless Endurance',
      SpeciesType.goliath =>
        'Giant Ancestry, Large Form (Bonus Action, Lv 5), Powerful Build, Stone\'s Endurance',
    };
  }
...
enum GenericUiGlyphType {
  ...
  advantage(
      'Advantage Beacon', Color(0xFF22C55E), GlyphFrameShape.upwardTriangle),
  disadvantage('Disadvantage Quench', Color(0xFFEF4444),
      GlyphFrameShape.invertedTriangle),
  concentrating('Concentrating', Color(0xFF38BDF8), GlyphFrameShape.circle),
  deathSave(
      'Death Save Telemetry', Color(0xFFF43F5E), GlyphFrameShape.tombstone),
  actionEconomyAction(
      'Standard Action', Color(0xFF3B82F6), GlyphFrameShape.diamond),
  actionEconomyBonus(
      'Bonus Action', Color(0xFFF59E0B), GlyphFrameShape.softRhombus),
  actionEconomyReaction(
      'Reaction Trigger', Color(0xFF06B6D4), GlyphFrameShape.heaterShield);
