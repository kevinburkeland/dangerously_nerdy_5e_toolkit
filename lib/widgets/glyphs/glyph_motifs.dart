...
class GlyphMotifs {
  ...
  static void drawItemMotif({
    ...
    switch (category) {
      case ItemCategory.weapon:
        ...
        canvas.drawCircle(
            center - Offset(5.5 * scale, 5.5 * scale), 1.1 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(5.5 * scale, -5.5 * scale), 1.1 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(5.5 * scale, 5.5 * scale), 1.1 * scale, nodeFill);
      ...
      case ItemCategory.armor:
        ...
        // Deflection rivets
        canvas.drawCircle(
            center - Offset(3.5 * scale, 4.0 * scale), 0.9 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(3.5 * scale, -4.0 * scale), 0.9 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(0, 1.8 * scale), 1.1 * scale, nodeFill);
      ...
      case ItemCategory.potion:
        ...
        canvas.drawCircle(
            center + Offset(0, 3.2 * scale), 1.2 * scale, nodeFill);
        canvas.drawCircle(
            center - Offset(1.8 * scale, -2.0 * scale), 0.9 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(2.0 * scale, 1.5 * scale), 0.8 * scale, nodeFill);
      ...
      case ItemCategory.ring:
        ...
        canvas.drawLine(center - Offset(0, 5.5 * scale),
            center - Offset(0, 7.5 * scale), primaryLine);
        canvas.drawCircle(
            center - Offset(0, 5.0 * scale), 1.0 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(0, 5.5 * scale), 1.0 * scale, nodeFill);
        canvas.drawCircle(
            center - Offset(5.5 * scale, 0), 1.0 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(5.5 * scale, 0), 1.0 * scale, nodeFill);
      ...
      case ItemCategory.staff:
        ...
        // Focus nodes
        canvas.drawCircle(
            center - Offset(0, 4.0 * scale), 1.2 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(0, 7.0 * scale), 1.1 * scale, nodeFill);
      ...
      case ItemCategory.wand:
        ...
        canvas.drawLine(
          center +
              Offset(-3.2 * scale, 4.8 * scale) -
              Offset(1.2 * scale, 1.2 * scale),
          center +
              Offset(-3.2 * scale, 4.8 * scale) +
              Offset(1.2 * scale, 1.2 * scale),
          primaryLine,
        ...
        canvas.drawCircle(
            center + Offset(5.5 * scale, -5.5 * scale), 1.2 * scale, nodeFill);
        canvas.drawCircle(
            center - Offset(4.5 * scale, -6.0 * scale), 1.0 * scale, nodeFill);
      ...
      case ItemCategory.wondrousItem:
        ...
        for (int i = 0; i < 8; i++) {
          ...
          final pOuter = Offset(center.dx + rStarOuter * cos(aOuter),
              center.dy + rStarOuter * sin(aOuter));
          final pInner = Offset(center.dx + rStarInner * cos(aInner),
              center.dy + rStarInner * sin(aInner));
          if (i == 0) {
      ...
      case ItemCategory.adventuringGear:
        ...
        final rpack =
            RRect.fromRectAndRadius(packRect, Radius.circular(1.5 * scale));
        ...
        canvas.drawCircle(
            Offset(center.dx - 2.2 * scale, center.dy + 0.5 * scale),
            0.8 * scale,
            nodeFill);
        canvas.drawCircle(
            Offset(center.dx + 2.2 * scale, center.dy + 0.5 * scale),
      ...
      case ItemCategory.artObject:
        ...
        final chalice = Path()
          ...
          ..quadraticBezierTo(center.dx, center.dy + 3.0 * scale, center.dx,
              center.dy + 3.0 * scale)
          ..lineTo(center.dx, center.dy + 5.0 * scale)
          ..lineTo(center.dx - 3.0 * scale, center.dy + 5.0 * scale)
          ..lineTo(center.dx + 3.0 * scale, center.dy + 5.0 * scale)
          ..moveTo(center.dx, center.dy + 3.0 * scale)
          ..quadraticBezierTo(center.dx, center.dy + 3.0 * scale,
              center.dx - 3.0 * scale, center.dy)
          ..close();
        canvas.drawPath(chalice, primaryLine);
        canvas.drawCircle(
            center - Offset(0, 2.0 * scale), 1.0 * scale, nodeFill);
    ...
    switch (classType) {
      case DndClassType.barbarian:
        ...
        final axeA = Path()
          ...
          ..quadraticBezierTo(center.dx - 3.0 * scale, center.dy - 5.5 * scale,
              center.dx - 2.0 * scale, center.dy - 3.0 * scale);
        final axeB = Path()
          ..moveTo(center.dx + 5.5 * scale, center.dy - 3.5 * scale)
          ..quadraticBezierTo(center.dx + 3.0 * scale, center.dy - 5.5 * scale,
              center.dx + 2.0 * scale, center.dy - 3.0 * scale);
      ...
      case DndClassType.bard:
        ...
        final lyre = Path()
          ...
          ..cubicTo(center.dx - 4.5 * scale, center.dy + 3.0 * scale, center.dx,
              center.dy + 5.0 * scale, center.dx, center.dy + 5.0 * scale)
          ..cubicTo(
              center.dx,
              center.dy + 5.0 * scale,
              center.dx + 4.5 * scale,
        ...
        canvas.drawLine(
            Offset(center.dx - 2.0 * scale, center.dy - 3.0 * scale),
            Offset(center.dx - 2.0 * scale, center.dy + 3.5 * scale),
            fineLine);
        canvas.drawLine(Offset(center.dx, center.dy - 3.0 * scale),
            Offset(center.dx, center.dy + 4.5 * scale), fineLine);
        canvas.drawLine(
            Offset(center.dx + 2.0 * scale, center.dy - 3.0 * scale),
            Offset(center.dx + 2.0 * scale, center.dy + 3.5 * scale),
            fineLine);
        canvas.drawCircle(
            center - Offset(4.5 * scale, 4.0 * scale), 1.0 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(4.5 * scale, -4.0 * scale), 1.0 * scale, nodeFill);
      ...
      case DndClassType.cleric:
        ...
        canvas.drawLine(center - Offset(0, 5.8 * scale),
            center + Offset(0, 5.8 * scale), primaryLine);
        canvas.drawLine(center - Offset(4.5 * scale, 1.8 * scale),
            center + Offset(4.5 * scale, -1.8 * scale), primaryLine);
        // 4 Radiant burst flares
        for (int i = 0; i < 4; i++) {
          final a = (i * 90.0 + 45.0) * pi / 180.0;
          canvas.drawLine(
            Offset(center.dx + 3.8 * scale * cos(a),
                center.dy + 3.8 * scale * sin(a)),
            Offset(center.dx + 5.5 * scale * cos(a),
                center.dy + 5.5 * scale * sin(a)),
            fineLine,
          );
        }
        canvas.drawCircle(
            center - Offset(0, 1.8 * scale), 1.2 * scale, nodeFill);

      case DndClassType.druid:
        // SACRED OAK LEAF & PRIMAL SPIRAL RUNES
        final leaf = Path()
          ..moveTo(center.dx, center.dy - 5.5 * scale)
          ..quadraticBezierTo(center.dx + 4.5 * scale, center.dy - 1.0 * scale,
              center.dx, center.dy + 5.5 * scale)
          ..quadraticBezierTo(center.dx - 4.5 * scale, center.dy - 1.0 * scale,
              center.dx, center.dy - 5.5 * scale);
        canvas.drawPath(leaf, primaryLine);
        // Central vein & spiral arcs
        canvas.drawLine(center - Offset(0, 5.0 * scale),
            center + Offset(0, 5.0 * scale), fineLine);
        canvas.drawLine(center - Offset(0, 2.0 * scale),
            center + Offset(2.5 * scale, -0.5 * scale), fineLine);
        canvas.drawLine(center + Offset(0, 1.0 * scale),
            center - Offset(2.5 * scale, -2.5 * scale), fineLine);
        canvas.drawCircle(center, 1.1 * scale, nodeFill);

      case DndClassType.fighter:
        // CROSSED LONGSWORDS & VANGUARD RETICLE
        canvas.drawLine(center - Offset(5.0 * scale, 5.0 * scale),
            center + Offset(5.0 * scale, 5.0 * scale), primaryLine);
        canvas.drawLine(center - Offset(-5.0 * scale, 5.0 * scale),
            center + Offset(-5.0 * scale, 5.0 * scale), primaryLine);
        // Crossguards
        canvas.drawLine(
          center -
              Offset(3.5 * scale, 3.5 * scale) -
              Offset(1.5 * scale, -1.5 * scale),
          center -
              Offset(3.5 * scale, 3.5 * scale) +
              Offset(1.5 * scale, -1.5 * scale),
          primaryLine,
      ...
      case DndClassType.monk:
        ...
        final chi = Path()
          ...
          ..quadraticBezierTo(center.dx + 2.5 * scale, center.dy - 2.4 * scale,
              center.dx, center.dy)
          ..quadraticBezierTo(center.dx - 2.5 * scale, center.dy + 2.4 * scale,
              center.dx, center.dy + 4.8 * scale);
        canvas.drawPath(chi, primaryLine);
        canvas.drawCircle(
            center - Offset(0, 2.4 * scale), 1.0 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(0, 2.4 * scale), 1.0 * scale, nodeHollow);
      ...
      case DndClassType.paladin:
        ...
        final shield = Path()
          ...
          ..quadraticBezierTo(center.dx, center.dy + 5.5 * scale, center.dx,
              center.dy + 5.5 * scale)
          ..quadraticBezierTo(center.dx - 4.5 * scale, center.dy,
              center.dx - 4.5 * scale, center.dy)
          ..close();
        canvas.drawPath(shield, primaryLine);
        // Central holy blade
        canvas.drawLine(center - Offset(0, 3.5 * scale),
            center + Offset(0, 3.5 * scale), primaryLine);
        canvas.drawLine(center - Offset(2.0 * scale, 1.5 * scale),
            center + Offset(2.0 * scale, -1.5 * scale), fineLine);
        canvas.drawCircle(
            center - Offset(0, 1.5 * scale), 1.0 * scale, nodeFill);
      ...
      case DndClassType.ranger:
        ...
        final bow = Path()
          ...
          ..quadraticBezierTo(center.dx + 4.0 * scale, center.dy,
              center.dx - 4.0 * scale, center.dy + 5.0 * scale);
        canvas.drawPath(bow, primaryLine);
        canvas.drawLine(center - Offset(4.0 * scale, 5.0 * scale),
            center - Offset(4.0 * scale, -5.0 * scale), fineLine);
        // Arrow
        canvas.drawLine(center - Offset(4.0 * scale, 0),
            center + Offset(5.0 * scale, 0), primaryLine);
        canvas.drawLine(center + Offset(3.5 * scale, -1.5 * scale),
            center + Offset(5.0 * scale, 0), primaryLine);
        canvas.drawLine(center + Offset(3.5 * scale, 1.5 * scale),
            center + Offset(5.0 * scale, 0), primaryLine);
      ...
      case DndClassType.rogue:
        ...
        canvas.drawLine(center - Offset(3.0 * scale, -2.0 * scale),
            center + Offset(3.0 * scale, 2.0 * scale), primaryLine);
        canvas.drawLine(center + Offset(0, 2.0 * scale),
            center + Offset(0, 5.0 * scale), primaryLine);
        // Stealth diamond ticks
        canvas.drawCircle(
            center - Offset(4.5 * scale, 0), 0.8 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(4.5 * scale, 0), 0.8 * scale, nodeFill);
      ...
      case DndClassType.sorcerer:
        ...
        for (int i = 0; i < vortexPts; i++) {
          ...
          final pt =
              Offset(center.dx + rOut * cos(a), center.dy + rOut * sin(a));
          if (i == 0) {
            vortex.moveTo(pt.dx, pt.dy);
          } else {
            vortex.lineTo(pt.dx, pt.dy);
      ...
      case DndClassType.warlock:
        ...
        final eye = Path()
          ...
          ..quadraticBezierTo(center.dx, center.dy - 3.5 * scale,
              center.dx + 5.0 * scale, center.dy)
          ..quadraticBezierTo(center.dx, center.dy + 3.5 * scale,
              center.dx - 5.0 * scale, center.dy);
        ...
        canvas.drawLine(center - Offset(0, 5.0 * scale),
            center - Offset(0, 3.5 * scale), fineLine);
        canvas.drawLine(center + Offset(0, 3.5 * scale),
            center + Offset(0, 5.0 * scale), fineLine);
      ...
      case DndClassType.wizard:
        ...
        for (int i = 0; i < 5; i++) {
          ...
          final pt = Offset(center.dx + 5.0 * scale * cos(a),
              center.dy + 5.0 * scale * sin(a));
          if (i == 0) {
  ...
  static void drawFeatMotif({
    ...
    if (lowerId.contains('radar') ||
        lowerId.contains('initiative') ||
        lowerId.contains('perceptive')) {
      ...
      canvas.drawLine(
          center,
          center +
              Offset(4.8 * scale * cos(pulseTurns * 2 * pi),
                  4.8 * scale * sin(pulseTurns * 2 * pi)),
          primaryLine);
      canvas.drawCircle(center, 1.2 * scale, nodeFill);
    } else if (lowerId.contains('focus') ||
        lowerId.contains('concentration') ||
        lowerId.contains('wand')) {
      // Crossed focus wand and concentration shield aegis
      canvas.drawLine(center - Offset(4.5 * scale, 4.5 * scale),
          center + Offset(4.5 * scale, 4.5 * scale), primaryLine);
      canvas.drawCircle(center, 3.5 * scale, primaryLine);
      canvas.drawCircle(
          center - Offset(4.5 * scale, 4.5 * scale), 1.0 * scale, nodeFill);
      canvas.drawCircle(
          center + Offset(4.5 * scale, 4.5 * scale), 1.0 * scale, nodeFill);
      canvas.drawCircle(center, 1.2 * scale, nodeFill);
    } else if (lowerId.contains('heavy') ||
        lowerId.contains('cleave') ||
        lowerId.contains('power_attack')) {
      ...
      canvas.drawCircle(center, 1.0 * scale, nodeFill);
    } else if (lowerId.contains('sniper') ||
        lowerId.contains('marksman') ||
        lowerId.contains('crosshair')) {
      ...
      canvas.drawLine(center - Offset(6.0 * scale, 0),
          center + Offset(6.0 * scale, 0), fineLine);
      canvas.drawLine(center - Offset(0, 6.0 * scale),
          center + Offset(0, 6.0 * scale), fineLine);
      canvas.drawCircle(center, 1.0 * scale, nodeFill);
    } else if (lowerId.contains('lockdown') ||
        lowerId.contains('perimeter') ||
        lowerId.contains('guardian')) {
      // Halberd restraint anchor & perimeter lockdown brackets
      canvas.drawCircle(center, 4.0 * scale, primaryLine);
      canvas.drawLine(center - Offset(0, 5.5 * scale),
          center + Offset(0, 5.5 * scale), primaryLine);
      canvas.drawLine(center - Offset(4.0 * scale, 0),
          center + Offset(4.0 * scale, 0), primaryLine);
      canvas.drawCircle(center, 1.4 * scale, nodeFill);
    } else if (lowerId.contains('clover') ||
        lowerId.contains('fortune') ||
        lowerId.contains('probability')) {
      // 4-Leaf quantum probability clover node
      for (int i = 0; i < 4; i++) {
        final a = (i * 90.0) * pi / 180.0;
        final pt = Offset(
            center.dx + 2.8 * scale * cos(a), center.dy + 2.8 * scale * sin(a));
      ...
      canvas.drawCircle(center, 4.5 * scale, primaryLine);
      canvas.drawLine(center - Offset(0, 5.5 * scale),
          center + Offset(0, 5.5 * scale), fineLine);
      canvas.drawLine(center - Offset(5.5 * scale, 0),
          center + Offset(5.5 * scale, 0), fineLine);
      canvas.drawCircle(center, 1.3 * scale, nodeFill);
    }
    ...
    switch (speciesType) {
      case SpeciesType.human:
        ...
        for (int i = 0; i < 8; i++) {
          ...
          canvas.drawLine(
              center,
              Offset(center.dx + len * cos(a), center.dy + len * sin(a)),
              primaryLine);
          canvas.drawCircle(
              Offset(center.dx + len * cos(a), center.dy + len * sin(a)),
              0.8 * scale,
      ...
      case SpeciesType.elf:
        ...
        final moon = Path()
          ..addArc(Rect.fromCircle(center: center, radius: 4.8 * scale),
              -pi * 0.45, pi * 0.9)
          ..quadraticBezierTo(
              center.dx + 1.5 * scale,
              center.dy,
              center.dx + 4.8 * scale * cos(-pi * 0.45),
              center.dy + 4.8 * scale * sin(-pi * 0.45));
        canvas.drawPath(moon, primaryLine);
        // Starlight diamond
        final star = Path()
      ...
      case SpeciesType.dwarf:
        ...
        canvas.drawLine(center - Offset(3.5 * scale, -3.5 * scale),
            center + Offset(3.5 * scale, 3.5 * scale), primaryLine);
        canvas.drawCircle(
            center - Offset(0, 1.5 * scale), 1.0 * scale, nodeFill);
      ...
      case SpeciesType.halfling:
        ...
        for (int i = 0; i < 4; i++) {
          final a = (i * 90.0) * pi / 180.0;
          final p = Offset(center.dx + 2.5 * scale * cos(a),
              center.dy + 2.5 * scale * sin(a));
      ...
      case SpeciesType.dragonborn:
        ...
        canvas.drawLine(center - Offset(0, 5.0 * scale),
            center + Offset(0, 5.0 * scale), fineLine);
        canvas.drawLine(center - Offset(3.5 * scale, 0),
            center + Offset(3.5 * scale, 0), fineLine);
        canvas.drawCircle(center, 1.2 * scale, nodeFill);
      ...
      case SpeciesType.gnome:
        ...
        for (int i = 0; i < 6; i++) {
          ...
          canvas.drawLine(
            Offset(center.dx + 4.2 * scale * cos(a),
                center.dy + 4.2 * scale * sin(a)),
            Offset(center.dx + 5.5 * scale * cos(a),
                center.dy + 5.5 * scale * sin(a)),
            primaryLine,
          );
      ...
      case SpeciesType.tiefling:
        ...
        final hornA = Path()
          ...
          ..quadraticBezierTo(center.dx - 5.0 * scale, center.dy - 1.0 * scale,
              center.dx - 3.0 * scale, center.dy - 5.0 * scale);
        final hornB = Path()
          ..moveTo(center.dx + 3.5 * scale, center.dy + 4.0 * scale)
          ..quadraticBezierTo(center.dx + 5.0 * scale, center.dy - 1.0 * scale,
              center.dx + 3.0 * scale, center.dy - 5.0 * scale);
        ...
        canvas.drawCircle(
            center + Offset(0, 2.0 * scale), 1.4 * scale, nodeFill);
      ...
      case SpeciesType.orc:
        ...
        canvas.drawLine(center - Offset(4.0 * scale, 3.0 * scale),
            center + Offset(4.0 * scale, -3.0 * scale), fineLine);
        canvas.drawCircle(
            center - Offset(0, 2.0 * scale), 1.2 * scale, nodeFill);
      ...
      case SpeciesType.goliath:
        ...
        canvas.drawLine(center - Offset(0, 5.0 * scale),
            center + Offset(0, 4.0 * scale), fineLine);
        canvas.drawLine(center - Offset(2.5 * scale, 1.0 * scale),
            center + Offset(2.5 * scale, 1.0 * scale), fineLine);
        canvas.drawCircle(center, 1.2 * scale, nodeFill);
    }
  ...
  static void drawGenericUiMotif({
    ...
    switch (uiType) {
      ...
      case GenericUiGlyphType.d6:
        ...
        canvas.drawLine(
            center, Offset(center.dx, center.dy - 5.5 * scale), fineLine);
        canvas.drawLine(center,
            Offset(center.dx + 4.5 * scale, center.dy + 2.8 * scale), fineLine);
        canvas.drawLine(center,
            Offset(center.dx - 4.5 * scale, center.dy + 2.8 * scale), fineLine);
        canvas.drawCircle(center, 1.0 * scale, nodeFill);
      ...
      case GenericUiGlyphType.d8:
        ...
        canvas.drawLine(Offset(center.dx - 4.5 * scale, center.dy),
            Offset(center.dx + 4.5 * scale, center.dy), fineLine);
        canvas.drawLine(
            Offset(center.dx, center.dy - 5.5 * scale), center, fineLine);
        canvas.drawLine(
            Offset(center.dx, center.dy + 5.5 * scale), center, fineLine);
        canvas.drawCircle(center, 1.1 * scale, nodeFill);
      ...
      case GenericUiGlyphType.d10:
        ...
        canvas.drawLine(
            Offset(center.dx, center.dy - 5.5 * scale), center, fineLine);
        canvas.drawLine(
            Offset(center.dx + 4.5 * scale, center.dy - 1.0 * scale),
            center,
            fineLine);
        canvas.drawLine(
            Offset(center.dx - 4.5 * scale, center.dy - 1.0 * scale),
      ...
      case GenericUiGlyphType.d20:
        ...
        for (int i = 0; i < 6; i++) {
          ...
          final pt = Offset(center.dx + 5.2 * scale * cos(a),
              center.dy + 5.2 * scale * sin(a));
          if (i == 0) {
        ...
        for (int i = 0; i < 3; i++) {
          ...
          final pt = Offset(center.dx + 3.0 * scale * cos(a),
              center.dy + 3.0 * scale * sin(a));
          if (i == 0) {
      ...
      case GenericUiGlyphType.d100:
        ...
        canvas.drawCircle(
            center - Offset(2.2 * scale, 0), 3.2 * scale, primaryLine);
        canvas.drawCircle(
            center + Offset(2.2 * scale, 0), 3.2 * scale, fineLine);
        canvas.drawCircle(center, 1.0 * scale, nodeFill);
      ...
      case GenericUiGlyphType.concentrating:
        ...
        final orbitA = Rect.fromCenter(
            center: center, width: 11.0 * scale, height: 7.2 * scale);
        final orbitB = Rect.fromCenter(
            center: center, width: 7.2 * scale, height: 11.0 * scale);
      ...
      case GenericUiGlyphType.deathSave:
        ...
        canvas.drawCircle(
            center - Offset(1.2 * scale, 4.5 * scale), 0.9 * scale, nodeFill);
        canvas.drawCircle(
            center + Offset(0.8 * scale, -4.5 * scale), 0.9 * scale, nodeFill);
      ...
      case GenericUiGlyphType.actionEconomyBonus:
        ...
        for (int i = 0; i < 3; i++) {
          ...
          canvas.drawLine(
            center,
            Offset(center.dx + 5.0 * scale * cos(a),
                center.dy + 5.0 * scale * sin(a)),
            primaryLine,
          );
          canvas.drawCircle(
      ...
      case GenericUiGlyphType.actionEconomyReaction:
        ...
        canvas.drawLine(center + Offset(4.0 * scale, -4.0 * scale),
            center + Offset(4.0 * scale, 4.0 * scale), fineLine);
        canvas.drawCircle(
            center + Offset(2.0 * scale, 0), 1.2 * scale, nodeFill);
    }
