...
class CharacterVitalsHud extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
                      ...
                      child: ConstrainedBox(
                        ...
                        child: FilledButton.tonalIcon(
                          ...
                          label: const Text('Long Rest',
                              style: TextStyle(fontWeight: FontWeight.bold)),
                          onPressed: () =>
                              _showLongRestConfirmationDialog(context),
                        ),
                      ),
                    ),
                  ),
        ...
        if (isDowned ||
            resources.deathSaveSuccesses > 0 ||
            resources.deathSaveFailures > 0) ...[
          const SizedBox(height: 10),
  ...
  Widget _buildPassiveSensesCard(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
              child: _buildPassiveSenseItem(theme, 'Perception',
                  stats.passivePerception, Icons.visibility_outlined)),
          Expanded(
              child: _buildPassiveSenseItem(theme, 'Insight',
                  stats.passiveInsight, Icons.psychology_outlined)),
          Expanded(
              child: _buildPassiveSenseItem(theme, 'Investig.',
                  stats.passiveInvestigation, Icons.search_outlined)),
        ],
      ),
    );
  }

  Widget _buildPassiveSenseItem(
      ThemeData theme, String label, int value, IconData icon) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      mainAxisSize: MainAxisSize.min,
      children: [
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Center(
                            child: Icon(
                              ...
                              size: 22,
                              color:
                                  isChecked ? Colors.red : Colors.grey.shade600,
                            ),
                          ),
                        ),
                      ),
          ...
          Row(
            ...
            children: [
              ...
              Semantics(
                button: true,
                label:
                    'Heroic Inspiration ${hasInspiration ? "Active" : "Inactive"}',
                child: Material(
                    ...
                    child: InkWell(
                      onTap: exhaustionLevel > 0
                          ? () {
                              HapticService.selectionTick(context);
                              controller
                                  .setExhaustionLevel(exhaustionLevel - 1);
                            }
                          : null,
          ...
          Wrap(
            ...
            children: character.progression.classes.map((c) {
              ...
              return Semantics(
                button: true,
                label:
                    'Spend or recover $die hit die, $current of $max available',
                child: InkWell(
                  onTap: () {
                    HapticService.selectionTick(context);
                    if (current > 0) {
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                            color: arenaCond.colorTheme.withValues(alpha: 0.6)),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(arenaCond.icon,
                              size: 14, color: arenaCond.colorTheme),
                          const SizedBox(width: 4),
                          Text(
  ...
  void _showConditionDialog(
      BuildContext context, CharacterCondition cond, ArenaCondition arenaCond) {
    final theme = Theme.of(context);
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                    color: arenaCond.colorTheme.withValues(alpha: 0.3)),
              ),
              child: Text(
            ...
            child: FilledButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                        'Long rest completed! HP, spell slots, and hit dice restored.'),
