...
class AddFeatDialog extends StatefulWidget {
  ...
  static Future<void> show(
      BuildContext context, CharacterSheetController controller) {
  ...
  List<String> _getEligibleToolChoices(Feat feat) {
    for (final g in feat.grants) {
      if (g.type == GrantType.bonusTool &&
          (g.payload['tool'] == null || g.payload['tool'].toString().isEmpty)) {
    ...
    if (rawTools is List) {
      for (final item in rawTools) {
        if (item is Map &&
            (item.containsKey('anyArtisansTool') || item.containsKey('any'))) {
          return SrdProficienciesLibrary.artisansTools;
        }
      }
    }
    ...
    if (_isCustomMode) {
      ...
      if (name.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Please enter a name for the custom feat.')),
        );
        return;
      }
      ...
      final eligible = feat.hasExpertiseChoice
          ? _getEligibleExpertiseSkills(_chosenSkill)
          : <SkillType>[];
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'Search feats by name or keyword...',
                                    prefixIcon:
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'e.g. DM granted bonus feat for completing trial, Level 1 human, etc.',
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8),
                  ElevatedButton.icon(
                    onPressed: (_isCustomMode || _selectedFeat != null)
                        ? _submit
                        : null,
          ...
          child: filtered.isEmpty
              ? const Center(
                  child: Padding(
                      ...
                      child: Text('No matching feats found.')))
              : ListView.separated(
        ...
        children: [
          Row(
            children: [
              ...
              Chip(
                label:
                    Text(feat.category, style: const TextStyle(fontSize: 10)),
            ...
            if (feat.requiresAbilityChoice)
              Wrap(
                ...
                children: feat.selectableAbilities.map((ab) {
                  final isSel =
                      (_chosenAbility ?? feat.selectableAbilities.first) == ab;
                  return ChoiceChip(
            ...
            DropdownButtonFormField<SkillType>(
              ...
              items: feat.selectableSkills.map((sk) {
                return DropdownMenuItem(
                  value: sk,
                  child: Text(
                      '${sk.displayName} (${sk.defaultAbility.shortName})',
          ...
          if (feat.hasExpertiseChoice) ...[
            ...
            () {
              ...
              return DropdownButtonFormField<SkillType>(
                key:
                    ValueKey('add_feat_expertise_${activeValue}_$_chosenSkill'),
                      ...
                      children: [
                        ...
                        if (isSameAsNew) ...[
                          ...
                          Container(
                            ...
                            child: const Text('New Skill Selected Above',
                                style: TextStyle(
                                    fontSize: 9.5, color: Colors.greenAccent)),
                          ),
                        ],
                      ],
                    ),
          ...
          if (feat.hasInvocationChoice) ...[
            () {
              ...
              final activeInvocationId =
                  eligibleInvocations.any((o) => o.id == _chosenOptionId)
                      ? _chosenOptionId
                      : (eligibleInvocations.isNotEmpty
                          ? eligibleInvocations.first.id
                          : null);
              final selectedOpt = eligibleInvocations
                  .where((o) => o.id == activeInvocationId)
                  .firstOrNull;
          ...
          if (feat.hasFightingStyleChoice) ...[
            () {
              final activeStyleId = SrdFeatureOptions.fightingStyles
                      .any((o) => o.id == _chosenOptionId)
                  ? _chosenOptionId
                  : (SrdFeatureOptions.fightingStyles.isNotEmpty
                      ? SrdFeatureOptions.fightingStyles.first.id
                      : null);
              final selectedOpt = SrdFeatureOptions.fightingStyles
                  .where((o) => o.id == activeStyleId)
                  .firstOrNull;
