  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final primaryClassType =
            DndClassType.tryParse(firstClass?.classRef.slug) ??
                              ...
                              onTap: () {
                                ...
                                LevelUpWizardDialog.show(
                                  ...
                                  onLevelUpApplied: (upgraded) async {
                                    await controller.setCharacter(upgraded,
                                        persist: true);
                                  },
                                );
                              },
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            content: Text(
                                '${character.name} sheet reparsed & updated!'),
                          ),
                        );
                      }
                    },
