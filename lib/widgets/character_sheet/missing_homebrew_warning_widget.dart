...
class MissingHomebrewBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final amberBg = isDark ? const Color(0xFF332005) : const Color(0xFFFFF8E1);
    final amberBorder =
        isDark ? const Color(0xFFB45309) : const Color(0xFFFFB300);
    final amberText =
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          onTap: () => showMissingHomebrewDialog(context,
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
                      side:
                          BorderSide(color: amberBorder.withValues(alpha: 0.4)),
                    ),
                  ),
                  child: Text(
                    'Details',
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.warning_amber_rounded,
                size: 12, color: Colors.amberAccent.shade400),
