...
class ModifyAbilityScoresDialog extends StatefulWidget {
  ...
  @override
  State<ModifyAbilityScoresDialog> createState() =>
      _ModifyAbilityScoresDialogState();
}
...
class _ModifyAbilityScoresDialogState extends State<ModifyAbilityScoresDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasChanges =
        AbilityType.values.any((a) => _scores[a] != baseScores.getScore(a));
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: const Icon(Icons.remove_circle_outline,
                                  size: 22),
                              color:
                                  curVal > 1 ? Colors.white70 : Colors.white24,
                              onPressed: curVal > 1
                                  ? () => _updateScore(ability, curVal - 1)
                                  : null,
                            ),
                            SizedBox(
                              width: 44,
                            ...
                            IconButton(
                              icon: const Icon(Icons.add_circle_outline,
                                  size: 22),
                              color:
                                  curVal < 30 ? Colors.white70 : Colors.white24,
                              onPressed: curVal < 30
                                  ? () => _updateScore(ability, curVal + 1)
                                  : null,
                            ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            'e.g. Drank Potion of Constitution (+1 Con), Manual DM adjustment, etc.',
                        hintStyle:
