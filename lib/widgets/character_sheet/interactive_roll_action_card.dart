...
class InteractiveRollActionCard extends StatelessWidget {
  ...
  void _dispatchRoll(BuildContext context,
  ...
  void _rollAttack(BuildContext context) {
    ...
    _dispatchRoll(context,
        isDamage: false, label: 'Attack Roll', formula: '1d20$bonusStr');
  }

  void _rollDamage(BuildContext context) {
    _dispatchRoll(context,
        isDamage: true,
        label: '${attack.damageType.name.toUpperCase()} Damage',
          ...
          Row(
            children: [
              ...
              Semantics(
                button: true,
                label:
                    'Roll ${attack.weaponName} Attack ${attack.attackBonusString}',
                child: InkWell(
              ...
              Semantics(
                button: true,
                label:
                    'Roll ${attack.weaponName} Damage ${attack.damageFormula}',
                child: InkWell(
