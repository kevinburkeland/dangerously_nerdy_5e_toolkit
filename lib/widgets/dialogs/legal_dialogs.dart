...
class LegalDialogs {
  ...
  static void showAttribution(BuildContext context) => _show(
        ...
        title: 'Legal & SRD 5.1 / 5.2.1 Attribution',
    ...
    return Column(
      ...
      children: [
        Text(
          'Privacy Policy',
          style: TextStyle(
              color: headingColor, fontWeight: FontWeight.bold, fontSize: 16),
        ),
        ...
        Text(
          ...
          style: TextStyle(
              color: headingColor, fontSize: 12, fontWeight: FontWeight.bold),
        ),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
              color: purpleHeader, fontWeight: FontWeight.bold, fontSize: 15),
        ),
        ...
        Text(
          ...
          '• Tabletop Game Mechanics: Rules text, spell statistics, creature stat blocks, and mechanics derived from Wizards of the Coast SRD 5.1 & SRD 5.2.1 are licensed under the Creative Commons Attribution 4.0 International License (CC-BY-4.0).',
          style: TextStyle(
              color: theme.colorScheme.onSurface.withValues(alpha: 0.85),
              fontSize: 12,
              height: 1.4),
        ...
        const SizedBox(height: 14),
        Text(
          'System Reference Document 5.1 & 5.2.1 (SRD 5.1 & SRD 5.2.1) Attribution',
          style: TextStyle(
              color: cyanHeader, fontWeight: FontWeight.bold, fontSize: 15),
        ),
        const SizedBox(height: 6),
        Text(
