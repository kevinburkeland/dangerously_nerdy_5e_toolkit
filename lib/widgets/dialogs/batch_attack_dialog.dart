...
class _BatchAttackDialogState extends State<BatchAttackDialog> {
  ...
  void _rollAttacks() {
    ...
    if (_lastAttackRollTime != null &&
        now.difference(_lastAttackRollTime!).inMilliseconds < 200) {
      return;
    }
    ...
    if (activeCode != null && activePlayer != null) {
      ...
      final summaryId =
          '${timestamp.microsecondsSinceEpoch}_batch_${secureRandom.nextInt(1000000)}';
      ...
      final attackDetails = summary.results.map((res) {
        final d20Str = res.d20Roll2 != null
            ...
            : 'd20 [${res.finalD20}]';
        final toHitStr =
            '$d20Str + ${res.object.attackBonus} = ${res.totalToHit} vs AC $_targetAc';
      ...
      final summaryRoll = RoomRoll(
        ...
        timestamp: timestamp,
        formulaString:
            'Batch Attack (${summary.totalHits}/${summary.totalAttacks} Hits vs AC $_targetAc)',
  ...
  Widget build(BuildContext context) {
    final livingCount =
        widget.session.activeObjects.where((o) => !o.isDead).length;
                              ...
                              FittedBox(
                                ...
                                child: SegmentedButton<RollMode>(
                                  ...
                                  onSelectionChanged: (set) =>
                                      _onManualRollModeChanged(set.first),
                                ),
                              ),
                            ],
                          );
                            ...
                            if (_showTacticalConditions) ...[
                              ...
                              Padding(
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    FilterChip(
                                      label: const Text('Target Prone (Melee)',
                      ...
                      Container(
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile(
                            ...
                            onChanged: (val) =>
                                setState(() => _useMaximizedCrits = val),
                          ),
                        ),
                      ),
