...
class ConditionReferenceDialog extends StatefulWidget {
  ...
  @override
  State<ConditionReferenceDialog> createState() =>
      _ConditionReferenceDialogState();
}
...
class _ConditionReferenceDialogState extends State<ConditionReferenceDialog> {
  ...
  Widget _buildConditionIcon(
      DmReferenceItem item, Color itemColor, bool isDark) {
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Search conditions (e.g., Blinded, Prone, Invisible, Exhaustion)...',
                  hintStyle: TextStyle(
                      color: theme.colorScheme.onSurfaceVariant
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: _buildConditionIcon(
                                          item, itemColor, isDark),
                                    ),
