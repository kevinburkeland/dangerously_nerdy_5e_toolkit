      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                tooltip:
                    isPinned ? 'Remove from My Bestiary' : 'Pin to My Bestiary',
          ...
          Wrap(
            ...
            children: [
              ...
              _buildStatChip(
                ...
                label:
                    'AC ${statBlock.ac}${statBlock.armorType != null ? ' (${statBlock.armorType})' : ''}',
                color:
              ...
              _buildStatChip(
                ...
                label:
                    'HP ${statBlock.maxHp}${statBlock.hitDice != null ? ' (${statBlock.hitDice})' : ''}',
                color:
              ...
              _buildStatChip(
                ...
                label:
                    '~${monster.calculateBaselineDpr(edition).toStringAsFixed(1)} DPR',
                color:
          ...
          if (statBlock.traits.isNotEmpty ||
              statBlock.actions.isNotEmpty ||
              statBlock.legendaryActions.isNotEmpty) ...[
            Wrap(
              spacing: 4,
              runSpacing: 4,
              children: [
                if (statBlock.hasLegendaryResistance)
                  _buildTraitPill(
                    statBlock.traits
                        .firstWhere((t) => t.name
                            .toLowerCase()
                            .contains('legendary resistance'))
                        .name,
                    isDark ? const Color(0xFFFDE047) : const Color(0xFFB45309),
                  ),
                if (statBlock.legendaryActions.isNotEmpty ||
                    statBlock.hasLegendaryActions)
                  _buildTraitPill(
                ...
                ...statBlock.traits
                    .where((t) =>
                        !t.name.toLowerCase().contains('legendary resistance'))
                    .take(2)
                    .map(
                ...
                if (statBlock.damageResistances != null &&
                    statBlock.damageResistances!.isNotEmpty)
                  _buildTraitPill(
                    'Resistances',
                    isDark ? Colors.amberAccent : const Color(0xFFB45309),
                  ),
                if (statBlock.damageImmunities != null &&
                    statBlock.damageImmunities!.isNotEmpty)
                  _buildTraitPill(
                    'Immunities',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon,
              size: 12,
              color: isFilled ? color : theme.colorScheme.onSurfaceVariant),
          const SizedBox(width: 4),
          Flexible(
            child: Text(
              label,
    ...
    return InkWell(
      onTap: onQuickRoll != null && action.attackBonus != null
          ? () {
              ...
              onQuickRoll!(rollFormula,
                  '${monster.name} - ${action.name} (Attack Roll)');
            }
          : null,
      borderRadius: BorderRadius.circular(4),
      child: Container(
