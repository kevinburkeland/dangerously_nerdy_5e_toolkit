...
class MonsterComparisonDialog extends StatefulWidget {
  ...
  @override
  State<MonsterComparisonDialog> createState() =>
      _MonsterComparisonDialogState();
}
            ...
            Expanded(
              child: showDualView
                  ...
                  : SingleChildScrollView(
                      child: _buildStatBlockBody(
                          context, statBlock, _activeEdition),
                    ),
            ),
          ],
        ),
  ...
  Widget _buildStatBlockBody(
    ...
    return Column(
      ...
      children: [
        ...
        if (sb.senses.isNotEmpty) _buildInfoRow('Senses', sb.senses, theme),
  ...
  Widget _buildAbilityScore(String name, int score) {
    return Column(
      children: [
        ...
        Text(Dnd5eScoreMath.formatScoreWithModifier(score),
