    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          _buildTipCard(
            'SRD 5.1 & SRD 5.2.1 Legal Notice',
            'All text, formulas, and creature stats above are strictly taken from the SRD 5.1 and SRD 5.2.1 under Creative Commons CC-BY-4.0 attribution.',
          ),
          _buildTipCard(
