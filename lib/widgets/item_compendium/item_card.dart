      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: rarityColor.withValues(alpha: 0.45)),
                ),
                child: Text(
          ...
          Wrap(
            ...
            runSpacing: 4,
            children: [
              _buildBadge(context, Icons.category_outlined,
                  item.category.displayName, categoryColor),
              _buildBadge(context, Icons.diamond_outlined,
                  item.rarity.displayName, rarityColor),
          ...
          FormattedMarkdownText(
            ...
            overflow:
                rules.description.contains('|') ? null : TextOverflow.ellipsis,
            style: TextStyle(
              fontSize: 12.5,
              height: 1.35,
                ...
                children: item.actionRings.map((ring) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(5),
                      border:
                          Border.all(color: ringColor.withValues(alpha: 0.5)),
                    ),
                    child: Row(
