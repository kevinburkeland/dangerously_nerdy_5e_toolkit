...
class _ItemDetailDialogState extends State<ItemDetailDialog>
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      backgroundColor:
          isDark ? const Color(0xFF0D111D) : theme.colorScheme.surface,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                DndGlyph.item(
                  ...
                  damageAccent:
                      item.getGlyphPrimaryDamageAccent(_activeEdition),
            ...
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [
                  _buildRulesTab(context, item, rules, isDark, rarityColor,
                      categoryColor, priceColor),
                  _buildCraftingTab(
                      context, item, crafting, isDark, rarityColor, priceColor),
                  if (hasDiff)
                  ...
                  children: [
                    TextButton.icon(
                      ...
                      label: Text(
                        ...
                        style: TextStyle(
                            color: _pinned ? pinColor : null, fontSize: 12),
                      ),
                    ),
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildDetailRow(
                    'Market Price', item.getEffectivePrice(_activeEdition),
                    color: priceColor),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildCraftingCard(
            ...
            children: [
              _buildDetailRow('Primary Tool', crafting.primaryTool,
                  color: Colors.amber),
              if (crafting.alternativeTools.isNotEmpty)
                _buildDetailRow(
                    'Alternate Tools', crafting.alternativeTools.join(', ')),
              _buildDetailRow('Raw Materials Cost', crafting.goldCostDisplay,
                  color: goldColor),
              if (crafting.isConsumable)
                _buildDetailRow('Consumable Item',
                    'Half crafting time & gold cost (Potions/Scrolls/Ammo)',
          ...
          _buildCraftingCard(
            ...
            children: [
              ...
              _buildDetailRow(
                  'Formula / Schematic',
                  crafting.formulaRequired
                      ? 'Arcane Formula Required'
                      : 'Standard Recipe / Blueprint'),
              _buildDetailRow('2024 Bastion Facility', crafting.bastionFacility,
          ...
          _buildCraftingCard(
            ...
            children: [
              _buildDetailRow(
                  'Creature / Harvest CR', crafting.exoticIngredientCr,
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child:
                            Icon(Icons.arrow_right, size: 16, color: goldColor),
                      ),
                      Expanded(
                        child: Text(
                          note,
  ...
  Widget _buildLoreNotesTab(
      BuildContext context, MagicItem item, Color accentColor) {
    final theme = Theme.of(context);
    final slug = item.id;
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Add campaign loot history, attuned owner, sentient item personality...',
              hintStyle: TextStyle(
                  fontSize: 12,
              ...
              Flexible(
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    final classSummary = char.progression.classes
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        final resolvedSlot =
                            InventoryTransactionService.resolveDefaultSlot(
                        ...
                        final newInstance = InventoryItemInstance(
                          instanceId:
                              'item-${widget.item.id}-${DateTime.now().millisecondsSinceEpoch}',
                          itemRef: EntityReference(
                            refType: EntityType.equipment,
                            slug: widget.item.id.replaceAll('_', '-'),
                            displayName: widget.item.name,
                        ...
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                  'Added ${widget.item.name} to ${char.name}\'s inventory!'),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                        }
