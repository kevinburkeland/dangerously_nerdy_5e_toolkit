...
class _FeatDetailDialogState extends State<FeatDetailDialog> {
  ...
  void initState() {
    ...
    final existingNotes =
        _fluffService.getUserNotes('feat', widget.feat.id.slug) ?? '';
  ...
  Widget build(BuildContext context) {
    ...
    final categoryLabel =
        (!is2024Mode && feat.category.toLowerCase() == 'origin')
            ? 'General'
            : feat.category;
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '$categoryLabel Feat • ${is2024Mode ? "2024 Rules (SRD 5.2.1)" : (isHomebrew ? "Custom Homebrew" : "2014 Rules (SRD 5.1)")}',
                        style: TextStyle(
                          color: accentColor,
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        final importedFluff =
                            _fluffService.getFluff('feat', slug);
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              onChanged: (val) =>
                                  _fluffService.setUserNotes('feat', slug, val),
                            ),
                          ],
                        );
                      },
