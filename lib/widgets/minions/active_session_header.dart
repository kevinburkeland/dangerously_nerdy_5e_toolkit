      ...
      child: Column(
        children: [
          AnimatedResourceMeter(
            ...
            fillColor:
                isOverBudget ? tabletop.fumbleRed : theme.colorScheme.primary,
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.health_and_safety_outlined,
                            color: tabletop.tempHpCyan, size: 18),
                        const SizedBox(width: 8),
                        Text('Grant Group Temp HP',
                            style:
                                TextStyle(color: theme.colorScheme.onSurface)),
                      ],
                    ),
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.health_and_safety,
                            color: tabletop.hitGreen, size: 18),
                        const SizedBox(width: 8),
                        Text('Heal All Objects',
                            style:
                                TextStyle(color: theme.colorScheme.onSurface)),
                      ],
                    ),
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.delete_sweep,
                            color: tabletop.fumbleRed, size: 18),
                        const SizedBox(width: 8),
                        Text('Clear Squad',
                            style: TextStyle(color: tabletop.fumbleRed)),
                      ],
                    ),
                  ),
                ],
