...
class ObjectCard extends StatelessWidget {
  ...
  Future<void> _showEditNameDialog(BuildContext context) async {
    ...
    final newName =
        await ValueInputDialog.showRename(context, initialName: object.name);
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: isDead
              ? customColors.fumbleRed.withValues(alpha: 0.5)
          ...
          children: [
              ...
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.info_outline,
                      size: 20, color: accentColor.withValues(alpha: 0.85)),
                  tooltip: 'Full Creature Stat Block',
                  onPressed: () => CreatureStatBlockDialog.show(context,
                      statBlock: object.statBlock),
                ),
                IconButton(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildStatBlock(context, 'AC', '${object.ac}',
                      isDark ? Colors.lightBlueAccent : const Color(0xFF0369A1),
                      semanticName: 'Armor Class', isHero: true),
                  _buildDivider(context),
                  _buildStatBlock(context, 'TO HIT', '+${object.attackBonus}',
                      isDark ? Colors.amberAccent : const Color(0xFFB45309),
                      semanticName: 'Attack Bonus', isHero: true),
                  _buildDivider(context),
                  _buildStatBlock(context, 'DMG', object.damageFormula,
                      isDark ? Colors.orangeAccent : const Color(0xFFC2410C),
                      semanticName: 'Damage Formula', isHero: true),
                  _buildDivider(context),
                  _buildStatBlock(context, 'STR', '${size.strScore}',
                      theme.colorScheme.onSurface,
                      semanticName: 'Strength Score'),
                  _buildDivider(context),
                  _buildStatBlock(context, 'DEX', '${size.dexScore}',
                      theme.colorScheme.onSurface,
                      semanticName: 'Dexterity Score'),
                ],
              ),
            ),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Semantics(
                    label:
                        '${object.name} Hit Points: ${isDead ? "Destroyed" : "${object.currentHp} of ${object.maxHp}"}${object.tempHp > 0 ? ", plus ${object.tempHp} temporary HP" : ""}. ${(object.hpPercent * 100).toInt()} percent remaining. Tap to edit custom HP.',
                    button: true,
                              ...
                              Row(
                                children: [
                                  Text(
                                    isDead
                                        ? '💀 DESTROYED'
                                        : 'HP: ${object.currentHp} / ${object.maxHp}',
                                    style: TextStyle(
                                      color: isDead
                              ...
                              children: [
                                ...
                                if (object.tempHp > 0)
                                  FractionallySizedBox(
                                    widthFactor:
                                        ((object.currentHp + object.tempHp) /
                                                object.maxHp)
                                            .clamp(0.0, 1.0),
                                    child: Container(
                                      height: 8,
                                ...
                                FractionallySizedBox(
                                  widthFactor: (object.currentHp / object.maxHp)
                                      .clamp(0.0, 1.0),
                                  child: Container(
                                    height: 8,
                                    decoration: BoxDecoration(
  ...
  Widget _buildStatBlock(
      ...
      {required String semanticName, bool isHero = false}) {
    final theme = Theme.of(context);
    return Semantics(
        ...
        child: Semantics(
          ...
          child: Material(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(
                color:
                    enabled ? color.withValues(alpha: 0.6) : Colors.transparent,
              ),
            ),
            child: InkWell(
              borderRadius: BorderRadius.circular(10),
