                ...
                Row(
                  ...
                  children: [
                    FilterChip(
                      ...
                      label: const Text('Halfling Luck',
                          style: TextStyle(fontSize: 11)),
                      tooltip:
                          'Reroll natural 1s on attack rolls (Halfling Luck / Lucky trait)',
                      ...
                      onSelected: (val) {
                        ...
                        onProfileChanged(
                            profile.copyWith(hasHalflingLuck: val));
                      },
                    ),
                    ...
                    FilterChip(
                      ...
                      label: const Text('Anything Goes',
                          style: TextStyle(fontSize: 11)),
                      tooltip:
                          'Unlock and mix all 2014 & 2024 feats, fighting styles, and weapon masteries',
              ...
              children: [
                Expanded(
                  child: NumericStepper(
                    ...
                    onChanged: (val) {
                      ...
                      onProfileChanged(
                          profile.copyWith(level: val, proficiencyBonus: pb));
                    },
                  ),
                ),
                ...
                Expanded(
                  child: NumericStepper(
                    ...
                    display: Dnd5eScoreMath.formatScoreWithModifier(
                    ...
                    onChanged: (val) {
                      ...
                      final updatedAttacks = profile.attacks.map((a) {
                        return a.copyWith(
                          abilityModForAgonizing: a.hasAgonizingBlast
                              ? newMod
                              : a.abilityModForAgonizing,
                          abilityModForGraze:
                              a.weaponMastery == WeaponMastery.graze
                                  ? newMod
                                  : a.abilityModForGraze,
                        );
                      }).toList();
                      onProfileChanged(profile.copyWith(
                          abilityScore: val, attacks: updatedAttacks));
                    },
                  ),
                ),
                const SizedBox(width: 8),
                  ...
                  onPressed: profile.sneakAttackDiceCount > 0
                      ? () => onProfileChanged(profile.copyWith(
                          sneakAttackDiceCount:
                              profile.sneakAttackDiceCount - 1))
                      : null,
                ),
                IconButton(
                  icon: const Icon(Icons.add, size: 18),
