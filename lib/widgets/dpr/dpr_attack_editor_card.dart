...
class DprAttackEditorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (damageTypeLower.contains('radiant') ||
        damageTypeLower.contains('holy')) {
    ...
    } else if (damageTypeLower.contains('lightning') ||
        damageTypeLower.contains('thunder')) {
      auraColor = const Color(0xFF38BDF8);
    } else if (damageTypeLower.contains('poison') ||
        damageTypeLower.contains('acid')) {
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Equip Weapon / Cantrip',
            ...
            children: [
              ...
              Expanded(
                child: NumericStepper(
                  ...
                  display: attack.attackBonus >= 0
                      ? '+${attack.attackBonus}'
                      : '${attack.attackBonus}',
                  onChanged: (val) =>
                      onUpdate(attack.copyWith(attackBonus: val)),
                ),
              ),
              const SizedBox(width: 8),
                ...
                child: DropdownButtonFormField<int>(
                  ...
                  items: const [4, 6, 8, 10, 12, 20].map((sides) {
                    return DropdownMenuItem(
                      value: sides,
                      child:
                          Text('d$sides', style: const TextStyle(fontSize: 12)),
                    );
                  }).toList(),
                  onChanged: (val) {
                    if (val != null) {
              ...
              Expanded(
                child: NumericStepper(
                  ...
                  display: attack.damageBonus >= 0
                      ? '+${attack.damageBonus}'
                      : '${attack.damageBonus}',
                  onChanged: (val) =>
                      onUpdate(attack.copyWith(damageBonus: val)),
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                ...
                child: NumericStepper(
                  ...
                  max: 10,
                  onChanged: (val) =>
                      onUpdate(attack.copyWith(secondaryDiceCount: val)),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                ...
                child: DropdownButtonFormField<int>(
                  key:
                      ValueKey('${attack.id}_sec_${attack.secondaryDiceSides}'),
                  initialValue: attack.secondaryDiceSides > 0
                      ? attack.secondaryDiceSides
                      : 6,
                  decoration: InputDecoration(
                    labelText: 'Rider Die',
                    isDense: true,
              ...
              Expanded(
                ...
                child: TextFormField(
                  ...
                  onChanged: (text) =>
                      onUpdate(attack.copyWith(secondaryDamageType: text)),
                ),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              const Text('Attacks with this weapon:',
                  style: TextStyle(fontSize: 12)),
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: attack.attacksPerRound > 1
                        ? () => onUpdate(attack.copyWith(
                            attacksPerRound: attack.attacksPerRound - 1))
                        : null,
                  ),
                  Text('${attack.attacksPerRound}',
          ...
          Wrap(
            ...
            children: [
              ...
              if (anythingGoesMode || !is2024)
                FilterChip(
                  label: const Text('GWM 2014 (-5/+10)',
              ...
              if (anythingGoesMode || is2024)
                FilterChip(
                  label: Text('GWM 2024 (+$proficiencyBonus dmg)',
                  ...
                  onSelected: (val) {
                    onUpdate(attack.copyWith(
                      gwmMode:
                          val ? GwmMode.v2024ProficiencyBonus : GwmMode.none,
                    ));
                  },
                ),
              ...
              if (anythingGoesMode || !is2024)
                FilterChip(
                  label: const Text('GWF 2014 (Reroll 1s & 2s)',
                      style: TextStyle(fontSize: 11)),
                  ...
                  onSelected: (val) {
                    onUpdate(attack.copyWith(
                      gwfVersion:
                          val ? GwfVersion.v2014Reroll : GwfVersion.none,
                    ));
                  },
                ),
              ...
              if (anythingGoesMode || is2024)
                FilterChip(
                  label: const Text('GWF 2024 (1s & 2s ➔ 3)',
                      style: TextStyle(fontSize: 11)),
                  ...
                  onSelected: (val) {
                    onUpdate(attack.copyWith(
                      gwfVersion:
                          val ? GwfVersion.v2024Floor3 : GwfVersion.none,
                    ));
                  },
                ),
              ...
              // Dueling (+2 dmg)
              FilterChip(
                label: const Text('Dueling (+2 dmg)',
                    style: TextStyle(fontSize: 11)),
              ...
              // Archery (+2 hit)
              FilterChip(
                label: const Text('Archery (+2 hit)',
                    style: TextStyle(fontSize: 11)),
              ...
              FilterChip(
                label:
                    const Text('Bless (+1d4)', style: TextStyle(fontSize: 11)),
                selected: attack.attackBuffDiceSides == 4,
                onSelected: (val) =>
                    onUpdate(attack.copyWith(attackBuffDiceSides: val ? 4 : 0)),
              ),
              ...
              FilterChip(
                ...
                label: Text('Agonizing Blast (+$abilityModifier dmg)',
                    style: const TextStyle(fontSize: 11)),
                tooltip:
                    'Add spellcasting ability modifier to cantrip / Eldritch Blast damage',
              ...
              if (anythingGoesMode || is2024) ...[
                FilterChip(
                  label: const Text('Graze (Miss Dmg)',
                      style: TextStyle(fontSize: 11)),
                  ...
                  onSelected: (val) {
                    onUpdate(attack.copyWith(
                      weaponMastery:
                          val ? WeaponMastery.graze : WeaponMastery.none,
                      abilityModForGraze: val ? attack.damageBonus : 0,
                    ));
                  },
                ),
                FilterChip(
                  label: const Text('Vex (Adv on Hit)',
                      style: TextStyle(fontSize: 11)),
                  ...
                  onSelected: (val) {
                    onUpdate(attack.copyWith(
                      weaponMastery:
                          val ? WeaponMastery.vex : WeaponMastery.none,
                    ));
                  },
                ),
              ],
              ...
              FilterChip(
                ...
                onSelected: (val) =>
                    onUpdate(attack.copyWith(critThreshold: val ? 19 : 20)),
              ),
            ],
          ),
        ],
