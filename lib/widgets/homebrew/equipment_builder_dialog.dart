...
class _EquipmentBuilderDialogState extends State<EquipmentBuilderDialog> {
  ...
  void initState() {
    ...
    _itemTypeController =
        TextEditingController(text: init?.itemType ?? 'Wondrous Item');
    _descController =
        TextEditingController(text: init?.descriptionMarkdown ?? '');
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      initialValue:
                          _rarities.contains(_rarity) ? _rarity : 'Rare',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText:
                      'Describe magic properties, bonus damage, and activated charges...',
