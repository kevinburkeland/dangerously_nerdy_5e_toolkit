  ...
  void _handleSave() {
    ...
    final spell = Spell(
      ...
      components: SpellComponents(
        ...
        m: _material,
        materialDescription:
            _material ? _materialDescController.text.trim() : null,
      ),
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      items: _schools
                          ...
                          .toList(),
                      onChanged: (val) =>
                          setState(() => _school = val ?? 'Evocation'),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: DropdownButtonFormField<ActionType>(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Casting Time'),
                      items: const [
                        DropdownMenuItem(
                        ...
                        DropdownMenuItem(
                            ...
                            child: Text('1 Reaction')),
                        DropdownMenuItem(
                            value: ActionType.minute, child: Text('1 Minute')),
                      ],
                      onChanged: (val) => setState(
                          () => _actionType = val ?? ActionType.action),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButtonFormField<DamageType>(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Damage Type'),
