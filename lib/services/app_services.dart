...
class AppServices {
  ...
  AppServices._({
    ...
    CommunityCompendiumImporterService? communityCompendiumImporter,
        ...
        _homebrewPersistence =
            homebrewPersistence ?? HomebrewPersistenceService(),
        _communityCompendiumImporter =
            communityCompendiumImporter ?? CommunityCompendiumImporterService();
  ...
  CommunityCompendiumImporterService get communityCompendiumImporter =>
      _communityCompendiumImporter;
  ...
  static void registerOverrides({
    ...
    _instance = AppServices._(
      ...
      campaignProfileService:
          campaignProfileService ?? _instance._campaignProfileService,
      dmBackupService: dmBackupService ?? _instance._dmBackupService,
      homebrewPersistence:
          homebrewPersistence ?? _instance._homebrewPersistence,
      communityCompendiumImporter:
          communityCompendiumImporter ?? _instance._communityCompendiumImporter,
    );
  }
