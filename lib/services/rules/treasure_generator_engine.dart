...
class TreasureGeneratorEngine {
      ...
      case TreasureTier.cr5To10:
        if (d100 <= 30) {
          return TreasureDropResult(
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 4d6×100 CP + 1d6×10 EP',
          );
        } else if (d100 <= 60) {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 6d6×10 SP + 2d6×10 GP',
          );
        } else if (d100 <= 70) {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 1d6×100 EP + 2d6×10 GP',
          );
        } else if (d100 <= 95) {
          return TreasureDropResult(
            tierLabel: tier.label,
      ...
      case TreasureTier.cr11To16:
        if (d100 <= 20) {
          return TreasureDropResult(
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 4d6×100 SP + 1d6×100 GP',
          );
        } else if (d100 <= 35) {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 1d6×100 EP + 1d6×100 GP',
          );
        } else if (d100 <= 75) {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 2d6×100 GP + 1d6×10 PP',
          );
        } else {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 2d6×100 GP + 2d6×10 PP',
          );
        }
      ...
      case TreasureTier.cr17Plus:
        if (d100 <= 15) {
          return TreasureDropResult(
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 2d6×1000 EP + 8d6×100 GP',
          );
        } else if (d100 <= 55) {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 1d6×1000 GP + 1d6×100 PP',
          );
        } else {
          return TreasureDropResult(
            tierLabel: tier.label,
            ...
            d100Roll: d100,
            rollSummary:
                'Individual Drop (d100: $d100) -> 1d6×1000 GP + 2d6×100 PP',
          );
        }
    }
  }
  ...
  TreasureDropResult _generateHoardCr0To4(int d100) {
    ...
    if (d100 >= 7 && d100 <= 16) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones10gp, _rollDice(2, 6)));
      summary += ' • 2d6 10gp Gems';
    } else if (d100 >= 17 && d100 <= 26) {
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects25gp, _rollDice(2, 4)));
      summary += ' • 2d4 25gp Art Objects';
    } else if (d100 >= 27 && d100 <= 36) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones50gp, _rollDice(2, 6)));
      summary += ' • 2d6 50gp Gems';
    } else if (d100 >= 37 && d100 <= 44) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones10gp, _rollDice(2, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableA, _rollDice(1, 6),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones10gp, _rollDice(2, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableB, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones10gp, _rollDice(2, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableC, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects25gp, _rollDice(2, 4)));
      _rollMagicItems(SrdLootTables.magicItemTableF, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects25gp, _rollDice(2, 4)));
      _rollMagicItems(
          SrdLootTables.magicItemTableG, 1, magicItemNames, magicItemIds);
  ...
  TreasureDropResult _generateHoardCr5To10(int d100) {
    ...
    if (d100 >= 5 && d100 <= 10) {
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones50gp, _rollDice(3, 6)));
      summary += ' • 3d6 50gp Gems';
    } else if (d100 >= 17 && d100 <= 22) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones100gp, _rollDice(3, 6)));
      summary += ' • 3d6 100gp Gems';
    } else if (d100 >= 23 && d100 <= 28) {
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects250gp, _rollDice(2, 4)));
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects25gp, _rollDice(2, 4)));
      _rollMagicItems(
          SrdLootTables.magicItemTableD, 1, magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones100gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableG, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones100gp, _rollDice(3, 6)));
      _rollMagicItems(
          SrdLootTables.magicItemTableH, 1, magicItemNames, magicItemIds);
  ...
  TreasureDropResult _generateHoardCr11To16(int d100) {
    ...
    if (d100 >= 4 && d100 <= 9) {
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects750gp, _rollDice(2, 4)));
      summary += ' • 2d4 750gp Art';
    } else if (d100 >= 16 && d100 <= 22) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones500gp, _rollDice(3, 6)));
      summary += ' • 3d6 500gp Gems';
    } else if (d100 >= 23 && d100 <= 29) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      summary += ' • 3d6 1,000gp Gems';
    } else if (d100 >= 30 && d100 <= 35) {
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects250gp, _rollDice(2, 4)));
      _rollMagicItems(SrdLootTables.magicItemTableA, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      _rollMagicItems(SrdLootTables.magicItemTableB, _rollDice(1, 6),
          magicItemNames, magicItemIds);
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects250gp, _rollDice(2, 4)));
      _rollMagicItems(
          SrdLootTables.magicItemTableF, 1, magicItemNames, magicItemIds);
      ...
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects750gp, _rollDice(2, 4)));
      _rollMagicItems(
          SrdLootTables.magicItemTableI, 1, magicItemNames, magicItemIds);
  ...
  TreasureDropResult _generateHoardCr17Plus(int d100) {
    ...
    if (d100 >= 3 && d100 <= 5) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableC, _rollDice(1, 8),
          magicItemNames, magicItemIds);
      summary += ' • 3d6 1000gp Gems + 1d8 Table C';
    } else if (d100 >= 6 && d100 <= 8) {
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects2500gp, _rollDice(1, 10)));
      _rollMagicItems(SrdLootTables.magicItemTableC, _rollDice(1, 8),
          magicItemNames, magicItemIds);
      summary += ' • 1d10 2500gp Art + 1d8 Table C';
    } else if (d100 >= 9 && d100 <= 11) {
      art.addAll(
          _pickRandomItems(SrdLootTables.artObjects7500gp, _rollDice(1, 4)));
      _rollMagicItems(SrdLootTables.magicItemTableC, _rollDice(1, 8),
          magicItemNames, magicItemIds);
      summary += ' • 1d4 7500gp Art + 1d8 Table C';
    } else if (d100 >= 12 && d100 <= 14) {
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones5000gp, _rollDice(1, 8)));
      _rollMagicItems(SrdLootTables.magicItemTableC, _rollDice(1, 8),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableD, _rollDice(1, 6),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableE, _rollDice(1, 6),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableH, _rollDice(1, 4),
          magicItemNames, magicItemIds);
      ...
      gems.addAll(
          _pickRandomItems(SrdLootTables.gemstones1000gp, _rollDice(3, 6)));
      _rollMagicItems(SrdLootTables.magicItemTableI, _rollDice(1, 4),
          magicItemNames, magicItemIds);
  ...
  String formatMarkdownSummary(
    ...
    buffer.writeln(
        '### 💰 5e Treasure Drop: ${drop.isHoard ? 'Hoard' : 'Loot'} (${drop.tierLabel})');
    ...
    if (coinList.isEmpty) {
      ...
      buffer.writeln(
          '- ${coinList.join(', ')} *(Total Coin Value: ${drop.coinsGoldValue.toStringAsFixed(1)} GP)*');
    }
    buffer.writeln();
    ...
    if (drop.gemstones.isNotEmpty) {
      ...
      for (final gem in drop.gemstones) {
        buffer.writeln(
            '- ${gem.count}x ${gem.name} (${gem.gpValue} GP each -> ${gem.totalGp} GP total)');
      }
    ...
    if (drop.artObjects.isNotEmpty) {
      ...
      for (final art in drop.artObjects) {
        buffer.writeln(
            '- ${art.count}x ${art.name} (${art.gpValue} GP each -> ${art.totalGp} GP total)');
      }
    ...
    buffer.writeln(
        '**Total Estimated Hoard Value:** **${drop.grandTotalGoldValue.toStringAsFixed(1)} GP**');

    if (partySize != null && partySize > 1) {
      final share = drop.calculateShares(partySize,
          includeLiquidatedGemsAndArt: includeLiquidatedShares);
      buffer.writeln();
      buffer.writeln('---');
      buffer.writeln('**Party Distribution (${share.partySize} Players):**');
      if (includeLiquidatedShares) {
        buffer.writeln(
            '- Each player receives: **${share.gpPerPlayer} GP** *(Liquidated all gems & art)*');
        if (share.remainderGpEquivalent > 0) {
          buffer.writeln(
              '- Party Fund / Remainder: ${share.remainderCoins['gp'] ?? 0} GP');
        }
      } else {
        ...
        if (sharesList.isNotEmpty) {
          buffer.writeln(
              '- Coin Share per Player: **${sharesList.join(', ')}** *(~${share.totalGpEquivalentPerPlayer.toStringAsFixed(2)} GP value)*');
        }
        if (share.remainderCoins.isNotEmpty) {
          final remList = share.remainderCoins.entries
