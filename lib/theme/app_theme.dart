...
class TabletopColors extends ThemeExtension<TabletopColors> {
  ...
  TabletopColors lerp(ThemeExtension<TabletopColors>? other, double t) {
    ...
    return TabletopColors(
      ...
      statPillBackground:
          Color.lerp(statPillBackground, other.statPillBackground, t)!,
  ...
  static ThemeData buildTheme({
    ...
    final colorScheme = isDark
        ? ColorScheme.dark(
            ...
            surfaceContainerHighest: oledPitchBlack
                ? const Color(0xFF1C1C1C)
                : const Color(0xFF2B263E),
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: isDark
            ? (oledPitchBlack ? Colors.black : const Color(0xFF1E1B2E))
            : Colors.white,
      ...
      extensions: [
        isDark
            ? TabletopColors.createDark(accent, oled: oledPitchBlack)
            : TabletopColors.createLight(accent),
      ],
    );
  }
