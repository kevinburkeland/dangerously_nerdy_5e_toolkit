...
class PartyLootItem {
  ...
  bool get isClaimed =>
      claimedByPlayer != null && claimedByPlayer!.trim().isNotEmpty;
  ...
  PartyLootItem copyWith({
    ...
    return PartyLootItem(
      ...
      claimedByPlayer: clearClaimedByPlayer
          ? null
          : (claimedByPlayer ?? this.claimedByPlayer),
      ...
      conflictPayload:
          clearConflict ? null : (conflictPayload ?? this.conflictPayload),
  ...
  factory PartyLootItem.fromJson(String source) =>
      PartyLootItem.fromMap(jsonDecode(source) as Map<String, dynamic>);
}
