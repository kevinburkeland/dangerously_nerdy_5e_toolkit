...
class DiceEntry {
  ...
  String get dieLabel =>
      dieType == DieType.custom ? 'd$customSides' : dieType.label;
...
class DiceRollResult {
  ...
  DieType get dieType =>
      diceEntries.isNotEmpty ? diceEntries.first.dieType : DieType.d20;
  int get count => diceEntries.isNotEmpty
      ? diceEntries.fold(0, (sum, e) => sum + e.count)
      : 1;
