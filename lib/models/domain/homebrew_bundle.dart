...
class _EpochDateTime implements DateTime {
  ...
  DateTime add(Duration duration) =>
      DateTime.fromMillisecondsSinceEpoch(0).add(duration);
  @override
  DateTime subtract(Duration duration) =>
      DateTime.fromMillisecondsSinceEpoch(0).subtract(duration);
  @override
  Duration difference(DateTime other) =>
      DateTime.fromMillisecondsSinceEpoch(0).difference(other);
  @override
