...
class GlyphGalleryData {
  ...
  static const List<GlyphItemEntry> allItems = [
    ...
    GlyphItemEntry(
      ...
      actionRings: [
        ActionTraitRing(
            ringType: ActionRingType.reaction, label: 'Critical Hit Immunity'),
      ],
      summary:
    ...
    GlyphItemEntry(
      ...
      actionRings: [
        ActionTraitRing(
            ringType: ActionRingType.control, label: 'Invisible for 1 Hour'),
      ],
      summary:
  ...
  static const List<GlyphFeatEntry> allFeats = [
    GlyphFeatEntry(
      ...
      actionRings: [
        ActionTraitRing(
          ringType: ActionRingType.melee,
          label: 'Advantage on Grappled Targets & Fast Drag',
        ),
      ],
      summary:
          'Master of close-quarters wrestling. You have Advantage on attack rolls against creatures you grapple, can drag at full speed, and can grapple on unarmed strike hits.',
    ),
  ];

  // ---------------------------------------------------------------------------
  // CHARACTER CLASSES (12 Core SRD Classes & Hit Die Geometries)
  // ---------------------------------------------------------------------------
  ...
  static const List<GlyphGenericEntry> allGenericUi = [
    ...
    GlyphGenericEntry(
      ...
      group: 'Dice Polyhedrals',
      summary:
          'Icosahedral 20-sided core tabletop d20 die used for all attack rolls, ability checks, and saving throws.',
    ),
    GlyphGenericEntry(
      name: 'd100 Die',
