...
class LandingToolItem {
  ...
  Color getLegibleAccent(bool isDark) {
    ...
    if (accentColor == Colors.amberAccent || accentColor == Colors.amber)
      return const Color(0xFFB45309);
    if (accentColor == Colors.purpleAccent ||
        accentColor == Colors.purple ||
        accentColor == const Color(0xFFC084FC)) return const Color(0xFF7E22CE);
    if (accentColor == Colors.orangeAccent || accentColor == Colors.orange)
      return const Color(0xFFC2410C);
    if (accentColor == Colors.greenAccent || accentColor == Colors.green)
      return const Color(0xFF047857);
    if (accentColor == Colors.redAccent || accentColor == Colors.red)
  ...
  Color getLegibleBadge(bool isDark) {
    ...
    if (badgeColor == Colors.amberAccent || badgeColor == Colors.amber)
      return const Color(0xFFB45309);
    if (badgeColor == Colors.purpleAccent ||
        badgeColor == Colors.purple ||
        badgeColor == const Color(0xFFC084FC)) return const Color(0xFF7E22CE);
    if (badgeColor == Colors.orangeAccent || badgeColor == Colors.orange)
      return const Color(0xFFC2410C);
    if (badgeColor == Colors.greenAccent || badgeColor == Colors.green)
      return const Color(0xFF047857);
    if (badgeColor == Colors.redAccent || badgeColor == Colors.red)
      return const Color(0xFFB91C1C);
    return badgeColor;
  }
}
...
class LandingToolRegistry {
  ...
  static List<LandingToolItem> get defaultTools => [
        ...
        LandingToolItem(
          ...
          accentColor: Colors.cyanAccent,
          description:
              'Damage Per Round (DPR) analyzer with interactive animated graphs, accuracy curves, Power Attack break-even AC, and damage breakdown.',
          keywords: [
            'dpr',
            'dps',
            'calculator',
        ...
        LandingToolItem(
          id: 'glyph_studio',
          title: '5E Techno-Rune Glyph Studio & Codex',
