...
class BeastSummons {
  ...
  static const boar = MinionStatBlock(
    ...
    damageType: 'Slashing',
    specialTrait:
        'Charge (Extra 1d6 damage, DC 11 Str save or prone) & Relentless',
    accentColor: Color(0xFF8D6E63),
  );
  ...
  static const giantSpider = MinionStatBlock(
    ...
    actions: [
      ...
      CreatureAction(
        ...
        description:
            'Ranged Weapon Attack: +5 to hit, range 30/60 ft., one creature. Hit: The target is restrained by webbing. As an action, the restrained target can make a DC 12 Strength check, bursting the webbing on a success.',
        attackType: 'Ranged Weapon Attack',
        attackBonus: 5,
  ...
  static const lion = MinionStatBlock(
    ...
    damageType: 'Slashing',
    specialTrait:
        'Pack Tactics & Pounce (DC 13 Str save or prone + bonus bite)',
  ...
  static const giantToad = MinionStatBlock(
    ...
    actions: [
      CreatureAction(
        name: 'Bite',
        description:
            'Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10 + 2) piercing damage plus 5 (1d10) poison damage, and the target is grappled (escape DC 13). Until this grapple ends, the target is restrained.',
        attackType: 'Melee Weapon Attack',
        attackBonus: 4,
        reach: 'reach 5 ft.',
  ...
  static const rhinoceros = MinionStatBlock(
    ...
    damageType: 'Bludgeoning',
    specialTrait:
        'Charge (Extra 2d8 damage, DC 15 Strength save or knock prone)',
  ...
  static const giantBoar = MinionStatBlock(
    ...
    damageType: 'Slashing',
    specialTrait:
        'Charge (Extra 2d6 damage, DC 13 Str save or prone) & Relentless',
    accentColor: Color(0xFF5D4037),
  );
  ...
  static const giantConstrictorSnake = MinionStatBlock(
    ...
    actions: [
      ...
      CreatureAction(
        name: 'Constrict',
        description:
            'Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 13 (2d8 + 4) bludgeoning damage, and the target is grappled (escape DC 14). Until this grapple ends, the creature is restrained, and the snake can\'t constrict another target.',
        attackType: 'Melee Weapon Attack',
        attackBonus: 6,
        reach: 'reach 5 ft.',
    ...
    damageType: 'Bludgeoning',
    specialTrait:
        'Constrict (2d8+4 bludgeoning, DC 14 Strength save or grappled/restrained)',
  ...
  static const conjureAnimalsPreset = SummonPreset(
    ...
    description:
        'You summon fey spirits that take the form of beasts and appear in unoccupied spaces that you can see within range. Choose CR options: 8 beasts of CR 1/4, 4 beasts of CR 1/2, 2 beasts of CR 1, or 1 beast of CR 2.',
    upcastRules:
        'Twice as many beasts at 5th level (e.g. 16 CR 1/4), three times as many at 7th level (24), four times as many at 9th level (32).',
    statBlocks: [
      // CR 1/4
      wolf,
      boar,
