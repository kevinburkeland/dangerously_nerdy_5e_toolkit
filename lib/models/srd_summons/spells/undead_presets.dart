...
class UndeadSummons {
  ...
  static const ghast = MinionStatBlock(
    ...
    actions: [
      ...
      CreatureAction(
        name: 'Claws',
        description:
            'Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10 (2d6 + 3) slashing damage. If the target is a creature other than an undead, it must succeed on a DC 10 Constitution saving throw or be paralyzed for 1 minute.',
        attackType: 'Melee Weapon Attack',
        attackBonus: 5,
        reach: 'reach 5 ft.',
  ...
  static const wight = MinionStatBlock(
    ...
    damageResistances:
        'necrotic; bludgeoning, piercing, and slashing from nonmagical attacks not made with silvered weapons',
    damageImmunities: 'poison',
    conditionImmunities: 'exhaustion, poisoned',
    ...
    actions: [
      ...
      CreatureAction(
        name: 'Life Drain',
        description:
            'Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 5 (1d6 + 2) necrotic damage. The target must succeed on a DC 13 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken.',
        attackType: 'Melee Weapon Attack',
        attackBonus: 4,
        reach: 'reach 5 ft.',
  ...
  static const mummy = MinionStatBlock(
    ...
    actions: [
      ...
      CreatureAction(
        name: 'Rotting Fist',
        description:
            'Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10 (2d6 + 3) bludgeoning damage plus 10 (3d6) necrotic damage. If the target is a creature, it must succeed on a DC 12 Constitution saving throw or be cursed with mummy rot.',
        attackType: 'Melee Weapon Attack',
        attackBonus: 5,
        reach: 'reach 5 ft.',
  ...
  static const animateDeadPreset = SummonPreset(
    ...
    duration: '24 hours',
    description:
        'This spell creates an undead servant. Choose a pile of bones or a corpse of a Medium or Small humanoid within range to animate a Skeleton or Zombie.',
    upcastRules:
        'Animate or reassert control over 2 additional undead creatures for each slot level above 3rd.',
  ...
  static const createUndeadPreset = SummonPreset(
    ...
    range: '10 feet',
    components:
        'V, S, M (one clay pot per corpse filled with grave dirt, salt, and 150gp black onyx per corpse)',
    duration: '24 hours',
    description:
        'You can animate up to three Ghouls from corpses within range. Higher levels allow Ghasts, Wights, or Mummies.',
    upcastRules:
        '7th level: 4 Ghouls or 2 Ghasts/Wights. 8th level: 5 Ghouls, 3 Ghasts/Wights, or 2 Mummies. 9th level: 6 Ghouls, 4 Ghasts/Wights, or 3 Mummies.',
