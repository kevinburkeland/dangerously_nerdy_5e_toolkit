...
class ValhallaSummons {
  static const berserker = MinionStatBlock(
    ...
    damageType: 'Slashing',
    specialTrait:
        'Reckless Attack (Advantage on attacks, grants advantage on incoming)',
  ...
  static const silverHornPreset = SummonPreset(
    ...
    duration: '1 Hour',
    description:
        'You blow the Silver Horn of Valhalla to summon 2d4 + 2 heroic warrior spirits (Berserkers) from Valhalla for 1 hour.',
  ...
  static const brassHornPreset = SummonPreset(
    ...
    duration: '1 Hour',
    description:
        'You blow the Brass Horn of Valhalla to summon 3d4 + 3 heroic warrior spirits (Berserkers) from Valhalla for 1 hour.',
    upcastRules: 'Cannot be used again for 7 days.',
    statBlocks: [berserker],
    isRandomTable: true,
  );
  ...
  static const bronzeHornPreset = SummonPreset(
    ...
    duration: '1 Hour',
    description:
        'You blow the Bronze Horn of Valhalla to summon 4d4 + 4 heroic warrior spirits (Berserkers) from Valhalla for 1 hour.',
    upcastRules: 'Cannot be used again for 7 days.',
    statBlocks: [berserker],
    isRandomTable: true,
  );
  ...
  static const ironHornPreset = SummonPreset(
    ...
    duration: '1 Hour',
    description:
        'You blow the Iron Horn of Valhalla to summon 5d4 + 5 heroic warrior spirits (Berserkers) from Valhalla for 1 hour.',
    upcastRules: 'Cannot be used again for 7 days.',
    statBlocks: [berserker],
    isRandomTable: true,
  );
