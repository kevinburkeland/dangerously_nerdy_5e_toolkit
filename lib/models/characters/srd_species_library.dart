...
class SrdSpeciesLibrary {
  ...
  static final Race humanVariant = Race(
    ...
    speed: '30 ft.',
    abilityScoreSummary:
        '+1 to Two Different Scores, 1 Skill, 1 Feat (2014 Optional)',
    traitsMarkdown:
  ...
  static final Race elf = Race(
    ...
    subraces: [
      const Subrace(
        ...
        name: 'High Elf',
        raceSlug: 'elf',
        abilityScoreSummary: '+2 DEX, +1 INT',
        fixedAbilityBonuses: {'dexterity': 2, 'intelligence': 1},
        traitsMarkdown:
      ...
      const Subrace(
        ...
        name: 'Wood Elf',
        raceSlug: 'elf',
        abilityScoreSummary: '+2 DEX, +1 WIS',
        fixedAbilityBonuses: {'dexterity': 2, 'wisdom': 1},
        speed: '35 ft.',
        traitsMarkdown:
      ...
      const Subrace(
        ...
        name: 'Drow',
        raceSlug: 'elf',
        abilityScoreSummary: '+2 DEX, +1 CHA',
        fixedAbilityBonuses: {'dexterity': 2, 'charisma': 1},
        darkvision: 120,
        traitsMarkdown:
  ...
  static final Race dwarf = Race(
    ...
    subraces: [
      const Subrace(
        ...
        name: 'Hill Dwarf',
        raceSlug: 'dwarf',
        abilityScoreSummary: '+2 CON, +1 WIS',
        fixedAbilityBonuses: {'constitution': 2, 'wisdom': 1},
        traitsMarkdown:
      ...
      const Subrace(
        ...
        name: 'Mountain Dwarf',
        raceSlug: 'dwarf',
        abilityScoreSummary: '+2 CON, +2 STR',
        fixedAbilityBonuses: {'constitution': 2, 'strength': 2},
        traitsMarkdown:
  ...
  static final Race halfling = Race(
    ...
    subraces: [
      const Subrace(
        ...
        fixedAbilityBonuses: {'dexterity': 2, 'charisma': 1},
        traitsMarkdown:
            '**Naturally Stealthy.** You can attempt to hide even when obscured only by a larger creature.',
      ),
      const Subrace(
        id: EntityId(slug: 'stout-halfling', ruleset: RulesetVersion.v2024),
        name: 'Stout Halfling',
        raceSlug: 'halfling',
        abilityScoreSummary: '+2 DEX, +1 CON',
        fixedAbilityBonuses: {'dexterity': 2, 'constitution': 1},
        traitsMarkdown:
  ...
  static final Race gnome = Race(
    ...
    subraces: [
      const Subrace(
        ...
        name: 'Forest Gnome',
        raceSlug: 'gnome',
        abilityScoreSummary: '+2 INT, +1 DEX',
        fixedAbilityBonuses: {'intelligence': 2, 'dexterity': 1},
        traitsMarkdown:
      ...
      const Subrace(
        ...
        name: 'Rock Gnome',
        raceSlug: 'gnome',
        abilityScoreSummary: '+2 INT, +1 CON',
        fixedAbilityBonuses: {'intelligence': 2, 'constitution': 1},
        traitsMarkdown:
            '**Artificer\'s Lore.** Double proficiency on Intelligence (History) checks related to magic items, alchemical objects, or technological devices.\n\n**Tinker.** Proficiency with tinker\'s tools to construct clockwork toys, fire starters, or music boxes.',
      ),
    ],
  );
  ...
  static final Race halfElf = Race(
    ...
    traitsMarkdown: '**Darkvision.** See in dim light within 60 feet.\n\n'
  ...
  /// Custom/homebrew species registered in the library
  static List<Race> get customSpecies => List.unmodifiable(_customSpecies);
  ...
  static List<Race> get allSpecies {
    return [..._baseSpecies, ..._customSpecies].map((r) {
      ...
      final existingSlugs =
          r.subraces.map((s) => s.id.slug.toLowerCase().trim()).toSet();
      final newSubraces = matchingCustomSubraces
  ...
  static List<Race> getSpeciesForRuleset(RulesetVersion ruleset) {
    if (ruleset == RulesetVersion.v2024) {
      ...
      return allSpecies
          .where((r) =>
              r.id.slug != 'human-variant' && r.id.slug != 'custom-lineage')
          .toList();
    }
    return allSpecies;
  }
  ...
  static Race? findBySlug(String slug) {
    ...
    return allSpecies
        .where((r) => r.id.slug == clean || r.name.toLowerCase() == clean)
        .firstOrNull;
  }
  ...
  static Subrace? findSubraceBySlug(String slug) {
    ...
    bool matchesSubrace(Subrace s) {
      ...
      return sSlug == clean ||
          ...
          sNameSlug == stripped ||
          sSlug.replaceFirst(
                  RegExp(r'^(human|elf|dwarf|gnome|halfling)-'), '') ==
              stripped;
    }
