...
class SrdFeatsLibrary {
  ...
  /// Dynamic list of custom/homebrew feats registered in the library
  static List<Feat> get customFeats => List.unmodifiable(_customFeats);
  ...
  static List<Feat> getOriginFeats(
  ...
  static Feat? findBySlug(String slug) {
    ...
    return allFeats
        .where((f) => f.id.slug == clean || f.name.toLowerCase() == clean)
        .firstOrNull;
  }
}
