...
class ArenaPresetMatchup {
  ...
  ({List<ArenaCombatant> teamA, List<ArenaCombatant> teamB}) resolveFighters([
    ...
    for (final member in teamA) {
      final monster = MonsterCodexLibrary.getMonsterById(member.monsterId) ??
          MonsterCodexLibrary.getMonsterByName(
              member.monsterName ?? member.monsterId);
      if (monster != null) {
  ...
  static const List<ArenaPresetMatchup> defaultPresets = [
    ArenaPresetMatchup(
      ...
      teamA: [
        ArenaPresetMember(
            monsterId: 'tyrannosaurus_rex',
            monsterName: 'Tyrannosaurus Rex',
            count: 1),
      ],
      teamB: [
    ...
    ArenaPresetMatchup(
      ...
      teamA: [
        ArenaPresetMember(
            monsterId: 'young_red_dragon',
            monsterName: 'Young Red Dragon',
            count: 1),
      ],
      teamB: [
    ...
    ArenaPresetMatchup(
      ...
      teamA: [
        ArenaPresetMember(
            monsterId: 'hill_giant', monsterName: 'Hill Giant', count: 1),
      ],
      teamB: [
        ArenaPresetMember(
            monsterId: 'goblin', monsterName: 'Goblin', count: 12),
      ],
    ),
    ArenaPresetMatchup(
      id: 'elemental_clash',
    ...
    ArenaPresetMatchup(
      ...
      teamB: [
        ArenaPresetMember(
            monsterId: 'skeleton', monsterName: 'Skeleton', count: 8),
    ...
    ArenaPresetMatchup(
      ...
      teamA: [
        ArenaPresetMember(
            monsterId: 'giant_shark', monsterName: 'Giant Shark', count: 1),
      ],
      teamB: [
    ...
    ArenaPresetMatchup(
      ...
      teamA: [
        ArenaPresetMember(
            monsterId: 'gladiator', monsterName: 'Gladiator', count: 1),
      ],
      teamB: [
        ArenaPresetMember(
            monsterId: 'berserker', monsterName: 'Berserker', count: 2),
      ],
    ),
  ];
}
