...
/// Heavy Weapon / Power Attack Feat modes.
enum GwmMode {
  none('None'),
  v2014PowerAttack('Power Attack (-5 to hit / +10 dmg)'),
  v2024ProficiencyBonus('Damage Bonus (+PB flat damage on hit)');
...
class DprWeaponPreset {
  ...
  final String name;
  final String
      category; // e.g. "Standard Melee", "Standard Ranged", "Magic Weapon", "Damage Cantrip"
  final int diceCount;
  final int diceSides;
  ...
  static const List<DprWeaponPreset> allPresets = [
    ...
    DprWeaponPreset(
        id: 'greatsword',
        name: 'Greatsword (2d6 Slashing)',
        category: 'Standard Melee',
        diceCount: 2,
        diceSides: 6,
        damageType: 'slashing',
        isHeavy: true,
        defaultMastery: WeaponMastery.graze),
    DprWeaponPreset(
        id: 'greataxe',
        name: 'Greataxe (1d12 Slashing)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 12,
        damageType: 'slashing',
        isHeavy: true,
        defaultMastery: WeaponMastery.topple),
    DprWeaponPreset(
        id: 'maul',
        name: 'Maul (2d6 Bludgeoning)',
        category: 'Standard Melee',
        diceCount: 2,
        diceSides: 6,
    ...
    DprWeaponPreset(
        id: 'halberd',
        name: 'Halberd / Glaive (1d10 Slashing, Reach)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 10,
        damageType: 'slashing',
    ...
    DprWeaponPreset(
        id: 'pam_butt',
        name: 'Pole Weapon Secondary Strike (1d4 Bludgeoning)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 4,
        damageType: 'bludgeoning',
        defaultMastery: WeaponMastery.none),
    DprWeaponPreset(
        id: 'longsword',
        name: 'Longsword / Warhammer (1d8 / 1d10 Versatile)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 8,
        damageType: 'slashing',
    ...
    DprWeaponPreset(
        id: 'rapier',
        name: 'Rapier (1d8 Piercing, Finesse)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 8,
        damageType: 'piercing',
        defaultMastery: WeaponMastery.vex),
    DprWeaponPreset(
        id: 'shortsword',
        name: 'Shortsword (1d6 Piercing)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 6,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'scimitar',
        name: 'Scimitar / Dagger (1d6 / 1d4)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 6,
        damageType: 'slashing',
        defaultMastery: WeaponMastery.nick),
    DprWeaponPreset(
        id: 'unarmed',
        name: 'Unarmed Strike (1d6 Monk)',
        category: 'Standard Melee',
        diceCount: 1,
        diceSides: 6,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        id: 'hand_crossbow',
        name: 'Hand Crossbow (1d6 Piercing)',
        category: 'Standard Ranged',
        diceCount: 1,
        diceSides: 6,
        damageType: 'piercing',
        defaultMastery: WeaponMastery.vex,
    ...
    DprWeaponPreset(
        id: 'heavy_crossbow',
        name: 'Heavy Crossbow (1d10 Piercing)',
        category: 'Standard Ranged',
        diceCount: 1,
        diceSides: 10,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'eldritch_blast_1',
        name: 'Eldritch Blast (1x 1d10 Force, 1 Beam, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'force',
        isRanged: true,
        isCantrip: true,
        defaultAttacksPerRound: 1),
    DprWeaponPreset(
        id: 'eldritch_blast_2',
        name: 'Eldritch Blast (2x 1d10 Force, 2 Beams, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'force',
        isRanged: true,
        isCantrip: true,
        defaultAttacksPerRound: 2),
    DprWeaponPreset(
        id: 'eldritch_blast_3',
        name: 'Eldritch Blast (3x 1d10 Force, 3 Beams, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'force',
        isRanged: true,
        isCantrip: true,
        defaultAttacksPerRound: 3),
    DprWeaponPreset(
        id: 'eldritch_blast_4',
        name: 'Eldritch Blast (4x 1d10 Force, 4 Beams, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'force',
        isRanged: true,
        isCantrip: true,
        defaultAttacksPerRound: 4),

    // Fire Bolt
    DprWeaponPreset(
        id: 'fire_bolt_1',
        name: 'Fire Bolt (1d10 Fire, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'fire_bolt_2',
        name: 'Fire Bolt (2d10 Fire, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 10,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'fire_bolt_3',
        name: 'Fire Bolt (3d10 Fire, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 10,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'fire_bolt_4',
        name: 'Fire Bolt (4d10 Fire, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 10,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'ray_of_frost_1',
        name: 'Ray of Frost (1d8 Cold, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
        damageType: 'cold',
    ...
    DprWeaponPreset(
        id: 'ray_of_frost_2',
        name: 'Ray of Frost (2d8 Cold, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 8,
        damageType: 'cold',
    ...
    DprWeaponPreset(
        id: 'ray_of_frost_3',
        name: 'Ray of Frost (3d8 Cold, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 8,
        damageType: 'cold',
    ...
    DprWeaponPreset(
        id: 'ray_of_frost_4',
        name: 'Ray of Frost (4d8 Cold, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 8,
        damageType: 'cold',
    ...
    DprWeaponPreset(
        id: 'sacred_flame_1',
        name: 'Sacred Flame (1d8 Radiant, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
        damageType: 'radiant',
    ...
    DprWeaponPreset(
        id: 'sacred_flame_2',
        name: 'Sacred Flame (2d8 Radiant, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 8,
        damageType: 'radiant',
    ...
    DprWeaponPreset(
        id: 'sacred_flame_3',
        name: 'Sacred Flame (3d8 Radiant, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 8,
        damageType: 'radiant',
    ...
    DprWeaponPreset(
        id: 'sacred_flame_4',
        name: 'Sacred Flame (4d8 Radiant, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 8,
        damageType: 'radiant',
    ...
    DprWeaponPreset(
        id: 'chill_touch_1',
        name: 'Chill Touch (1d8 Necrotic, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
        damageType: 'necrotic',
    ...
    DprWeaponPreset(
        id: 'chill_touch_2',
        name: 'Chill Touch (2d8 Necrotic, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 8,
        damageType: 'necrotic',
    ...
    DprWeaponPreset(
        id: 'chill_touch_3',
        name: 'Chill Touch (3d8 Necrotic, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 8,
        damageType: 'necrotic',
    ...
    DprWeaponPreset(
        id: 'chill_touch_4',
        name: 'Chill Touch (4d8 Necrotic, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 8,
        damageType: 'necrotic',
    ...
    DprWeaponPreset(
        id: 'shocking_grasp_1',
        name: 'Shocking Grasp (1d8 Lightning, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
    ...
    DprWeaponPreset(
        id: 'shocking_grasp_2',
        name: 'Shocking Grasp (2d8 Lightning, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 8,
        damageType: 'lightning',
    ...
    DprWeaponPreset(
        id: 'shocking_grasp_3',
        name: 'Shocking Grasp (3d8 Lightning, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 8,
        damageType: 'lightning',
    ...
    DprWeaponPreset(
        id: 'shocking_grasp_4',
        name: 'Shocking Grasp (4d8 Lightning, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 8,
        damageType: 'lightning',
    ...
    DprWeaponPreset(
        id: 'poison_spray_1',
        name: 'Poison Spray (1d12 Poison, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 12,
        damageType: 'poison',
    ...
    DprWeaponPreset(
        id: 'poison_spray_2',
        name: 'Poison Spray (2d12 Poison, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 12,
        damageType: 'poison',
    ...
    DprWeaponPreset(
        id: 'poison_spray_3',
        name: 'Poison Spray (3d12 Poison, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 12,
        damageType: 'poison',
    ...
    DprWeaponPreset(
        id: 'poison_spray_4',
        name: 'Poison Spray (4d12 Poison, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 12,
        damageType: 'poison',
    ...
    DprWeaponPreset(
        id: 'acid_splash_1',
        name: 'Acid Splash (1d6 Acid, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 6,
        damageType: 'acid',
    ...
    DprWeaponPreset(
        id: 'acid_splash_2',
        name: 'Acid Splash (2d6 Acid, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 6,
        damageType: 'acid',
    ...
    DprWeaponPreset(
        id: 'acid_splash_3',
        name: 'Acid Splash (3d6 Acid, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 6,
        damageType: 'acid',
    ...
    DprWeaponPreset(
        id: 'acid_splash_4',
        name: 'Acid Splash (4d6 Acid, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 6,
        damageType: 'acid',
    ...
    // Vicious Mockery
    DprWeaponPreset(
        id: 'vicious_mockery_1',
        name: 'Vicious Mockery (1d4 Psychic, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 4,
        damageType: 'psychic',
        ...
        isCantrip: true),
    DprWeaponPreset(
        id: 'vicious_mockery_2',
        name: 'Vicious Mockery (2d4 Psychic, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 4,
        damageType: 'psychic',
        ...
        isCantrip: true),
    DprWeaponPreset(
        id: 'vicious_mockery_3',
        name: 'Vicious Mockery (3d4 Psychic, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 4,
        damageType: 'psychic',
        ...
        isCantrip: true),
    DprWeaponPreset(
        id: 'vicious_mockery_4',
        name: 'Vicious Mockery (4d4 Psychic, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 4,
        damageType: 'psychic',
    ...
    DprWeaponPreset(
        id: 'produce_flame_1',
        name: 'Produce Flame (1d8 Fire, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'produce_flame_2',
        name: 'Produce Flame (2d8 Fire, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 8,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'produce_flame_3',
        name: 'Produce Flame (3d8 Fire, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 8,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'produce_flame_4',
        name: 'Produce Flame (4d8 Fire, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 8,
        damageType: 'fire',
    ...
    DprWeaponPreset(
        id: 'thorn_whip_1',
        name: 'Thorn Whip (1d6 Piercing, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 6,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'thorn_whip_2',
        name: 'Thorn Whip (2d6 Piercing, Lvl 5-10)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 6,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'thorn_whip_3',
        name: 'Thorn Whip (3d6 Piercing, Lvl 11-16)',
        category: 'Damage Cantrip',
        diceCount: 3,
        diceSides: 6,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'thorn_whip_4',
        name: 'Thorn Whip (4d6 Piercing, Lvl 17-20)',
        category: 'Damage Cantrip',
        diceCount: 4,
        diceSides: 6,
        damageType: 'piercing',
    ...
    DprWeaponPreset(
        id: 'shillelagh',
        name: 'Shillelagh (1d8 Magical Bludgeoning, Lvl 1-4)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 8,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        id: 'shillelagh_2',
        name: 'Shillelagh (1d10 Magical Bludgeoning, 2024 Lvl 5+)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 10,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        id: 'shillelagh_3',
        name: 'Shillelagh (1d12 Magical Bludgeoning, 2024 Lvl 11+)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 12,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        id: 'shillelagh_4',
        name: 'Shillelagh (2d6 Magical Bludgeoning, 2024 Lvl 17+)',
        category: 'Damage Cantrip',
        diceCount: 2,
        diceSides: 6,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        id: 'magic_stone',
        name: 'Magic Stone (1d6 Bludgeoning Ranged, 3 Stones)',
        category: 'Damage Cantrip',
        diceCount: 1,
        diceSides: 6,
        damageType: 'bludgeoning',
    ...
    DprWeaponPreset(
        ...
        name: 'Flame Tongue Greatsword (2d6 + 2d6 Fire)',
        category: 'Magic Weapon',
        diceCount: 2,
        diceSides: 6,
        damageType: 'slashing',
    ...
    DprWeaponPreset(
        ...
        name: 'Flame Tongue Longsword (1d8 + 2d6 Fire)',
        category: 'Magic Weapon',
        diceCount: 1,
        diceSides: 8,
        damageType: 'slashing',
    ...
    DprWeaponPreset(
        id: 'sun_blade',
        name: 'Sun Blade (+2, 1d8 Radiant + 1d8 Undead)',
        category: 'Magic Weapon',
        diceCount: 1,
        diceSides: 8,
        damageType: 'radiant',
    ...
    DprWeaponPreset(
        id: 'dragon_slayer',
        name: 'Dragon Slayer (+1, +3d6 vs Dragons)',
        category: 'Magic Weapon',
        diceCount: 1,
        diceSides: 8,
        damageType: 'slashing',
        flatBonus: 1,
        secondaryDiceCount: 3,
        secondaryDiceSides: 6,
        secondaryDamageType: 'slashing'),
    DprWeaponPreset(
        id: 'holy_avenger',
        name: 'Holy Avenger (+3, +2d10 Radiant)',
        category: 'Magic Weapon',
        diceCount: 1,
        diceSides: 8,
        damageType: 'slashing',
...
class DprAttackAction {
  ...
  final int? saveDc;
  final bool
      halfDamageOnSave; // true = half damage on save, false = no damage on save

  // Area of Effect & Target Scaling
  final bool isAoe;
  final int
      targetCount; // default 1 for single-target, 2 for standard 5e DMG AoE assumptions
  ...
  final bool
      hasAgonizingBlast; // adds ability modifier to cantrip / Eldritch Blast damage
  ...
  final int
      extraCritDiceCount; // +1 for Half-Orc Savage Attacks / Brutal Critical
  final int extraCritDiceSides;

  // Buffs / Precision Modifiers
  final int
      attackBuffDiceSides; // e.g. 4 for Bless (+1d4), 6/8/10/12 for Bardic/Precision
  ...
  DprAttackAction copyWith({
    ...
    return DprAttackAction(
      ...
      abilityModForAgonizing:
          abilityModForAgonizing ?? this.abilityModForAgonizing,
  ...
  String get formulaDisplay {
    ...
    if (hasAgonizingBlast && abilityModForAgonizing > 0)
      totalBonus += abilityModForAgonizing;
    ...
    if (deliveryType == DprActionDeliveryType.savingThrow && saveDc != null) {
      final saveLabel =
          saveAbility != null ? ' ${saveAbility!.toUpperCase()}' : '';
...
class DprCombatantProfile {
  ...
  final int
      sneakAttackDiceCount; // 0 for none, 1..10 for Rogues (once per turn proc)
  ...
  factory DprCombatantProfile.cleanCustom({
    ...
    return DprCombatantProfile(
      ...
      description:
          'Level $level Character (+$abilityMod Mod, +$proficiencyBonus PB)',
      level: level,
  ...
  factory DprCombatantProfile.fromMinionStatBlock(
    ...
    return DprCombatantProfile(
      ...
      name: statBlock.name,
      description:
          'CR ${statBlock.crDisplay} ${statBlock.sizeDisplay} ${statBlock.typeDisplay}',
      level: math.max(
          1,
          statBlock.crDisplay.contains('/')
              ? 1
              : int.tryParse(statBlock.crDisplay) ?? 1),
  ...
  factory DprCombatantProfile.fromMonsterItem(
    ...
    final extracted =
        sb.extractDprAttacks().where((a) => !a.isLegendaryAction).toList();
    final activeAttacks =
        extracted.where((a) => a.attacksPerRound > 0).toList();
    ...
    return DprCombatantProfile(
      ...
      proficiencyBonus:
          ((math.max(1, monster.challengeRating.ceil()) - 1) ~/ 4) + 2,
      defaultAdvantage: adv,
...
/// Comprehensive break-even crossover analysis between standard and power attack (penalty to hit / bonus damage) profiles.
class DprBreakEvenAnalysis {
  ...
  /// The maximum AC where Power Attack deals more or equal DPR than Normal.
  /// Null if Power Attack is always worse or always better across the evaluated range.
  final int? maxOptimalAc;

  /// Backwards-compatible getter for legacy callers
  int? get maxOptimalAcForGwm => maxOptimalAc;
  ...
  const DprBreakEvenAnalysis({
    ...
    int? maxOptimalAc,
    int? maxOptimalAcForGwm,
    required this.recommendation,
  }) : maxOptimalAc = maxOptimalAc ?? maxOptimalAcForGwm;
}
...
class DprMonsterAcPreset {
  ...
  static const List<DprMonsterAcPreset> standardPresets = [
    DprMonsterAcPreset(
        label: 'CR 1/4 - Minion/Unarmored',
        crDisplay: '1/4',
        typicalAc: 11,
        examples: 'Goblin, Skeleton, Cultist'),
    DprMonsterAcPreset(
        label: 'CR 1 - Standard Monster',
        crDisplay: '1',
        typicalAc: 13,
        examples: 'Bugbear, Ghoul, Spy'),
    DprMonsterAcPreset(
        label: 'CR 5 - Tough Veteran',
        crDisplay: '5',
        typicalAc: 15,
        examples: 'Gladiator, Troll, Wraith'),
    DprMonsterAcPreset(
        label: 'CR 10 - Elite / Monster',
        crDisplay: '10',
        typicalAc: 17,
        examples: 'Young Red Dragon, Stone Golem'),
    DprMonsterAcPreset(
        label: 'CR 15 - Adult Dragon',
        crDisplay: '15',
        typicalAc: 18,
        examples: 'Adult Blue Dragon, Mummy Lord'),
    DprMonsterAcPreset(
        label: 'CR 20 - Ancient Fiend',
        crDisplay: '20',
        typicalAc: 19,
        examples: 'Pit Fiend, Ancient Brass Dragon'),
    DprMonsterAcPreset(
        label: 'CR 25+ - Legendary Avatar',
        crDisplay: '25',
        typicalAc: 22,
        examples: 'Solar, Ancient Red Dragon'),
    DprMonsterAcPreset(
        label: 'CR 30 - The Tarrasque',
        crDisplay: '30',
        typicalAc: 25,
        examples: 'Tarrasque (AC 25, Reflective)'),
  ];
}
...
final RegExp _swallowClauseRegex = RegExp(
    r'it can (?:use|make) its swallow instead of its bite\.?',
    caseSensitive: false);
final RegExp _frightfulClauseRegex =
    RegExp(r'it can use its frightful presence\.?', caseSensitive: false);
final RegExp _replaceClauseRegex = RegExp(
    r'it can replace one (?:of those )?attacks? with [^.]*\.?',
    caseSensitive: false);
...
final RegExp _bonusToHitPattern =
    RegExp(r'([+-]\s*\d+)\s+to\s+hit', caseSensitive: false);
final RegExp _primaryDicePattern = RegExp(
  r'(\d+)\s*d\s*(\d+)(?:\s*([+-])\s*(\d+))?',
  caseSensitive: false,
);
final RegExp _flatHitPattern =
    RegExp(r'Hit:\s*(\d+)|taking\s*(\d+)', caseSensitive: false);
...
final RegExp _legendaryCostPattern =
    RegExp(r'\(costs\s*\d+\s*actions?\)', caseSensitive: false);
...
final RegExp _reachPattern =
    RegExp(r'reach\s*(\d+)\s*ft', caseSensitive: false);
...
extension MinionStatBlockDprExt on MinionStatBlock {
  ...
  void _resolveAttacksPerRound(
    ...
    for (final branch in branchSegments) {
      ...
      for (int i = 0; i < attacks.length; i++) {
        ...
        final cleanName =
            nameLower.replaceAll(_parenthesesRemovalRegex, '').trim();
      ...
      if (branchCounts.any((c) => c > 0)) {
        ...
        for (int i = 0; i < attacks.length; i++) {
          if (branchCounts[i] > 0) {
            final a = attacks[i];
            final primaryAvg =
                (a.diceCount * (a.diceSides + 1) / 2.0) + a.damageBonus;
            final secAvg =
            ...
            if (a.deliveryType == DprActionDeliveryType.savingThrow) {
              ...
              singleDpr = (totalHitDmg *
                      (failProb + (1.0 - failProb) * successFactor)) *
                  aoeMultiplier;
            } else {
  ...
  bool _branchMentionsWeapon(String branch, String cleanName, String baseName) {
    ...
    final pattern = _branchMentionsCache.putIfAbsent(key, () {
      ...
      return RegExp('\\b(?:$escaped|$baseEscaped)(?:s)?\\b',
          caseSensitive: false);
    });
  ...
  void _assignSingleBestAttack(List<DprAttackAction> attacks, int count) {
    ...
    for (int i = 0; i < attacks.length; i++) {
      ...
      if (a.deliveryType == DprActionDeliveryType.savingThrow) {
        ...
        final aoeMultiplier = a.isAoe ? 2.0 : 1.0;
        efficiency =
            (totalHitDmg * (failProb + (1.0 - failProb) * successFactor)) *
                aoeMultiplier;
      } else {
        final neededRoll = (15 - a.attackBonus).clamp(2, 20);
        final hitProb = (21.0 - neededRoll) / 20.0;
    ...
    for (int i = 0; i < attacks.length; i++) {
      attacks[i] =
          attacks[i].copyWith(attacksPerRound: (i == bestIndex) ? count : 0);
    }
  }

  int _extractAttackCountForName(
      String desc, String cleanName, String baseName) {
  ...
  DprAttackAction? _parseCreatureActionToDpr(
    ...
    int legCost = 1;
    if (isLegendary &&
        (nameLower.contains('costs 2') || descLower.contains('costs 2'))) {
      legCost = 2;
    } else if (isLegendary &&
        (nameLower.contains('costs 3') || descLower.contains('costs 3'))) {
      legCost = 3;
    }
    ...
    if (nameLower.contains('recharge 5') || descLower.contains('recharge 5')) {
      recharge = 5;
    } else if (nameLower.contains('recharge 6') ||
        descLower.contains('recharge 6')) {
      recharge = 6;
    }
    ...
    final halfOnSave = descLower.contains('half as much') ||
        !descLower.contains('taking no damage');
    ...
    final primarySource =
        action.hitDamage != null && action.hitDamage!.isNotEmpty
            ? action.hitDamage!
            : action.description;
    ...
    if (isLegendary && availableRegularAttacks.isNotEmpty) {
      final hasOwnDamage = dCount > 0 ||
          dBonus > 0 ||
          secDCount > 0 ||
          delivery == DprActionDeliveryType.savingThrow;

      if (!hasOwnDamage ||
          descLower.contains('makes a ') ||
          descLower.contains('makes one ') ||
          descLower.contains('uses its ')) {
        ...
        for (final reg in availableRegularAttacks) {
          ...
          if (cleanName.isNotEmpty &&
              (regName == cleanName ||
                  regName.contains(cleanName) ||
                  cleanName.contains(regName))) {
        ...
        if (referencedAttack == null) {
          ...
          if (descRefMatch != null) {
            ...
            for (final reg in availableRegularAttacks) {
              final regName = reg.name.toLowerCase();
              if (regName == targetWord ||
                  regName.contains(targetWord) ||
                  targetWord.contains(regName)) {
                referencedAttack = reg;
                break;
              }
            }
        ...
        if (referencedAttack == null &&
            (cleanName == 'attack' ||
                cleanName == 'weapon' ||
                descLower.contains('makes one weapon attack') ||
                descLower.contains('makes one attack'))) {
    ...
    final actionReach =
        reachMatch != null ? (int.tryParse(reachMatch.group(1) ?? '') ?? 5) : 5;
