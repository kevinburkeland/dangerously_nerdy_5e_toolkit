...
const List<SpellItem> srdCantrips = [
  ...
  SpellItem(
    ...
    school: SpellSchool.conjuration,
    isChangedIn2024: false,
    diffSummary: 'Hurls a bubble of acid affecting one creature (or two within 5 feet) dealing 1d6 acid damage on failed Dexterity save.',
    tags: ['acid', 'aoe', 'save', 'sorcerer', 'wizard', 'artificer', 'cantrip'],
    rules2014: SpellEditionDetails(
      castingTime: '1 Action',
      range: '60 feet',
      components: 'V, S',
  ...
  SpellItem(
    ...
    school: SpellSchool.necromancy,
    isChangedIn2024: false,
    diffSummary: 'Projects a puff of noxious gas dealing 1d12 poison damage to a creature within 10 feet on failed Constitution save.',
    tags: ['poison', 'save', 'druid', 'sorcerer', 'warlock', 'wizard', 'artificer', 'cantrip'],
    rules2014: SpellEditionDetails(
      castingTime: '1 Action',
      range: '10 feet',
      components: 'V, S',
      duration: 'Instantaneous',
      classes: [SpellClass.artificer, SpellClass.druid, SpellClass.sorcerer, SpellClass.warlock, SpellClass.wizard],
      rollFormula: '1d12',
  ...
  SpellItem(
    ...
    school: SpellSchool.transmutation,
    isChangedIn2024: false,
    diffSummary: 'Primal sensory tricks: forecast weather for 24 hours, bloom flowers, spark sensory breeze/odors, or light/snuff small candles and campfires.',
