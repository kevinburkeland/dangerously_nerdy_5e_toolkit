...
class TreasureDropResult {
  ...
  int get gemsGoldValue => gemstones.fold(0, (sum, gem) => sum + gem.totalGp);

  /// Total value of all art objects in GP.
  int get artGoldValue => artObjects.fold(0, (sum, art) => sum + art.totalGp);
  ...
  PartyShareBreakdown calculateShares(int partyMembers,
