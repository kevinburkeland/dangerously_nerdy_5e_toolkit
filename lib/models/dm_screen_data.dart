...
/// Backward-compatibility 5e ruleset extensions on core domain models.
extension Character5eRulesetExtension on Character {
  DmRulesEdition get rulesEdition => switch (rulesetId) {
        'dnd5e_2014' || 'v2014' || '5e-2014' => DmRulesEdition.v2014,
        _ => DmRulesEdition.v2024,
      };
}
...
extension RulesetString5eExtension on String {
  String get label => contains('2014') ? '2014' : '2024';
}
...
class DmScreenLibrary {
  ...
  static List<DmReferenceItem> standardActions(DmRulesEdition edition) =>
      allItems
          .where((i) =>
  ...
  static const List<DmReferenceItem> _baseItems = [
    ...
    DmReferenceItem(
      ...
      diffSummary:
          '2024 lets you draw/stow a weapon before or after EACH attack, and Unarmed Strikes now offer Damage, Grapple, or Shove options directly.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 codifies this as the "Magic Action" and limits you to expending only ONE spell slot on your turn (allowing Cantrip + Leveled, but preventing Double Leveled Slots).',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: '1 Action',
      summary:
          'Focus entirely on evading incoming attacks and hazard reflex saves.',
      tags: [
        'dodge',
        'defense',
        'advantage',
    ...
    DmReferenceItem(
      ...
      cost: '1 Action',
      summary:
          'Give an ally Advantage on an ability check or their next attack roll.',
      tags: ['help', 'assist', 'advantage', 'feint', 'standard_action'],
      isChangedIn2024: true,
      diffSummary:
          '2024 specifies that helping on an ability check requires proficiency in the relevant skill.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 was a contested check against enemy Passive Perception. 2024 sets a standardized DC 15 Dexterity (Stealth) check to immediately gain the Invisible condition!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      summary:
          'Specify a perceivable trigger and an action to execute as a Reaction.',
      tags: [
        'ready',
        'reaction',
        'trigger',
    ...
    DmReferenceItem(
      ...
      cost: '1 Action',
      summary:
          'Devote attention to finding something or tracking hidden creatures.',
      tags: [
        'search',
        'perception',
        'investigation',
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 codifies Search under Wisdom checks (Insight, Perception, Survival) to discern motives or locate concealed creatures/items.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 introduces a codified Study action using Intelligence checks to deduce monster stats and weaknesses.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 standardizes DCs for social influence: Friendly DC 10, Indifferent DC 15, Hostile DC 20.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: '1 Action',
      summary:
          'Interact with a second object or operate complex mechanical apparatuses.',
      tags: [
        'use an object',
        'utilize',
        'interact',
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 renames Use an Object to Utilize and standardizes equipping/using non-magic gear and apparatuses.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      diffSummary:
          '2014 used contested Athletics checks. 2024 makes Grapple/Shove a saving throw (DC = 8 + STR + Prof) against the target\'s STR/DEX save!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: 'Per Attack',
      summary:
          'd20 + modifier + PB vs AC, natural 20 critical hits, natural 1 automatic miss.',
      tags: [
        'attack roll',
        'ac',
        'advantage',
    ...
    DmReferenceItem(
      ...
      cost: 'Continuous',
      summary:
          'Advantage on attacks when unseen; disadvantage against unseen targets.',
      tags: [
        'unseen',
        'hidden',
        'invisible',
    ...
    DmReferenceItem(
      ...
      cost: 'Within 5 ft',
      summary:
          'Disadvantage on ranged attack rolls when a hostile creature is within 5 ft.',
      tags: [
        'ranged',
        'melee range',
        '5 ft',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 required a full Action to drink or administer a potion. 2024 makes drinking or administering a potion a Bonus Action!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          'In 2024, rolling a Natural 20 on a death save lets you regain 1 HP AND immediately stand up / act without losing your turn.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      summary:
          'Declare nonlethal damage with melee attacks to knock unconscious instead of killing.',
    ...
    DmReferenceItem(
      ...
      summary:
          'Splitting movement, double cost terrain, and squeezing through small openings.',
      tags: [
        'movement',
        'difficult terrain',
        'squeezing',
    ...
    DmReferenceItem(
      ...
      summary:
          'Long Jump (STR score ft) & High Jump (3 + STR mod ft) with 10ft running start.',
      tags: [
        'jumping',
        'long jump',
        'high jump',
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 makes Jumping an active check (DC 10 Athletics/Acrobatics) to clear obstacles or gain extra height beyond standard baseline.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: 'Continuous',
      summary:
          'Weapon restrictions, movement penalties, and fire resistance submerged.',
      tags: [
        'underwater',
        'submerged',
        'swimming',
    ...
    DmReferenceItem(
      ...
      summary:
          'Advantage on melee attacks when ally is on direct opposite side of enemy.',
      tags: [
        'flanking',
        'optional',
        'advantage',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 strictly required a Bonus Action for the off-hand attack. 2024 codifies this in the Light weapon property (and weapon masteries like Nick can make it part of the Attack action with no Bonus Action used).',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 Bonus Action spell rule limited your Action to Cantrips. 2024 limits you to 1 spell slot per turn.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: '1 Reaction',
      summary:
          'Melee weapon strike when an enemy leaves your reach without Disengaging.',
    ...
    DmReferenceItem(
      ...
      cost: '1 Reaction',
      summary:
          'Triggered magical defenses like Shield, Absorb Elements, or Counterspell.',
      tags: [
        'shield',
        'absorb elements',
        'counterspell',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Combat / Checks',
      summary:
          'Disadvantage while source is in sight; cannot willingly move closer.',
      tags: [
        'frightened',
        'fear',
        'disadvantage',
    ...
    DmReferenceItem(
      ...
      interactiveTool: 'grapple_shove',
      diffSummary:
          '2024 grappled creatures suffer Disadvantage on attacks against anyone other than the grappler, and make saves at the end of each turn.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 explicitly mentions Bonus Actions, gives incoming attacks Advantage, and gives Disadvantage on Initiative rolls!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 clarifies that Invisible grants Advantage on Initiative rolls, and you are Concealed from standard sight and darkvision.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      subCategory: 'Incapacitating',
      summary:
          'Incapacitated, cannot move or speak, auto-fails STR/DEX saves, melee hits are crits.',
      tags: [
        'paralyzed',
        'incapacitated',
        'auto-fail',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Incapacitating',
      summary:
          'Transformed into solid stone (weight ×10), damage resistance, poison immunity.',
      tags: [
        'petrified',
        'stone',
        'resistance',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Movement',
      summary:
          'Lying on ground; crawling costs extra, standing costs half speed.',
      tags: [
        'prone',
        'crawl',
        'stand up',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Movement',
      summary:
          'Speed is 0, attacks against have advantage, disadvantage on DEX saves.',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Incapacitating',
      summary:
          'Incapacitated, faltering speech, auto-fails STR/DEX saves, attacks have advantage.',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Incapacitating',
      summary:
          'Knocked out, asleep, or reduced to 0 HP; hits within 5 ft are criticals.',
      tags: [
        'unconscious',
        'asleep',
        'incapacitated',
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 clarifies that unconscious creatures roll Initiative with Disadvantage if asleep when combat starts.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          'MASSIVE CHANGE: 2014 had 6 rigid tiers (disadvantage, half speed, death). 2024 uses 10 levels with a uniform -2 penalty to D20 tests and -5 ft speed reduction per level!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014: Skipped whole turn on round 1. 2024: No "surprised condition" — surprised creatures simply roll Initiative with Disadvantage!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      subCategory: 'Hazards',
      summary:
          'Contact, Ingested, Inhaled, and Injury poison mechanics and sample afflictions.',
      tags: [
        'poison',
        'disease',
        'toxic',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Cover',
      summary:
          'AC and Dexterity saving throw modifiers from physical obstacles.',
      tags: [
        'cover',
        'half cover',
        'three-quarters',
      ...
      isChangedIn2024: false,
      diffSummary:
          'Cover bonuses (+2, +5, Total) remain identical in 2014 and 2024.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      cost: 'Environmental',
      summary:
          'Target has three-quarters cover if about three-quarters of its body is covered.',
      tags: [
    ...
    DmReferenceItem(
      ...
      cost: 'Environmental',
      summary:
          'Target completely concealed by obstacle; cannot be targeted directly.',
    ...
    DmReferenceItem(
      ...
      diffSummary:
          '2024 standardizes falling onto another creature: DC 15 Dex save, damage is split evenly between both creatures on fail!',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.environment,
      summary:
          'Bright, Dim Light, Darkness, Darkvision, Blindsight, and Truesight.',
      tags: [
        'vision',
        'light',
        'dim light',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: false,
      diffSummary:
          'Holding breath duration and drowning countdown remain identical.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.environment,
      summary:
          'Heavy rain/snow, strong winds, and high altitude thin air penalties.',
      tags: [
        'weather',
        'heavy rain',
        'snow',
    ...
    DmReferenceItem(
      ...
      category: DmCategory.environment,
      summary:
          'Quicksand sinking DCs, slippery ice acrobatics, and unholy ground buffs.',
      tags: [
        'quicksand',
        'slippery ice',
        'desecrated ground',
    ...
    DmReferenceItem(
      ...
      diffSummary:
          'Standard DC scale (5, 10, 15, 20, 25, 30) is the foundational benchmark for all 5e editions.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.exploration,
      summary:
          'Formula: 10 + all modifiers (+5 with advantage, -5 with disadvantage).',
      tags: [
        'passive check',
        'passive perception',
        'contested roll',
    ...
    DmReferenceItem(
      ...
      category: DmCategory.exploration,
      summary:
          'Overland travel speed, stealth capability, and passive perception penalties.',
      tags: [
        'travel',
        'pace',
        'fast',
      ...
      isChangedIn2024: false,
      diffSummary:
          'Travel rates (30, 24, 18 miles/day) and stealth penalties match in both editions.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.exploration,
      summary:
          'Traveling beyond 8 hours daily requires progressive Constitution saving throws.',
      tags: [
        'forced march',
        'travel',
        'exhaustion',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2024 codifies exact DC thresholds for the Influence action: Friendly DC 10, Indifferent DC 15, Hostile DC 20.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.exploration,
      summary:
          'Perception / Investigation DCs to find traps; Thieves\' Tools to disarm.',
      tags: [
        'traps',
        'spotting',
        'disarming',
    ...
    DmReferenceItem(
      ...
      summary:
          'Maintaining active spells, saving throws, and simultaneous spell rules.',
      tags: [
        'concentration',
        'save',
        'con save',
      ...
      diffSummary:
          'DC formula (max of 10 or half damage) is identical in both editions.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.magicAndResting,
      summary:
          'Action, Bonus Action, Reaction, Areas (Cone, Cube, Cylinder, Line, Sphere), and Rituals.',
      tags: [
        'casting time',
        'ritual',
        'aoe',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 Bonus Action spell rule strictly limited your Action to Cantrips. 2024 limits you to expending only ONE spell slot on your turn (allowing Cantrip + Leveled, but preventing Double Leveled Slots).',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: true,
      diffSummary:
          '2014 Counterspell used an ability check (DC 10 + spell level). 2024 makes Counterspell force a Constitution saving throw from the caster to prevent the slot from being wasted.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.magicAndResting,
      summary:
          '3-item attunement limit, Short Rest attunement/identification rules.',
      tags: [
        'attunement',
        'identify',
        'magic items',
    ...
    DmReferenceItem(
      ...
      isChangedIn2024: false,
      diffSummary:
          'Short Rest (1 hr) and Long Rest (8 hrs, regain all HP, half Hit Dice, 1 Exhaustion level) are consistent.',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      category: DmCategory.magicAndResting,
      summary:
          'Crafting non-magic items, potions, scrolls, training languages, and recuperating.',
      tags: [
        'downtime',
        'crafting',
        'training',
    ...
    DmReferenceItem(
      ...
      summary:
          'AC and HP for doors, chests, barriers, and inanimate structures.',
      tags: [
        'object ac',
        'object hp',
        'wood',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Data & Reference Tables',
      summary:
          'Grid space control, carrying capacity, push/drag/lift formulas.',
      tags: [
        'size',
        'space',
        'carrying capacity',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Data & Reference Tables',
      summary:
          'Standard properties (Finesse, Light, Heavy, Reach) & 2024 Masteries (Cleave, Graze, Nick, Push, Sap, Slow, Topple, Vex).',
      tags: [
        'weapon properties',
        'finesse',
        'heavy',
      ...
      diffSummary:
          '2024 adds codified Weapon Masteries: Cleave (extra attack on adjacent), Graze (damage on miss), Nick (extra light attack without bonus action), Push (10ft knockback), Sap (enemy disadvantage), Slow (-10ft speed), Topple (Prone save), Vex (advantage on next attack).',
      rules2014: [
    ...
    DmReferenceItem(
      ...
      subCategory: 'Data & Reference Tables',
      summary:
          'AC formulas, stealth penalties, Strength minimums, and equip times.',
      tags: [
        'armor',
        'shield',
        'don',
    ...
    DmReferenceItem(
      ...
      subCategory: 'Data & Reference Tables',
      summary:
          'Common, Dwarvish, Elvish, Draconic, Undercommon, Sylvan, Celestial, Abyssal, Infernal.',
      tags: [
        'languages',
        'common',
        'elvish',
