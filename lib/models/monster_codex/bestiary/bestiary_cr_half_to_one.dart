  ...
  static final List<MonsterItem> entries = [
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          CreatureAction(
            name: 'Pseudopod',
            description:
                'Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 4 (1d6 + 1) bludgeoning damage plus 7 (2d6) acid damage.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 3,
            reach: '5 ft.',
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'The armor is incapacitated while in the area of an antimagic field. If targeted by dispel magic, the armor must succeed on a Con saving throw against the caster\'s spell save DC or fall unconscious for 1 minute.',
          ),
          CreatureTrait(
            name: 'False Appearance',
            description:
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Tree Stride',
            description:
                'Once on her turn, the dryad can use 10 ft. of her movement to step magically into one living tree within her reach and emerge from a second living tree within 60 ft.',
          ),
        ],
        actions: [
          CreatureAction(
            name: 'Club',
            description:
                'Melee Weapon Attack: +2 to hit (+6 with shillelagh), reach 5 ft., one target. Hit: 2 (1d4) bludgeoning damage, or 8 (1d8 + 4) bludgeoning damage with shillelagh.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 2,
            reach: '5 ft.',
            hitDamage: '1d4',
          ...
          CreatureAction(
            name: 'Fey Charm',
            description:
                'The dryad targets one humanoid or beast that she can see within 30 ft. of her. If the target can see the dryad, it must succeed on a DC 14 Wisdom saving throw or be magically charmed for 1 day.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Luring Song',
            description:
                'The harpy sings a magical melody. Every humanoid and giant within 300 ft. of the harpy that can hear the song must succeed on a DC 11 Wisdom saving throw or be charmed until the song ends.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            ...
            description:
                'While in sunlight, the specter has disadvantage on attack rolls and Perception checks.',
          ),
        ],
        actions: [
          CreatureAction(
            name: 'Life Drain',
            description:
                'Melee Spell Attack: +4 to hit, reach 5 ft., one creature. Hit: 10 (3d6) necrotic damage. The target must succeed on a DC 10 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken.',
    ...
    MonsterItem.simple(
      ...
      statBlock: const MinionStatBlock(
        ...
        chaScore: 16,
        skills:
            'Deception +5, Insight +4, Investigation +5, Perception +6, Persuasion +5, Stealth +4',
