      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'If a creature starts its turn within 30 ft. of the basilisk and the two of them can see each other, the basilisk can force the creature to make a DC 12 Constitution saving throw if the basilisk isn\'t incapacitated. On a failure, the creature begins to turn to stone and is restrained.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'The couatl has advantage on saving throws against spells and other magical effects.',
          ),
          CreatureTrait(
            name: 'Shielded Mind',
            description:
        ...
        actions: [
          CreatureAction(
            name: 'Bite',
            description:
                'Melee Weapon Attack: +8 to hit, reach 5 ft., one creature. Hit: 8 (1d6 + 5) piercing damage, and the target must succeed on a DC 13 Constitution saving throw or be poisoned for 24 hours. Until this poison ends, the target is unconscious.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 8,
            reach: '5 ft.',
            hitDamage: '1d6 + 5',
          ...
          CreatureAction(
            name: 'Constrict',
            description:
                'Melee Weapon Attack: +6 to hit, reach 10 ft., one Medium or smaller creature. Hit: 10 (2d6 + 3) bludgeoning damage, and the target is grappled (escape DC 15).',
            attackType: 'Melee Weapon Attack',
            attackBonus: 6,
            reach: '10 ft.',
            hitDamage: '2d6 + 3',
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Spellcasting',
            description:
                'The fanatic is a 4th-level spellcaster (spell save DC 11, +3 to hit with spell attacks). Cantrips: light, sacred flame, thaumaturgy. 1st level (4 slots): command, inflict wounds, shield of faith. 2nd level (3 slots): hold person, spiritual weapon.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Engulf',
            description:
                'The cube moves up to its speed. While doing so, it can enter Large or smaller creatures\' spaces. Whenever the cube enters a creature\'s space, the creature must make a DC 12 Dexterity saving throw. On a failure, the creature takes 10 (3d6) acid damage and is engulfed.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            ...
            description:
                'Each non-undead creature within 60 ft. of the ghost that can see it must succeed on a DC 13 Wisdom saving throw or be frightened for 1 minute.',
          ),
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Reckless',
            description:
                'At the start of its turn, the minotaur can gain advantage on all melee weapon attack rolls during that turn, but attack rolls against it have advantage until the start of its next turn.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'While in sunlight, the wight has disadvantage on attack rolls and Perception checks.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Invisibility',
            description:
                'The will-o\'-wisp and its light magically become invisible until it attacks or uses its Life Drain, or until its concentration ends.',
          ),
        ],
      ),
    ),
