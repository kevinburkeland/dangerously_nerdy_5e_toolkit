  ...
  static final List<MonsterItem> entries = [
    ...
    MonsterItem.simple(
      ...
      statBlock: const MinionStatBlock(
        ...
        chaScore: 5,
        damageImmunities:
            'lightning, poison; bludgeoning, piercing, and slashing from nonmagical attacks not made with adamantine',
        conditionImmunities:
        ...
        traits: [
          CreatureTrait(
            name: 'Berserk',
            description:
                'Whenever the golem starts its turn with 40 hit points or fewer, roll a d6. On a 6, the golem goes berserk and attacks the nearest creature it can see.',
          ),
          CreatureTrait(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            ...
            description:
                'While in sunlight, the wraith has disadvantage on attack rolls and Perception checks.',
          ),
        ],
        actions: [
          CreatureAction(
            name: 'Life Drain',
            description:
                'Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 21 (4d8 + 3) necrotic damage. The target must succeed on a DC 14 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 6,
            reach: '5 ft.',
            hitDamage: '4d8 + 3',
          ...
          CreatureAction(
            name: 'Create Specter',
            description:
                'The wraith targets a humanoid within 10 ft. of it that has been dead for no longer than 1 minute and died violently. The target\'s spirit rises as a specter in the space of its corpse or in the nearest unoccupied space.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'When a creature that can see the medusa\'s eyes starts its turn within 30 ft. of the medusa, the medusa can force it to make a DC 14 Constitution saving throw if the medusa isn\'t incapacitated. On a failed save, the creature magically begins to turn to stone and is restrained.',
          ),
        ],
        actions: [
          CreatureAction(
            name: 'Multiattack',
            description:
                'The medusa makes three attacks: either three with its snake hair, or two with its shortsword and one with its snake hair, or two with its longbow.',
          ),
          CreatureAction(
            name: 'Snake Hair',
            description:
