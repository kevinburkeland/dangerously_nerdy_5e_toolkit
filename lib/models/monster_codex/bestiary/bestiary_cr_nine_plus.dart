  ...
  static final List<MonsterItem> entries = [
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Mucous Cloud',
            description:
                'While underwater, the aboleth is surrounded by transformative mucus. A creature that touches the aboleth or hits it with a melee attack while within 5 ft. must succeed on a DC 14 Con save or be diseased for 1d4 hours.',
          ),
          CreatureTrait(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Enslave (3/Day)',
            description:
                'The aboleth targets one creature it can see within 30 ft. of it. The target must succeed on a DC 14 Wisdom saving throw or be magically charmed by the aboleth until the aboleth dies or is on a different plane of existence.',
          ),
        ],
        legendaryActions: [
          CreatureAction(
          ...
          CreatureAction(
            ...
            description:
                'One creature charmed by the aboleth takes 10 (3d6) psychic damage, and the aboleth regains hit points equal to the damage dealt.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            ...
            description:
                'Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or a creature that is grappled by the vampire, incapacitated, or restrained. Hit: 7 (1d6 + 4) piercing damage plus 10 (3d6) necrotic damage.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 9,
            reach: '5 ft.',
          ...
          CreatureAction(
            name: 'Charm',
            description:
                'The vampire targets one humanoid it can see within 30 ft. of it. If the target can see the vampire, the target must succeed on a DC 17 Wisdom saving throw against this magic or be charmed by the vampire.',
          ),
        ],
        legendaryActions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            ...
            description:
                'Each creature of the dragon\'s choice that is within 120 ft. of the dragon and aware of it must succeed on a DC 19 Wisdom saving throw or become frightened for 1 minute.',
          ),
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Rejuvenation',
            description:
                'If it has a phylactery, a destroyed lich gains a new body in 1d10 days, regaining all its hit points and becoming active again.',
          ),
          CreatureTrait(
        ...
        legendaryActions: [
          ...
          CreatureAction(
            ...
            description:
                'The lich fixes its gaze on one creature it can see within 10 ft. of it. The target must succeed on a DC 18 Wisdom saving throw against this magic or become frightened for 1 minute.',
          ),
          CreatureAction(
            name: 'Disrupt Life (Costs 3 Actions)',
            description:
                'Each living creature within 20 ft. of the lich must make a DC 18 Constitution saving throw against this magic, taking 21 (6d6) necrotic damage on a failed save, or half as much damage on a successful one.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            ...
            description:
                'Any time the tarrasque is targeted by a magic missile spell, a line spell, or a spell that requires a ranged attack roll, roll a d6. On a 1 to 5, the tarrasque is unaffected. On a 6, the tarrasque is unaffected, and the effect is reflected back at the caster.',
          ),
          CreatureTrait(
            name: 'Siege Monster',
            description:
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Frightful Presence',
            description:
                'Each creature of the tarrasque\'s choice within 120 ft. of it and aware of it must succeed on a DC 17 Wisdom saving throw or become frightened for 1 minute.',
          ),
          CreatureAction(
            name: 'Swallow',
            description:
    ...
    MonsterItem.simple(
      ...
      statBlock: const MinionStatBlock(
        ...
        chaScore: 1,
        damageImmunities:
            'acid, poison, psychic; bludgeoning, piercing, and slashing from nonmagical attacks not made with adamantine weapons',
        conditionImmunities:
    ...
    MonsterItem.simple(
      ...
      statBlock: const MinionStatBlock(
        ...
        chaScore: 1,
        damageImmunities:
            'fire, poison, psychic; bludgeoning, piercing, and slashing from nonmagical attacks not made with adamantine weapons',
        conditionImmunities:
            'charmed, exhaustion, frightened, paralyzed, petrified, poisoned',
