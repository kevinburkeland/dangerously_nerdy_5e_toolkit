      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          CreatureAction(
            name: 'Bite',
            description:
                'Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 1 piercing damage, and the target must succeed on a DC 10 Constitution saving throw or be poisoned for 1 minute.',
            attackType: 'Melee Weapon Attack',
            attackBonus: 4,
            reach: '5 ft.',
            hitDamage: '1',
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The jackal has advantage on attack rolls against a creature if at least one of the jackal\'s allies is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            ...
            description:
                'A lemure that dies in the Nine Hells revives with all its hit points in 1d10 days unless it was killed by a good-aligned creature with a bless spell cast on that creature or its remains are sprinkled with holy water.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          CreatureAction(
            name: 'Tentacles',
            description:
                'Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 1 bludgeoning damage, and the target is grappled (escape DC 10).',
            attackType: 'Melee Weapon Attack',
            attackBonus: 4,
            reach: '5 ft.',
            hitDamage: '1',
          ...
          CreatureAction(
            ...
            description:
                'A 5-foot-radius cloud of ink extends all around the octopus if it is underwater. The area is heavily obscured for 1 minute.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The hawk has advantage on an attack roll against a creature if at least one of the hawk\'s allies is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The rat has advantage on attack rolls against a creature if at least one of the rat\'s allies is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'While in sunlight, the kobold has disadvantage on attack rolls and Wisdom (Perception) checks.',
          ),
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The kobold has advantage on attack rolls against a creature if at least one ally is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Sure-Footed',
            description:
                'The mule has advantage on Strength and Dexterity saving throws made against being knocked prone.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The warrior has advantage on attack rolls against a creature if at least one ally is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            name: 'Spellcasting',
            description:
                'The acolyte is a 1st-level spellcaster (spell save DC 12, +4 to hit with spell attacks). Cantrips: light, sacred flame, thaumaturgy. 1st level (3 slots): bless, cure wounds, sanctuary.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Sunlight Sensitivity',
            description:
                'While in sunlight, the drow has disadvantage on attack rolls and Perception checks.',
          ),
        ],
        actions: [
          CreatureAction(
          ...
          CreatureAction(
            name: 'Hand Crossbow',
            description:
                'Ranged Weapon Attack: +4 to hit, range 30/120 ft., one target. Hit: 5 (1d6 + 2) piercing damage, and the target must succeed on a DC 13 Constitution saving throw or be poisoned for 1 hour.',
            attackType: 'Ranged Weapon Attack',
            attackBonus: 4,
            reach: 'range 30/120 ft.',
            hitDamage: '1d6 + 2',
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'The sword is incapacitated while in the area of an antimagic field. If targeted by dispel magic, the sword must succeed on a Con saving throw against the caster\'s spell save DC or fall unconscious for 1 minute.',
          ),
          CreatureTrait(
            name: 'False Appearance',
            description:
                'While the sword remains motionless, it is indistinguishable from a normal sword.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          ...
          CreatureTrait(
            name: 'Pack Tactics',
            description:
                'The wolf has advantage on attack rolls against a creature if at least one ally is within 5 ft.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        traits: [
          CreatureTrait(
            ...
            description:
                'If damage reduces the zombie to 0 hit points, it must make a Con save DC 5 + damage taken, unless radiant or a critical hit. On success, zombie drops to 1 HP instead.',
          ),
        ],
        actions: [
          CreatureAction(
      ...
      statBlock: const MinionStatBlock(
        ...
        reactions: [
          CreatureAction(
            name: 'Shriek',
            description:
                'When bright light or a creature is within 30 ft. of the shrieker, it emits a shriek audible within 300 ft. of it. The shrieker continues to shriek until the disturbance moves out of range and for 1d4 of the shrieker\'s turns afterward.',
          ),
        ],
      ),
    ),
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Shortbow',
            description:
                'Ranged Weapon Attack: +6 to hit, range 40/160 ft., one target. Hit: 1 piercing damage, and the target must succeed on a DC 10 Constitution saving throw or become poisoned for 1 minute. If the saving throw fails by 5 or more, the target falls unconscious for the same duration.',
            attackType: 'Ranged Weapon Attack',
            attackBonus: 6,
            reach: '40/160 ft.',
            hitDamage: '1',
          ...
          CreatureAction(
            name: 'Heart Sight',
            description:
                'The sprite touches a creature and magically knows the creature\'s current emotional state. If the target fails a DC 10 Charisma saving throw, the sprite also knows the creature\'s alignment.',
          ),
          CreatureAction(
            name: 'Invisibility',
            description:
