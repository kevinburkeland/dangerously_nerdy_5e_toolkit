...
class BestiaryCr0ToQuarter {
  ...
  static final List<MonsterItem> entries = [
    ...
    MonsterItem.simple(
      id: 'srd_mon_giant_poisonous_snake',
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          CreatureAction(
            ...
            attackBonus: 6,
            reach: '10 ft.',
            hitDamage: '1d4 + 4 + 3d6 poison',
          ),
        ],
      ),
    ),
    MonsterItem.simple(
      id: 'srd_mon_giant_wolf_spider',
    ...
    MonsterItem.simple(
      ...
      statBlock: const MinionStatBlock(
        ...
        actions: [
          ...
          CreatureAction(
            name: 'Shortbow',
            description: 'Ranged Weapon Attack: +6 to hit, range 40/160 ft., one target. Hit: 1 piercing damage, and the target must succeed on a DC 10 Constitution saving throw or become poisoned for 1 minute. If the saving throw fails by 5 or more, the target falls unconscious for the same duration.',
            attackType: 'Ranged Weapon Attack',
            attackBonus: 6,
            reach: '40/160 ft.',
            hitDamage: '1',
