...
class StorageDurabilityBanner extends StatefulWidget {
  ...
  @override
  State<StorageDurabilityBanner> createState() => _StorageDurabilityBannerState();
}
...
class StorageLockOfflineAction extends StatefulWidget {
  ...
  @override
  State<StorageLockOfflineAction> createState() => _StorageLockOfflineActionState();
}
    ...
    return StreamBuilder<StorageTelemetryReport>(
      ...
      builder: (context, snapshot) {
        ...
        final requiresGesture = widget.coordinator.requiresContextualPrompt ||
            (report != null && !report.isPersisted && !report.profile.isStandalonePwa);
