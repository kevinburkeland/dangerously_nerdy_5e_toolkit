...
class CharacterDto {
  ...
  factory CharacterDto.fromJson(Map<String, dynamic> json) {
    ...
    final resolvedName =
        json['name'] is String ? json['name'] as String : 'Unknown Adventurer';
    final resolvedLevel =
        (json['level'] is num ? (json['level'] as num).toInt() : 1)
            .clamp(1, 20);
    final resolvedStrength =
        (json['strength'] is num ? (json['strength'] as num).toInt() : 10)
            .clamp(1, 30);
