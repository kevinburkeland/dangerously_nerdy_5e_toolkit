...
- **What is stored:** Custom dice formulas, user-saved presets, and application preferences (e.g., custom d20 modifiers or custom die counts).
- **Where it is stored:** Exclusively on your local browser/device cache via web `LocalStorage`.
...
- **What is processed:** Temporary room codes (e.g., `ROOM-1234`), optional display names chosen for session feeds, and raw roll mathematical outcomes (e.g., `2d20 + 5`).
