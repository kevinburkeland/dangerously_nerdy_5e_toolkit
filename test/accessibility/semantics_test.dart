...
void main() {
  group('Accessibility & Semantics Tests', () {
    testWidgets('PressableCard exposes configured semantics correctly',
        (tester) async {
        ...
        MaterialApp(
          home: Scaffold(
            body: PressableCard(
              onTap: () {},
              semanticLabel:
                  'DM Screen, 2014 & 2024. Quick lookup tool. Tap to launch.',
    ...
    testWidgets('LandingScreen has semantic headers and accessible tool cards',
        (tester) async {
      final handle = tester.ensureSemantics();
    ...
    testWidgets(
        'DmReferenceScreen exposes header semantics on title and sections',
        (tester) async {
      final handle = tester.ensureSemantics();
      tester.view.physicalSize = const Size(1200, 2000);
      tester.view.devicePixelRatio = 1.0;
