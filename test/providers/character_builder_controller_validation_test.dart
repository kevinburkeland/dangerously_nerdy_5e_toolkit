...
void main() {
  group('CharacterBuilderController Invariant & Refund Tests', () {
    test('Resetting orphaned skill refunds when overlapping skills change', () {
      ...
      expect(controller.grantedBackgroundSkills,
          containsAll([SkillType.insight, SkillType.religion]));
      ...
      expect(controller.bonusReplacementSkills,
          containsAll([SkillType.acrobatics, SkillType.stealth]));
    ...
    test('Controller evaluates validation issues on draft mutation', () {
      ...
      expect(
          controller.validationIssues
              .where((i) => i.code == 'feat_prereq_unmet'),
          isEmpty);
    });
  });
}
