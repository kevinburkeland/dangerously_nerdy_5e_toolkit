...
void main() {
  group('ClassDetailDialog Spells & Subclass Spells UI Tests', () {
    ...
    setUp(() {
      testCasterClass = CharacterClass(
        ...
        subclasses: [
          Subclass(
            id: const EntityId(
                slug: 'life-domain', ruleset: RulesetVersion.v2024),
            name: 'Life Domain',
            classSlug: 'cleric',
            featuresMarkdown:
    ...
    testWidgets(
        'Renders Class Features, Subclasses, and Spells tabs for spellcasters',
        (tester) async {
    ...
    testWidgets(
        'Subclasses tab displays SUBCLASS / BONUS SPELLS chips for granted spells',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets('Spells tab displays search bar, level chips, and spell items',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
