...
void main() {
  ...
  testWidgets('ActionEconomyDialog renders tabs and actions',
  ...
  testWidgets('ActionEconomyDialog search filters combat actions dynamically',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
  ...
  testWidgets('ActionEconomyDialog switches to Bonus Action and Reaction tabs',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
  ...
  testWidgets('ActionEconomyDialog toggles to 2014 edition',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
