...
void main() {
  group('HomebrewExpertOptionsView Widget & A11y Tests', () {
    testWidgets(
        'Renders warnings, keeps submit disabled until explicit ruleset and agreement',
        (tester) async {
      ...
      expect(find.text('Client-Side Ingestion & Licensing Disclaimer'),
          findsOneWidget);
      ...
      // Select 2024 ruleset
      final radioOption = find.text('2024 SRD 5.2.1');
