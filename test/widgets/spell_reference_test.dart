...
void main() {
  testWidgets('SpellReferenceWidget renders responsive creature profile cards',
      (WidgetTester tester) async {
    final wolfPreset = SrdSummonsLibrary.allPresets
        .firstWhere((p) => p.id == 'conjure_animals');
