...
void main() {
  group('Arena Monster Info Dots & Codex Dialog Tests', () {
    testWidgets(
        'ArenaMonsterPickerSheet renders info dot button and opens CreatureStatBlockDialog',
        (tester) async {
      ...
      expect(find.widgetWithText(CreatureStatBlockDialog, firstName),
          findsOneWidget);
    ...
    testWidgets(
        'ArenaCombatantCard in setup mode renders info button and opens CreatureStatBlockDialog',
        (tester) async {
      final tRex =
      ...
      // Verify CreatureStatBlockDialog opened
      expect(find.byType(CreatureStatBlockDialog), findsOneWidget);
      expect(find.widgetWithText(CreatureStatBlockDialog, 'Tyrannosaurus Rex'),
          findsOneWidget);
    });

    testWidgets(
        'ArenaCombatantCard in battle mode renders info button and opens CreatureStatBlockDialog',
        (tester) async {
      ...
      expect(find.byType(CreatureStatBlockDialog), findsOneWidget);
      expect(
          find.widgetWithText(CreatureStatBlockDialog, 'Wolf'), findsOneWidget);
    });

    testWidgets(
        'ArenaClashStage renders attacker and defender info dots and opens CreatureStatBlockDialog',
        (tester) async {
      final tRex =
          MonsterCodexLibrary.getMonsterById('srd_mon_tyrannosaurus_rex')!;
      final wolf = MonsterCodexLibrary.getMonsterById('srd_mon_wolf')!;
