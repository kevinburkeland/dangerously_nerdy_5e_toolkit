...
void main() {
  ...
  testWidgets('AnimatedResourceMeter renders labels and ratios correctly',
      (tester) async {
  ...
  testWidgets(
      'AnimatedResourceMeter triggers low-resource critical alert and pulse when <= 25%',
      (tester) async {
    final settingsProvider = SettingsProvider();
  ...
  testWidgets(
      'AnimatedResourceMeter renders temporary HP bonus label and semantics',
      (tester) async {
    final settingsProvider = SettingsProvider();
