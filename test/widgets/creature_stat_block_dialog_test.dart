...
void main() {
  group('CreatureStatBlockDialog Tests', () {
    testWidgets('renders full 5e SRD stat block fields for Wolf',
    ...
    testWidgets(
        'renders elemental traits and special actions for Fire Elemental',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    testWidgets('onAddToSquad callback fires when ADD TO SQUAD tapped',
        (WidgetTester tester) async {
      bool added = false;
    ...
    testWidgets('switches between Stat Block and Damage / DPR tabs smoothly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
