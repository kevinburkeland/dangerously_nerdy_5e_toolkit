...
void main() {
  group('PartyVitalityHud Widget Tests', () {
    testWidgets('renders character vitality metrics, HP bar, AC, and speed',
        (tester) async {
    ...
    testWidgets(
        'displays External Homebrew chip with tooltip when hasUnresolvedPointers is true',
        (tester) async {
    ...
    testWidgets('renders death saves when character is downed (currentHp == 0)',
        (tester) async {
