...
void main() {
  group('CreatureDprView Widget Tests', () {
    testWidgets('renders DPR calculations and Pack Tactics badge for Wolf',
    ...
    testWidgets('supports switching target AC chips and stepping AC +/-',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    testWidgets(
        'supports toggling roll modifiers (Normal, Advantage, Disadvantage)',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    testWidgets(
        'renders Multiattack routine with multiple actions for Brown Bear',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
