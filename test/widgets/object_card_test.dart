...
void main() {
  ...
  testWidgets(
      'ObjectCard displays 1-second combat HUD and handles HP modifications',
  ...
  testWidgets('ObjectCard displays DESTROYED badge when object is dead',
      (WidgetTester tester) async {
  ...
  testWidgets('ObjectCard displays TEMP badge when temp HP is active',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'SetObjectHpDialog allocates bonus health in excess of cap to temp HP',
      (WidgetTester tester) async {
    ...
    expect(
        dialogResult!.tempHp, 5); // 25 - 20 = 5 bonus HP allocated as temp HP!
  });
}
