...
void main() {
  ...
  group('Attributes-First Lineage Flexible Choices & Class Skills Tests', () {
    testWidgets(
        'Selecting Half-Elf in 2014 mode prompts flexible choices inside card and gates progression',
        (tester) async {
      ...
      expect(find.textContaining('Half-Elf Lineage Ability Choices (+1):'),
          findsOneWidget);
      expect(find.textContaining('Species Bonus Skills (Half-Elf):'),
          findsOneWidget);
      ...
      final nextButtonStillDisabled = tester.widget<ElevatedButton>(
          find.widgetWithText(ElevatedButton, 'Next Step'));
    ...
    testWidgets(
        'Imported class starting skills populate allowed skills and choice count',
        (tester) async {
      tester.view.physicalSize = const Size(1280, 2500);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
