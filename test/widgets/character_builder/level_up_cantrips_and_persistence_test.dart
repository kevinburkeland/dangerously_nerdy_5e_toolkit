...
void main() {
  group('Level Up Cantrip Quotas & Persistence Verification Tests', () {
    ...
    testWidgets(
        'Leveling Wizard from 1 to 2 strictly blocks selecting any new cantrips (quota 0)',
        (tester) async {
      ...
      expect(find.textContaining('0 New Cantrips allowed (3/3 already known)'),
          findsOneWidget);
      ...
      expect(find.textContaining('No new cantrips granted at Level 2'),
          findsOneWidget);
    ...
    testWidgets(
        'CharacterHeaderBanner Level Up immediately persists upgraded character to persistence service',
        (tester) async {
    ...
    test(
        'CharacterSheetController.setCharacter persists immediately when persist is true',
        () async {
      final controller = CharacterSheetController(
        character: level1Wizard,
        persistenceService: mockPersistence,
