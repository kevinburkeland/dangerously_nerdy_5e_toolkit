...
void main() {
  ...
  testWidgets('ConditionReferenceDialog displays conditions and categories',
  ...
  testWidgets('ConditionReferenceDialog filter category chips work',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
  ...
  testWidgets('ConditionReferenceDialog toggles between 2014 and 2024 editions',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
    ...
    expect(find.textContaining('Cumulative penalty across 10 total levels'),
        findsOneWidget);
    ...
    expect(find.textContaining('Level 1: Disadvantage on ability checks'),
        findsOneWidget);
  });

  testWidgets(
      'ConditionReferenceDialog search filters conditions by name or mechanic',
      (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
