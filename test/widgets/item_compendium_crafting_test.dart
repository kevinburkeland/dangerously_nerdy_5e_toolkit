...
void main() {
  ...
  group('Item Compendium Pricing & Crafting Widget Tests', () {
    ...
    testWidgets(
        'ItemDetailDialog renders tab bar with Rules & Traits and Crafting Rules',
        (tester) async {
      ...
      expect(find.textContaining('Downtime Crafting Requirements'),
          findsOneWidget);
    ...
    testWidgets(
        'ItemDetailDialog supports switching rules editions inside dialog',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'ItemCard renders silver (sp) price badge with silver color coding',
        (tester) async {
    ...
    testWidgets(
        'ItemCard renders markdown formatted text and tables via FormattedMarkdownText',
        (tester) async {
    ...
    testWidgets('ItemDetailDialog renders markdown table in rules tab',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
