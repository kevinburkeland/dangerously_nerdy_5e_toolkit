...
void main() {
  ...
  testWidgets('Privacy Policy dialog renders and closes cleanly',
  ...
  testWidgets('Terms of Service dialog renders and closes cleanly',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(
      Builder(
        builder: (context) => ElevatedButton(
  ...
  testWidgets(
      'Legal & SRD 5.1 / 5.2.1 Attribution dialog renders and closes cleanly',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(
      Builder(
        builder: (context) => ElevatedButton(
    ...
    expect(find.text('Legal & SRD 5.1 / 5.2.1 Attribution'), findsOneWidget);
