...
void main() {
  ...
  group('CharacterSheetView Widget Tests', () {
    ...
    testWidgets(
        'Renders character name, class level, vital HUD cards, and ability ribbon',
        (tester) async {
    ...
    testWidgets('Toggling Equip on Plate Armor immediately updates AC to 18',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
      ...
      final inventoryTab =
          find.byWidgetPredicate((w) => w is Tab && w.text == 'Inventory');
    ...
    testWidgets('Toggling Inspiration updates state reactively',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
    ...
    testWidgets('Attuning to item updates Attuned Slots count in Inventory tab',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
    ...
    testWidgets(
        'Tapping reparse button in AppBar triggers reparse and shows SnackBar',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
      ...
      final reparseButton =
          find.byKey(const Key('reparse_sheet_appbar_button'));
    ...
    testWidgets(
        'Tapping reparse chip in Header Banner triggers reparse and shows SnackBar',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
