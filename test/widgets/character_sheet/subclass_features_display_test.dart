...
void main() {
  group('FeaturesTraitsSection Subclass Features Display Tests', () {
    testWidgets(
      ...
      expect(
          find.textContaining(
              'make a bonus melee attack or deal extra frenzy damage'),
          findsOneWidget);
    ...
    testWidgets('Subclass features respect character level gating',
        (tester) async {
...
''',
      ...
      expect(find.textContaining('use your reaction to impose disadvantage'),
          findsOneWidget);
      expect(find.byIcon(Icons.close), findsOneWidget);
