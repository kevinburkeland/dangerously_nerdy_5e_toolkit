...
void main() {
  ...
  group('Feat & Stat Modification on Character Sheet Tests', () {
    ...
    test(
      ...
      // Modify base score
      await controller.modifyAbilityScore(AbilityType.strength, 16,
          isBaseScore: true);
      ...
      await controller.modifyAbilityScore(AbilityType.constitution, 1,
          isBaseScore: false);
    ...
    test(
      ...
      // Add Versatile Specialist granting +1 CON, Athletics as skill grant, and Athletics as expertise grant
      await controller.addFeat(
        versatileSpecialistRef,
      ...
      expect(
          controller.character.feats
              .any((f) => f.slug == 'versatile-specialist'),
          isTrue);
      expect(controller.character.bonusScores.constitution, equals(1));
      expect(controller.stats.effectiveScores.constitution, equals(15));
    ...
    test(
        'Campaign audit log tracks stat and feat changes when character is part of a campaign',
        () async {
      ...
      final statEvt =
          updatedProfile.changeLog.firstWhere((e) => e.type == 'statModified');
      ...
      final featAddEvt =
          updatedProfile.changeLog.firstWhere((e) => e.type == 'featAdded');
      ...
      final featRemEvt =
          updatedProfile.changeLog.firstWhere((e) => e.type == 'featRemoved');
          ...
          home: Scaffold(
            body: Builder(
              builder: (context) => ElevatedButton(
                onPressed: () => ModifyAbilityScoresDialog.show(context,
