...
void main() {
  group('Skill Expertise Controller & UI Tests', () {
    test(
      ...
      await controller.setSkillProficiency(
      ...
      await controller.setSkillProficiency(
          SkillType.persuasion, SkillProficiencyLevel.none);
      expect(
          controller.character.skillProficiencies
              .containsKey(SkillType.persuasion),
          isFalse);
      expect(controller.stats.skillModifiers[SkillType.persuasion], equals(4));
    });
    ...
    testWidgets(
        'SkillsSavesMatrix displays EXPERTISE badge and amber star for Persuasion with expertise',
        (tester) async {
      final character = _createTestWarlock(
        skillProficiencies: {
          SkillType.persuasion: SkillProficiencyLevel.expertise,
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              child: AnimatedBuilder(
                ...
                builder: (context, _) =>
                    SkillsSavesMatrix(controller: controller),
              ),
            ),
          ),
        ),
    ...
    test(
        'CharacterEvaluationEngine applies FeatureGrant.expertise to skillModifiers',
        () {
      final grantFeat = Feat(
        id: const EntityId(
            slug: 'custom-persuasion-master', ruleset: RulesetVersion.v2014),
