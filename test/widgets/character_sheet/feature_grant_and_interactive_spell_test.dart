...
void main() {
  ...
  group('InteractiveSpellTile Widget Tests', () {
    ...
    testWidgets(
        'Renders spell title, +Atk bonus, formula with Cha bonus, and minimum touch target size',
        (tester) async {
    ...
    testWidgets(
        'Tapping spell tile executes attack and damage rolls, displaying SnackBar',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets(
        'Tapping details info button opens modal bottom sheet with semantics header and description',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
  ...
  group('FeaturesTraitsSection Widget Tests', () {
    ...
    testWidgets(
        'Renders all feature categories with 48x48 touch targets and opens detail modal',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(find.textContaining('add your Charisma modifier to the damage'),
          findsOneWidget);
    ...
    testWidgets(
        'Visual stress test: 2.0x Text Scale renders without RenderFlex overflow',
        (tester) async {
                  ...
                  children: [
                    ...
                    InteractiveSpellTile(
                      spell: const Spell(
                        ...
                        school: 'evocation',
                        castingTime:
                            CastingTime(cost: 1, actionType: ActionType.action),
                        duration:
                            SpellDuration(type: DurationType.instantaneous),
                        range: '120 ft',
                        components: SpellComponents(v: true, s: true),
