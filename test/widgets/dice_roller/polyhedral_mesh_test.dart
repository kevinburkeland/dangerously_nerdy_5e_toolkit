...
void main() {
  group('PolyhedronMesh Geometry Tests', () {
    ...
    test(
        'createD10 produces a mathematically exact pentagonal trapezohedron mesh',
        () {
    ...
    test(
        'createD100 and createMedallion produce a 3D coin medallion mesh for d100 and custom dice',
        () {
