...
void main() {
  group('RulesEditionToggle Tests', () {
    testWidgets('Renders 2014 and 2024 options with active selection',
        (tester) async {
    ...
    testWidgets('Renders dense, expanded, showIcons, and showSubtext variants',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(find.text('2024'), findsOneWidget);
      expect(find.text('(5.2.1 Revised)'), findsOneWidget);
  ...
  group('Common Diff Widgets Tests', () {
    testWidgets('DiffHighlightBanner renders summary and highlight chips',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
      ...
      expect(
          find.text('Key mechanical revisions to this rule.'), findsOneWidget);
