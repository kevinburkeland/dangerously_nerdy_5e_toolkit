...
void main() {
  group('D&D Glyph System Tests', () {
    ...
    testWidgets(
      ...
      expect(find.text('5E Glyph Studio & Codex'), findsOneWidget);
      ...
      expect(
          find.text('8. Species & Heritage Sigils (2024 SRD)'), findsOneWidget);
      ...
      expect(
          find.text('8. Races & Heritage Sigils (2014 SRD)'), findsOneWidget);
    ...
    testWidgets(
        'DndGlyph handles repeated sequential mouse hover enter and exit cycles without freezing',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Center(
              child: DndGlyph.monster(
                creatureType: CreatureType.dragon,
                actionRings: const [
                  ActionTraitRing(ringType: ActionRingType.recharge)
                ],
                size: 64,
              ),
            ),
