...
void main() {
  group('Polymorphic Glyph System & Renderables', () {
    ...
    testWidgets(
        'DndGlyph.fromRenderable renders Feats, Classes, Species, and Generic UI',
        (tester) async {
    ...
    testWidgets('DndGlyph renders all 12 Character Classes without exception',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(find.byType(DndGlyph), findsNWidgets(12));
    });
    ...
    test('SpeciesType 2014 vs 2024 SRD speed, size, and trait specifications',
      ...
      expect(SpeciesType.human.getSize(DmRulesEdition.v2024),
          equals('Medium or Small'));
