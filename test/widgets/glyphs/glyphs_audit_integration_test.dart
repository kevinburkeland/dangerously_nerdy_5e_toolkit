...
void main() {
  ...
  group('Glyph Audit Integration Tests', () {
    ...
    testWidgets('ClassDetailDialog renders DndGlyph.classFeature',
        (tester) async {
      final cls = SrdClassesLibrary.allClasses.first;
      await tester.pumpWidget(
        wrapWithSettings(
    ...
    testWidgets('CharacterHeaderBanner renders avatar DndGlyph',
        (tester) async {
      await tester.pumpWidget(
        wrapWithSettings(
    ...
    testWidgets(
        'CharacterVitalsHud renders DndGlyph for Hit Dice & Death Saves',
        (tester) async {
      await tester.pumpWidget(
        wrapWithSettings(
    ...
    testWidgets('SkillsSavesMatrix renders DndGlyph for Roll Mode toggle',
        (tester) async {
      await tester.pumpWidget(
        wrapWithSettings(
          SingleChildScrollView(
    ...
    testWidgets('InteractiveSpellTile and SpellListItem render DndGlyph.spell',
        (tester) async {
      await tester.pumpWidget(
        wrapWithSettings(
          Column(
            children: [
              InteractiveSpellTile(
                  spell: testSpell, controller: testController),
    ...
    testWidgets('ShortRestDialog renders Hit Die DndGlyph.genericUi',
        (tester) async {
      await tester.pumpWidget(
        wrapWithSettings(
          Builder(
            builder: (context) => ElevatedButton(
              onPressed: () =>
                  ShortRestDialog.show(context, controller: testController),
