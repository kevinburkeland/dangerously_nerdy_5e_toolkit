...
void main() {
  group('5e Item Glyph System Tests', () {
    test(
        'All 13 ItemCategories and 7 ItemRarities have valid colors and frame shapes',
        () {
    ...
    test(
        'GlyphThemeData.fromItem correctly assigns primary colors and frame shapes',
        () {
      final themeWeapon = GlyphThemeData.fromItem(ItemCategory.weapon);
      expect(
          themeWeapon.frameShape, equals(GlyphFrameShape.sharpDiamondShield));
      ...
      expect(themeRareWeapon.frameShape,
          equals(GlyphFrameShape.sharpDiamondShield));
    ...
    test('ActionRingType.attunement has valid colors and geometry', () {
      ...
      expect(
          ring.getEffectiveColor(Colors.white, isDarkMode: false), isNotNull);
    });

    test('GlyphGalleryData.allItems contains items for all 13 categories', () {
    ...
    testWidgets('DndGlyph.item renders correctly across all 13 item categories',
    ...
    testWidgets(
        'DndGlyph.item renders with damage accents and action trait rings',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets(
        'DndGlyph.item responds to focus state and enables active animations',
        (WidgetTester tester) async {
