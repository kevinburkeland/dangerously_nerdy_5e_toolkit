...
void main() {
  group('CharacterDraft Model & Validation Tests', () {
    ...
    test('Draft accepts mutations in arbitrary out-of-order sequence', () {
      ...
      draft.characterName = 'Thorek Ironshield';
  ...
  group('CharacterFactory.buildFromDraft Tests', () {
    test(
        'buildFromDraft throws StateError with informative message on incomplete draft',
        () {
      ...
      expect(
        ...
        throwsA(isA<StateError>().having(
          ...
          'message',
          contains(
              'Missing mandatory field(s): Class, Background, Base Scores'),
        )),
      );
    });
    ...
    test('buildFromDraft compiles complete draft into valid Character entity',
      ...
      expect(
          character.progression.classes.first.classRef.slug, equals('fighter'));
      ...
      expect(
          character.savingThrowProficiencies, contains(AbilityType.strength));
