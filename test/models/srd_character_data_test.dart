...
void main() {
  group('SRD Character Libraries Tests', () {
    test(
        'SrdFeatsLibrary contains only the Grappler feat under strict SRD compliance',
        () {
    ...
    test(
        'SrdClassesLibrary contains all 12 SRD classes with valid progression rules',
        () {
    ...
    test(
        'SrdBackgroundsLibrary contains only the Acolyte background under strict SRD compliance',
        () {
