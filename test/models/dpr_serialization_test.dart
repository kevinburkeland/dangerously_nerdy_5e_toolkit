...
void main() {
  ...
  group('DPR Serialization & Persistence Tests', () {
    ...
    test(
        'DprAttackAction round-trip serialization maintains all complex properties',
        () {
    ...
    test('DprPersistenceService saves and loads custom builds library',
        () async {
      ...
      expect(library.map((p) => p.name),
          containsAll(['Build Alpha', 'Build Beta']));
