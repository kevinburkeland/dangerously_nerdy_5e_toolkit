...
void main() {
  ...
  group('HomebrewStudioScreen Widget Tests', () {
    ...
    testWidgets('renders Homebrew Studio tabs and empty states',
        (tester) async {
    ...
    testWidgets('opens SpellBuilderDialog on New Spell tap and saves spell',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: HomebrewStudioScreen(),
      ...
      await tester.enterText(
        find.widgetWithText(
            TextFormField, 'Spell Description (Markdown supported)'),
    ...
    testWidgets('opens HomebrewImportPreviewDialog and parses compendium JSON',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
      ...
      const jsonSnippet =
          '{"spell":[{"name":"Frost Nova","source":"HOMEBREW","level":3,"school":"V","time":[{"number":1,"unit":"action"}],"range":{"type":"point","distance":{"type":"feet","amount":30}},"components":{"v":true,"s":true},"duration":[{"type":"instant"}],"entries":["Freezes ground dealing {@damage 6d6|cold} damage."]}]}';
    ...
    testWidgets(
        'imports multi-category bundle including classes, races, and feats with deduplication',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: HomebrewStudioScreen(useIsolate: false),
...
''';
    ...
    testWidgets('opens HomebrewExportDialog and generates bundle JSON',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: HomebrewStudioScreen(),
    ...
    testWidgets('opens HomebrewRefresherDialog and executes reparse',
        (tester) async {
    ...
    testWidgets(
        'opens HomebrewBulkDeleterDialog and executes category deletion',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: HomebrewStudioScreen(),
    ...
    testWidgets('supports in-tab multi-select mode and batch item deletion',
        (tester) async {
    ...
    testWidgets(
        'Codex & Rules tab renders category chips and filters other entries',
        (tester) async {
      final persistence = HomebrewPersistenceService();
    ...
    testWidgets(
        'HomebrewBulkDeleterDialog supports granular subcategory deletion',
        (tester) async {
      final persistence = HomebrewPersistenceService();
      await persistence.saveCustomOtherEntriesBatch([
        const HomebrewCompendiumEntry(
