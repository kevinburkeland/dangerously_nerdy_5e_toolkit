...
void main() {
  ...
  group('LandingScreen Campaign Carousel & Hub Section', () {
    ...
    testWidgets(
        'Renders campaign cards with role badges and room codes when present',
        (tester) async {
      final registry = CampaignRegistryService();
    ...
    testWidgets('Tapping Create New Campaign opens CreateCampaignDialog',
        (tester) async {
      final registry = CampaignRegistryService();
      registry.membershipsNotifier.value = [];
    ...
    testWidgets('Tapping Join Campaign opens JoinCampaignDialog',
        (tester) async {
      final registry = CampaignRegistryService();
      registry.membershipsNotifier.value = [];
