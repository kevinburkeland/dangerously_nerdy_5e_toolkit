...
void main() {
  Widget buildTestableScreen(
      {SettingsProvider? settingsProvider, DmRulesEdition? initialEdition}) {
  ...
  group('ArenaSimulatorScreen Widget Tests', () {
    testWidgets('respects global rules edition from SettingsProvider (2014)',
        (tester) async {
    ...
    testWidgets(
        'renders Arena screen with title, presets, and default fighters',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('starts battle and advances turns step by step',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'Skip to End instantly concludes battle and presents victory dialog',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('opens Monte Carlo dialog and simulates win probabilities',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'toggles 2014 and 2024 rules via RulesEditionToggle and opens environment descriptors dialog',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'renders cleanly without overflow on mobile phone screen (360x640)',
        (tester) async {
    ...
    testWidgets(
        'Clear All Creatures removes all monsters from both teams with undo option',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('Clear Team removes creatures from one team with undo option',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(
          find.text('Cleared all creatures from Team Crimson'), findsOneWidget);
