...
void main() {
  ...
  testWidgets(
      'LandingScreen renders branding, headers, and individual tool cards with DndGlyphs',
  ...
  testWidgets('Tapping Animate Objects launches Animate Objects tool screen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets(
      'Tapping Conjure Animals launches Conjure Animals tool screen with 8 Wolves',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets('Tapping DPR Calculator navigates to DPR Calculator screen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets('Tapping Spellbook Spells navigates to Spellbook screen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets('Tapping Item Codex navigates to Item Codex screen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets('Tapping Monster Codex navigates to Monster Codex screen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets('Tapping Dice Roller & Party Rooms launches DiceRollerScreen',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets(
      'Entering search query filters tools dynamically and shows result count',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets(
      'Entering non-matching search query shows empty state with Clear Search button',
      (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget(const LandingScreen()));
  ...
  testWidgets(
      'LandingScreen RulesEditionToggle toggles global 2014 and 2024 rules edition',
      (WidgetTester tester) async {
