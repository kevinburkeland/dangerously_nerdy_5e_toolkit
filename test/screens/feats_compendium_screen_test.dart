...
void main() {
  ...
  testWidgets(
      'FeatsCompendiumScreen renders, filters, and opens feat detail dialog',
      (tester) async {
  ...
  testWidgets(
      'FeatsCompendiumScreen renders full feats catalogue in 2014 rules edition mode',
      (tester) async {
  ...
  testWidgets(
      'FeatCard shows General Feat in 2014 mode and Origin Feat in 2024 mode for Alert',
      (tester) async {
    tester.view.physicalSize = const Size(1200, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(() => tester.view.resetPhysicalSize());
