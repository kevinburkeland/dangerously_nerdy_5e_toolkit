...
void main() {
  ...
  group('ItemCompendiumScreen Widget Tests', () {
    ...
    testWidgets('renders search bar, view segments, and list of items',
        (tester) async {
    ...
    testWidgets('filters items when entering query into search bar',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'switches to Personal Reliquary tab and shows empty state until pinned',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'switches to 2024 Diffs view mode and opens ItemComparisonDialog',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
