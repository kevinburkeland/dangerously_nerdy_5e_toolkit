...
void main() {
  ...
  group('SpellbookScreen Widget Tests', () {
    ...
    testWidgets('renders search bar, view segments, and list of spells',
        (tester) async {
    ...
    testWidgets('filters spells when entering query into search bar',
        (tester) async {
      await tester.pumpWidget(buildTestScreen());
      await tester.pumpAndSettle();
    ...
    testWidgets(
        'switches to My Spellbook tab and shows empty state until pinned',
        (tester) async {
      await tester.pumpWidget(buildTestScreen());
      await tester.pumpAndSettle();
    ...
    testWidgets(
        'displays newly added high-level spells and costly component badges',
        (tester) async {
      await tester.pumpWidget(buildTestScreen());
      await tester.pumpAndSettle();
    ...
    testWidgets(
        'renders spell level section headers without dashes in ordinal suffixes',
        (tester) async {
