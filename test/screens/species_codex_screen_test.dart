...
void main() {
  ...
  group('SpeciesCodexScreen Widget Tests', () {
    ...
    testWidgets(
        'renders screen title, search header, view mode chips, and species cards',
        (tester) async {
    ...
    testWidgets('opens RaceDetailDialog upon tapping a race card',
        (tester) async {
    ...
    testWidgets(
        'displays 25 ft speed for Gnome/Dwarf in 2014 mode and 30 ft in 2024 mode',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 1000);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
