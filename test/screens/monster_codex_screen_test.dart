...
void main() {
  ...
  group('MonsterCodexScreen Widget Tests', () {
    ...
    testWidgets('opens filter sheet and resets filters', (tester) async {
      ...
      expect(
          find.textContaining('Filter & Sort Monster Codex'), findsOneWidget);
    ...
    testWidgets(
        'supports sorting by DPR and alphabetical order from filter sheet',
        (tester) async {
      await tester.pumpWidget(buildTestScreen());
      await tester.pumpAndSettle();
    ...
    testWidgets('switches to 2024 Diffs tab and opens MonsterComparisonDialog',
      ...
      expect(find.textContaining('2024 REVISED RULES DIFF HIGHLIGHTS'),
          findsOneWidget);
