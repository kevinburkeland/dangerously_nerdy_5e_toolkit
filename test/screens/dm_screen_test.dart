...
void main() {
  ...
  group('DmReferenceScreen Widget Tests', () {
    ...
    testWidgets('renders Rules Compendium with title, quick roller, and cards',
    ...
    testWidgets('toggling between 2014 and 2024 updates rule display',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestableWidget(
          const DmReferenceScreen(initialEdition: DmRulesEdition.v2024)));
    ...
    testWidgets('filtering by search query filters cards dynamically',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestableWidget(const DmReferenceScreen()));
    ...
    testWidgets('tapping quick dice rolls a result and displays banner',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestableWidget(const DmReferenceScreen()));
    ...
    testWidgets('tapping card opens Compare 2014 vs 2024 dialog',
        (WidgetTester tester) async {
    ...
    testWidgets('tapping pin button on card pins rule to top section',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
    ...
    testWidgets('Unpin All button clears all pinned rules',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
    ...
    testWidgets('Pinned Only filter chip filters to only pinned rules',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
    ...
    testWidgets('pin button inside compare dialog toggles pinned state',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
      ...
      expect(
          find.descendant(
              of: find.byType(Dialog), matching: find.byTooltip('Unpin rule')),
          findsOneWidget);
    ...
    testWidgets('LandingScreen launches DmReferenceScreen from card and AppBar',
        (WidgetTester tester) async {
