...
void main() {
  ...
  group('DprCalculatorScreen Widget Tests', () {
    testWidgets(
        'renders DPR Calculator with clean custom build default and 2024 header',
        (tester) async {
    ...
    testWidgets('switches between 2024 and 2014 rules edition toggles',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('opens weapon picker sheet and selects a weapon',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(
          find.text('Select Weapon, Cantrip, or Magic Item'), findsOneWidget);
    ...
    testWidgets('opens picker sheet and selects a damage cantrip',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'resets build to clean custom when tapping refresh icon in app bar',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('adjusts target AC when pressing + / - buttons',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('opens 5e DPR Math Guide dialog when tapping info icon',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(find.textContaining('Core Formula for Damage Per Round (DPR):'),
          findsOneWidget);
    ...
    testWidgets(
        'filters modifiers strictly by edition and unlocks all with Anything Goes',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      await tester
          .pumpWidget(buildTestableScreen(edition: DmRulesEdition.v2024));
      await tester.pumpAndSettle();
    ...
    testWidgets('toggles Agonizing Blast chip to add ability modifier damage',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'switches between chart modes and adjusts AC scale presets & zoom',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
