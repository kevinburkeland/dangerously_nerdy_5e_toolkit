...
void main() {
  ...
  group('TableIndexScreen Widget Tests', () {
    testWidgets('renders Table Index screen with title and default tabs',
        (tester) async {
    ...
    testWidgets(
        'TreasureHoardView generates drops, adjusts party size, and toggles liquidation',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'switches to All Tables Index tab, searches, and rolls on table',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(find.text('Search all SRD tables, loot items, magic surges...'),
          findsOneWidget);
    ...
    testWidgets(
        'switches to Quick Rollers tab and dispenses trinket and wild magic',
        (tester) async {
      tester.view.physicalSize = const Size(1200, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
