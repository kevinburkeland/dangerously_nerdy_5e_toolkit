...
void main() {
  ...
  group('EntityFluffService Tests', () {
    ...
    test('saves, retrieves, and updates imported lore/fluff correctly', () {
      ...
      expect(updatedFluff!.loreMarkdown,
          contains('Ancient telepathic amphibians'));
    ...
    test('saves, retrieves, and updates user-authored notes', () {
      ...
      service.setUserNotes('spell', 'fireball',
          'Always check radius for friendly fire in narrow dungeons.');
      expect(service.getUserNotes('spell', 'fireball'),
          equals('Always check radius for friendly fire in narrow dungeons.'));
    ...
    test('exports and imports backup payloads faithfully', () {
      ...
      service.setFluff('race', 'elf', 'Graceful fey heritage.',
          source: 'SRD 5.1');
      ...
      expect(service.getFluff('race', 'elf')?.loreMarkdown,
          contains('Graceful fey heritage.'));
      expect(service.getUserNotes('class', 'fighter'),
          equals('Focus on Action Surge combos.'));
    });
  });
}
