  ...
  group('Layered Priority Repository & Resolver Tests', () {
    ...
    setUp(() {
      ...
      baseFireball2024 = const Spell(
        ...
        damageMath: [
          EvaluationMath(diceFormula: '8d6', damageType: DamageType.fire)
        ],
      );
      ...
      customFireballOverride = const Spell(
        ...
        damageMath: [
          EvaluationMath(diceFormula: '10d6', damageType: DamageType.fire)
        ],
      );
    });
    ...
    test('campaign override layer takes top priority (Copy-on-Write clone)',
      ...
      expect(result.entity!.castingTime.actionType,
          equals(ActionType.bonusAction));
