  ...
  group('SessionGraphService & Room Integration Tests', () {
    ...
    setUp(() {
      ...
      rogue = const Character(
        ...
        skillProficiencies: {
          SkillType.perception: SkillProficiencyLevel
              .expertise, // Expertise in perception: +2 * 2 + 1 = +5 => Passive 15
          SkillType.investigation:
              SkillProficiencyLevel.proficient, // +2 + 2 = +4 => Passive 14
        },
      ...
      cleric = const Character(
        ...
        skillProficiencies: {
          SkillType.insight:
              SkillProficiencyLevel.proficient, // +3 + 2 = +5 => Passive 15
        },
    ...
    test('distributes room container loot to target character atomically', () {
      ...
      expect(updatedRogue.inventory.last.itemRef.slug,
          equals('ruby-of-the-war-mage'));
