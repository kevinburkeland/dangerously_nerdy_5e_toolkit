...
void main() {
  ...
  group('Data Resilience & Serialization Recovery Tests', () {
    ...
    test('Saving and reloading custom presets round-trips with full fidelity',
        () async {
    ...
    test(
        'Corrupted JSON payloads in localStorage or import strings are handled gracefully without crashing',
        () async {
    ...
    test(
        'Exporting and importing presets via JSON diagnostics correctly tallies valid and invalid items',
        () async {
