...
void main() {
  ...
  group('Comprehensive Community & Multi-Category Compendium Ingestion Tests',
      () {
    test(
        'ingests multi-category community compendium payload with 0% data loss',
        () {
      const fullPayload = '''
{
  "spell": [
    {
      ...
      "homebrewDesigner": "Shadowblade Council"
    }
  ],
  "monster": [
    {
...
''';
      ...
      expect(result.spells.first.customProperties['homebrewDesigner'],
          equals('Shadowblade Council'));
      ...
      expect(result.monsters.first.customProperties['habitatOrigin'],
          equals('Astral Sea'));
      ...
      expect(result.items.first.customProperties['ancientRune'],
          equals('Khaz-Modan'));

      // 4. Classes
      expect(result.classes.length, equals(1));
      expect(result.classes.first.name, equals('Psion'));
      expect(result.classes.first.customProperties['psionDiscipline'],
          equals('Telekinesis'));
      ...
      // Bundle conversion
      final bundle =
          result.toBundle(bundleName: 'Psionics & Astral Compendium');
