...
void main() {
  group('SrdEquivalenceIndex Deduplication Tests', () {
    ...
    test('correctly identifies canonical SRD spells', () {
      expect(
        index.checkEntity(
            slug: 'fireball', name: 'Fireball', type: EntityType.spell),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'magic-missile-phb',
            name: 'Magic Missile',
      ...
      expect(
        index.checkEntity(
            slug: 'void-blast', name: 'Void Blast', type: EntityType.spell),
    ...
    test('correctly identifies canonical SRD monsters', () {
      expect(
        index.checkEntity(
            slug: 'goblin', name: 'Goblin', type: EntityType.monster),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'ancient-red-dragon-mm',
    ...
    test('correctly identifies canonical SRD classes', () {
      expect(
        index.checkEntity(
            slug: 'fighter', name: 'Fighter', type: EntityType.classDefinition),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'wizard', name: 'Wizard', type: EntityType.classDefinition),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
    ...
    test('correctly identifies canonical SRD species, feats, and backgrounds',
      ...
      expect(
        index.checkEntity(
            slug: 'human', name: 'Human', type: EntityType.species),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'high-elf', name: 'High Elf', type: EntityType.species),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'grappler', name: 'Grappler', type: EntityType.feat),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
      ...
      expect(
        index.checkEntity(
            slug: 'acolyte', name: 'Acolyte', type: EntityType.background),
        equals(SrdMatchResult.exactSrdMatch),
      );
      expect(
        index.checkEntity(
            slug: 'homebrew-feat',
            name: 'Homebrew Mastery',
    ...
    test(
        'isCanonSrd returns true for exact canonical SRD slugs and stripped slugs',
        () {
      ...
      expect(index.isCanonSrd('custom-rogue', EntityType.classDefinition),
          isFalse);
      expect(
          index.isCanonSrd('custom-rogue', EntityType.classDefinition,
              name: 'Rogue'),
          isTrue);
    });

    test(
        'tolerates apostrophe-stripped and hyphenated slug formats for SRD spells',
        () {
