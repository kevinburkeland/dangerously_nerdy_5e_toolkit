...
void main() {
  group('EntryNodeTransformer Enhanced Tags and Cleaning Tests', () {
    ...
    test(
        'parses zero-argument tags like {@h}, {@hom}, {@hitYourSpellAttack}, and {@recharge}',
        () {
      const input =
          'Claw. {@atk mw} {@hit 5} to hit. {@h}10 ({@damage 2d6}) slashing damage. {@hom}5 slashing damage.';
    ...
    test('parses {@hitYourSpellAttack} cleanly', () {
      ...
      expect(result.markdown,
          contains('**`+your spell attack modifier`** to hit'));
