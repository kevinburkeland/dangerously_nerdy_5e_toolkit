...
void main() {
  group('Community Compendium & Homebrew Spell Parser Tests', () {
    ...
    test(
        'parses full mechanical spell with 1-letter school code and nested duration',
        () {
      final raw = {
        'name': 'Solar Flare',
        'source': 'HOMEBREW',
        ...
        'components': {
          ...
          's': true,
          'm': {
            'text': 'a prism and a piece of amber',
            'cost': 5000,
            'consume': false
          }
        },
      ...
      expect(
          spell.customProperties['customAuthorTag'], equals('Archmage Morden'));
      expect(spell.customProperties['page'], equals(142));
      expect(spell.customProperties['savingThrow'], equals(['dexterity']));
      expect(
          spell.customProperties['classes']['fromClassList'].length, equals(2));
    });
