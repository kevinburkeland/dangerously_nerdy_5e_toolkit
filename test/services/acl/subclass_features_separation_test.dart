...
void main() {
  group('Subclass Features Separation Ingestion Tests', () {
    ...
    test(
        'ingestion routes subclass features to Subclass and keeps Class featuresMarkdown clean',
        () {
...
''';
      ...
      expect(wardenClass.featuresMarkdown,
          contains('gaining a +1 bonus to Armor Class'));
      ...
      expect(
          wardenClass.featuresMarkdown, isNot(contains('Unbreakable Bastion')));
      ...
      expect(bulwarkSub.featuresMarkdown,
          contains('Unbreakable Bastion (Level 6)'));
      expect(bulwarkSub.featuresMarkdown,
          contains('intercept incoming projectiles'));
    });
  });
}
