  ...
  group('CharacterStatCalculator Tests', () {
    ...
    test('attunement requirement enforces stat bonus only when attuned', () {
      ...
      final statsUnattuned =
          CharacterStatCalculator.compute(charUnattuned, resolver);
      ...
      final statsAttuned =
          CharacterStatCalculator.compute(charAttuned, resolver);
    ...
    test('Gauntlets of Ogre Power overrides STR to 19 when attuned', () {
      ...
      expect(
          stats.abilityModifiers[AbilityType.strength], equals(4)); // 19 = +4
    });
    ...
    test(
      ...
      expect(stats.unresolvedReferences.first.slug,
          equals('deleted-legendary-blade'));
    });
    ...
    test(
      ...
      expect(
          stats.abilityModifiers[AbilityType.dexterity], equals(-4)); // 3 -> -4
      expect(stats.abilityModifiers[AbilityType.constitution],
          equals(3)); // 16 -> +3
    });
