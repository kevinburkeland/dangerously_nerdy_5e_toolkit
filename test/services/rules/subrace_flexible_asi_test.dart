...
void main() {
  group('Subrace Flexible ASI Selection & Pool Constraints', () {
    test(
        'Subrace serialization preserves flexibleAbilityPool, count, and bonus',
        () {
      const subrace = Subrace(
        id: EntityId(
            slug: 'custom-forge-lineage', ruleset: RulesetVersion.v2014),
    ...
    test(
      ...
      expect(draft.pendingFlexibleAbilityChoices.first,
          equals(AbilityType.dexterity));
      expect(draft.pendingFlexibleAbilityChoices.contains(AbilityType.strength),
          isFalse);
    });
    ...
    test(
      ...
      draft.reconcile();
      expect(
          draft.pendingFlexibleAbilityChoices, equals([AbilityType.dexterity]));
    });
    ...
    test(
      ...
      draft.reconcile();
      expect(draft.pendingFlexibleAbilityChoices,
    ...
    test(
        '2024 mode preserves backgroundBonusScores and zeroes speciesBonusScores',
        () {
      final draft = CharacterDraft(
