...
void main() {
  group('2014 Rules Character Lifecycle & Level Up Edge Cases', () {
    test(
        'Subclass selection triggers at Level 2 for Wizard/Druid and Level 1 for Cleric in 2014',
        () {
      final wizardClass2014 =
          SrdClassesLibrary.findBySlug('wizard', ruleset: RulesetVersion.v2014);
      final druidClass2014 =
          SrdClassesLibrary.findBySlug('druid', ruleset: RulesetVersion.v2014);
      final clericClass2014 =
          SrdClassesLibrary.findBySlug('cleric', ruleset: RulesetVersion.v2014);
      final fighterClass2014 = SrdClassesLibrary.findBySlug('fighter',
      ...
      expect(
        CharacterProgressionEngine.isSubclassMilestone(
          ...
          characterClass: SrdClassesLibrary.findBySlug('wizard',
              ruleset: RulesetVersion.v2024),
        ),
        isFalse,
      );
    ...
    test(
        'HP calculation accounts for Draconic Bloodline Sorcerer and Hill Dwarf bonuses',
        () {
    ...
    test(
      ...
      expect(
          character.getAbilityScoreMaximum(AbilityType.strength), equals(20));
    ...
    test(
      ...
      expect(
          barbarian20.getAbilityScoreMaximum(AbilityType.strength), equals(24));
      expect(barbarian20.getAbilityScoreMaximum(AbilityType.constitution),
          equals(24));
      expect(barbarian20.getAbilityScoreMaximum(AbilityType.dexterity),
          equals(20));
      ...
      expect(withTreatise.getAbilityScoreMaximum(AbilityType.intelligence),
          equals(22));
    });

    test(
        'Unarmored Defense multiclass precedence respects class acquisition order',
        () {
      final repo = LayeredPriorityRepository();
      final resolver = ReferenceResolver(repo);
