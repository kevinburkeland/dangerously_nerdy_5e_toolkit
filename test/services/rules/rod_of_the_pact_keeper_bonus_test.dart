...
void main() {
  ...
  group('Rod of the Pact Keeper & Magic Item Spell Bonus Tests', () {
    ...
    test(
        'Rod of the Pact Keeper +1 when equipped and attuned boosts DC to 15 and Attack to +7',
        () {
      final warlock =
          createTestWarlock(equipRod: true, attuneRod: true, rodBonus: 1);
      final stats = CharacterEvaluationEngine.evaluate(warlock);
    ...
    test('Rod of the Pact Keeper +2 boosts DC to 16 and Attack to +8', () {
      final warlock =
          createTestWarlock(equipRod: true, attuneRod: true, rodBonus: 2);
      final stats = CharacterEvaluationEngine.evaluate(warlock);
    ...
    test('Rod of the Pact Keeper +3 boosts DC to 17 and Attack to +9', () {
      final warlock =
          createTestWarlock(equipRod: true, attuneRod: true, rodBonus: 3);
      final stats = CharacterEvaluationEngine.evaluate(warlock);
    ...
    test('Equipped but UNATTUNED Rod does NOT grant bonus', () {
      final warlock =
          createTestWarlock(equipRod: true, attuneRod: false, rodBonus: 2);
      final stats = CharacterEvaluationEngine.evaluate(warlock);
