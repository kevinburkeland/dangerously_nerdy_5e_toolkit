...
void main() {
  group('InventoryTransactionService Tests', () {
    ...
    test('equipping a two-handed weapon auto-unequips main hand and shield',
      ...
      final sword =
          equipped.inventory.firstWhere((i) => i.instanceId == 'inst-sword');
      final shield =
          equipped.inventory.firstWhere((i) => i.instanceId == 'inst-shield');
      final greatsword = equipped.inventory
          .firstWhere((i) => i.instanceId == 'inst-greatsword');
    ...
    test('attunement cap validation allows up to max (3) and rejects 4th', () {
      ...
      expect(
        () => InventoryTransactionService.attuneItem(
            baseCharacter, 'inst-ring1', true),
        throwsStateError,
      );

      // Unattuning ring2
      final unattuned = InventoryTransactionService.attuneItem(
          baseCharacter, 'inst-ring2', false);
      expect(unattuned.attunedItemCount, equals(2));

      // Now attuning ring1 succeeds
      final reAttuned =
          InventoryTransactionService.attuneItem(unattuned, 'inst-ring1', true);
      expect(reAttuned.attunedItemCount, equals(3));
      final ring1 =
          reAttuned.inventory.firstWhere((i) => i.instanceId == 'inst-ring1');
      expect(ring1.isAttuned, isTrue);
    });

    test(
        'equipping multiple wondrous items does not unequip existing wondrous items',
        () {
      ...
      final bag1 = step1.inventory
          .firstWhere((i) => i.instanceId == 'inst-bag-of-holding');
      ...
      final bag2 = step2.inventory
          .firstWhere((i) => i.instanceId == 'inst-bag-of-holding');
      final periapt2 =
          step2.inventory.firstWhere((i) => i.instanceId == 'inst-periapt');
      expect(bag2.isEquipped, isTrue,
          reason: 'First wondrous item should remain equipped');
      expect(periapt2.isEquipped, isTrue,
          reason: 'Second wondrous item should be equipped');
      ...
      final bag3 = step3.inventory
          .firstWhere((i) => i.instanceId == 'inst-bag-of-holding');
      final periapt3 =
          step3.inventory.firstWhere((i) => i.instanceId == 'inst-periapt');
      final bracers3 =
          step3.inventory.firstWhere((i) => i.instanceId == 'inst-bracers');
    ...
    test(
        'equipping a second ring automatically fills ring2 when ring1 is occupied',
        () {
      ...
      final r1Step1 =
          step1.inventory.firstWhere((i) => i.instanceId == 'inst-ring1');
      ...
      final r1Step2 =
          step2.inventory.firstWhere((i) => i.instanceId == 'inst-ring1');
      final r2Step2 =
          step2.inventory.firstWhere((i) => i.instanceId == 'inst-ring2');
      expect(r1Step2.isEquipped, isTrue,
          reason: 'Ring 1 should still be equipped in ring1');
      expect(r1Step2.equippedSlot, equals(EquipmentSlot.ring1));
      expect(r2Step2.isEquipped, isTrue,
          reason: 'Ring 2 should be equipped in ring2');
