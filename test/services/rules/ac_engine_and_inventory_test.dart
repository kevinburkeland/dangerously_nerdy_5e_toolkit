...
void main() {
  group('Armor Class Engine & Inventory Propagation Tests', () {
    ...
    test('Equipping two-handed weapon auto-unequips shield and offhand', () {
      ...
      char = InventoryTransactionService.equipItem(
          char, 'weapon-2', EquipmentSlot.twoHand);

      final greatswordItem =
          char.inventory.firstWhere((i) => i.instanceId == 'weapon-2');
      final shieldItem =
          char.inventory.firstWhere((i) => i.instanceId == 'shield-1');
      final longswordItem =
          char.inventory.firstWhere((i) => i.instanceId == 'weapon-1');
    ...
    test('Dwarven Toughness propagation adds +1 HP per level', () {
      ...
      final stats = CharacterEvaluationEngine.evaluate(dwarf,
          overrideEdition: DmRulesEdition.v2024);
