...
void main() {
  group('TreasureGeneratorEngine Tests', () {
    ...
    test(
        'calculateShares with includeLiquidatedGemsAndArt computes accurate gold appraisal',
        () {
      const drop = TreasureDropResult(
        tierLabel: 'CR 5–10',
        isHoard: true,
    ...
    test(
        'formatMarkdownSummary outputs readable markdown with party distribution',
        () {
